...
LEFT JOIN dbo.T_MANIFEST_ENTRY AS T3 ON T1.SYSTEM_ID = T3.RENKEI_SYSTEM_ID AND T1.DETAIL_SYSTEM_ID=T3.RENKEI_MEISAI_SYSTEM_ID AND T3.RENKEI_DENSHU_KBN_CD='1' AND T3.DELETE_FLG = 0
