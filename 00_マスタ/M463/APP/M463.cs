// $Id: M463.cs 31591 2014-10-03 12:55:49Z nagata $
...
namespace Shougun.Core.Master.HikiaiGenbaHoshu.APP
{
    ...
    /// M463 引合現場入力
    /// </summary>
    class M463 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// 画面作成処理
        /// </summary>
        ...
        public Form CreateForm(params object[] args)
        {
            ...
            if (args.Length > 4)
            {
                denshiShinseiFlg = bool.Parse(args[4].ToString());
            }

            var callForm = new UIForm(windowType, hikiaiGyoushaUseFlg, gyoushaCd, genbaCd, denshiShinseiFlg);
        ...
        public bool IsSameContentForm(Form form, params object[] args)
        {
            if (args.Length > 2)
            {
                string gyoushaCd = args[2].ToString();
                string genbaCd = args[3].ToString();
