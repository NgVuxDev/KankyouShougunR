...
namespace Shougun.Core.Master.HikiaiGenbaHoshu.Const
{
    /// <summary>
    /// 定数クラス
    /// </summary>
    public class ConstCls
    {
        ...
        public static readonly string TEIKI_BEFORE_HINMEI_CD = "BEFORE_HINMEI_CD";
        ...
        public const string MSG_ERR_A = "品名CDを入力してください";

        public const string MSG_ERR_B = "契約区分＝３．回収のみを選択してください";

        public const string MSG_ERR_C = "契約区分＝２．現金　または　３．回収のみ　のいずれかを選択してください";
