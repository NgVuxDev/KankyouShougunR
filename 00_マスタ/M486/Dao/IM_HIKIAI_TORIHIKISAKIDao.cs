...
namespace Shougun.Core.Master.HikiaiGenbaIchiran.Dao
{
    ...
    public interface IM_HIKIAI_TORIHIKISAKIDao : IS2Dao
    {
        ...
        /// <parameparam name="data">Entity</parameparam>
        /// <returns>取得したデータのリスト</returns>
        [SqlFile("Shougun.Core.Master.HikiaiGenbaIchiran.Sql.GetHikiaiTorihikisakiAllValidData.sql")]
        M_HIKIAI_TORIHIKISAKI[] GetAllValidData(M_HIKIAI_TORIHIKISAKI data);

        [SqlFile("Shougun.Core.Master.HikiaiGenbaIchiran.Sql.GetHikiaiTorihikisakiAllValidDataMinCols.sql")]
