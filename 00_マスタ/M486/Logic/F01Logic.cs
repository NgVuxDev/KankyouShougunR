// $Id: F01Logic.cs 15601 2014-02-04 06:08:35Z ogawa@takumi-sys.co.jp $
using System;
...
namespace HikiaiGenbaIchiran.Logic
{
    ...
    /// ビジネスロジック
    /// </summary>
    internal class F01Logic : IBuisinessLogic
    {
        #region フィールド
        ...
        private readonly string LinkWindowInfoXmlPath = "TransWindowSetting.xml";
        ...
        private TransWindowSetting[] transWindowSetting;
        ...
        public F01Logic(UIForm targetForm)
        {
        ...
        internal void WindowInit()
        {
            ...
            string LinkWindowInfoXmlPath = "TransWindowSetting.xml";
            var thisAssembly = Assembly.GetExecutingAssembly();
            TransWindowSetting[] linkWindowDtoArray = TransWindowSetting.LoadTransWindowSetting(LinkWindowInfoXmlPath);
        ...
        private void OpenWindow(WINDOW_TYPE windowType, bool newFlg = false)
        {
            ...
            if (this.transWindowSetting.Length <= 0)
                {
            ...
            var assembly = Assembly.LoadFrom(this.transWindowSetting[0].AssemblyName);
            SuperForm superForm = (SuperForm)assembly.CreateInstance(
                    //this.linkWindowSetting[0].FormName, // 名前空間を含めたクラス名
                    this.transWindowSetting[0].FormName, // 名前空間を含めたクラス名
        ...
        public override bool Equals(object other)
        {
            ...
            F01Logic localLogic = other as F01Logic;
