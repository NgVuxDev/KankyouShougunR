// $Id: GamenSeigyoHoshuForm.cs 18950 2014-04-10 09:53:01Z sc.h.hashimoto $
using System;
...
namespace GamenSeigyoHoshu
{
    ...
    /// </summary>
    [Implementation]
    public partial class GamenSeigyoHoshuForm : SuperForm
    {
        /// <summary>
        /// 画面制御入力保守画面ロジック
        /// </summary>
        private GamenSeigyoHoshuLogic logic;
        ...
        /// コンストラクタ
        /// </summary>
        public GamenSeigyoHoshuForm()
            : base(WINDOW_ID.M_SHAIN_MAX_WINDOW, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new GamenSeigyoHoshuLogic(this);
