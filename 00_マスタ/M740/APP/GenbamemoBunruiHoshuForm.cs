...
using GenbamemoBunruiHoshu.Logic;
...
namespace GenbamemoBunruiHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class GenbamemoBunruiHoshuForm : SuperForm
    {
        /// <summary>
        /// 現場メモ分類入力画面ロジック
        /// </summary>
        private GenbamemoBunruiHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public GenbamemoBunruiHoshuForm()
            : base(WINDOW_ID.M_GENBAMEMO_BUNRUI, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new GenbamemoBunruiHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.GenbamemoBunruiHoshuConstans.GENBAMEMO_BUNRUI_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void BunruiHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
