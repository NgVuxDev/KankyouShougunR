// $Id: BunruiHoshuForm.cs 54201 2015-07-01 05:06:18Z quocthang@e-mall.co.jp $
using System;
using System.Windows.Forms;
using GenbamemoHyoudaiHoshu.Logic;
...
namespace GenbamemoHyoudaiHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class GenbamemoHyoudaiHoshuForm : SuperForm
    {
        /// <summary>
        /// 現場メモ表題入力画面ロジック
        /// </summary>
        private GenbamemoHyoudaiHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public GenbamemoHyoudaiHoshuForm()
            : base(WINDOW_ID.M_GENBAMEMO_HYOUDAI, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new GenbamemoHyoudaiHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.GenbamemoHyoudaiHoshuConstans.GENBAMEMO_HYOUDAI_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void HyoudaiHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
