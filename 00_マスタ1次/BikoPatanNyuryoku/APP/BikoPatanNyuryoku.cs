// $Id: BikoPatanNyuryokuForm.cs 54201 2015-07-01 05:06:18Z quocthang@e-mall.co.jp $
using System;
using System.Windows.Forms;
using BikoPatanNyuryoku.Logic;
...
namespace BikoPatanNyuryoku.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class BikoPatanNyuryokuForm : SuperForm
    {
        /// <summary>
        /// 分類画面ロジック
        /// </summary>
        private BikoPatanNyuryokuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public BikoPatanNyuryokuForm()
            : base(WINDOW_ID.M_BIKO_PATAN_NYURYOKU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new BikoPatanNyuryokuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.BikoPatanNyuryokuConstans.BIKO_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void BikoPatanNyuryokuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
