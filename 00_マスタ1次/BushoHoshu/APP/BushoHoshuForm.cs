// $Id: BushoHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
using System.Windows.Forms;
using BushoHoshu.Logic;
...
namespace BushoHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class BushoHoshuForm : SuperForm
    {

        /// <summary>
        /// 部署保守画面ロジック
        /// </summary>
        private BushoHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public BushoHoshuForm()
            : base(WINDOW_ID.M_BUSHO, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new BushoHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.BushoHoshuConstans.BUSHO_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void BushoHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
