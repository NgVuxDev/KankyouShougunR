// $Id: ChiikibetsuBunruiHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
using System.Windows.Forms;
using ChiikibetsuBunruiHoshu.Logic;
...
namespace ChiikibetsuBunruiHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ChiikibetsuBunruiHoshuForm : SuperForm
    {
        /// <summary>
        /// メニュー権限保守画面ロジック
        /// </summary>
        private ChiikibetsuBunruiHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ChiikibetsuBunruiHoshuForm(String Cd)
            : base(WINDOW_ID.M_CHIIKIBETSU_BUNRUI, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ChiikibetsuBunruiHoshuLogic(this);
        ...
        public virtual void Search(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    bool catchErr = this.logic.SetIchiran(false);
                    if (catchErr)
                    {
                        return;
                    }
        ...
        {
            if (e.CellName.Equals(Const.ChiikibetsuBunruiHoshuConstans.HOUKOKUSHO_BUNRUI_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ChiikibetsuBunruiHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
