// $Id: ChiikibetsuGyoushuHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
using System.Windows.Forms;
using ChiikibetsuGyoushuHoshu.Logic;
...
namespace ChiikibetsuGyoushuHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ChiikibetsuGyoushuHoshuForm : SuperForm
    {
        /// <summary>
        /// メニュー権限保守画面ロジック
        /// </summary>
        private ChiikibetsuGyoushuHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ChiikibetsuGyoushuHoshuForm(String Cd)
            : base(WINDOW_ID.M_CHIIKIBETSU_GYOUSHU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ChiikibetsuGyoushuHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.ChiikibetsuGyoushuHoshuConstans.GYOUSHU_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ChiikibetsuGyoushuHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
