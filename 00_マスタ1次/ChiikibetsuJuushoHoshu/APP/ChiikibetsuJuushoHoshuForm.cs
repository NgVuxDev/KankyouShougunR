// $Id: ChiikibetsuJuushoHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
using System.Windows.Forms;
using ChiikibetsuJuushoHoshu.Logic;
...
namespace ChiikibetsuJuushoHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ChiikibetsuJuushoHoshuForm : SuperForm
    {
        /// <summary>
        /// メニュー権限保守画面ロジック
        /// </summary>
        private ChiikibetsuJuushoHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ChiikibetsuJuushoHoshuForm(String Cd)
            : base(WINDOW_ID.M_CHIIKIBETSU_JUSHO, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ChiikibetsuJuushoHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.ChiikibetsuJuushoHoshuConstans.CHANGE_CHIIKI_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ChiikibetsuJuushoHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
