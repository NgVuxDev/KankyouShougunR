// $Id: ChiikibetsuShobunHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
using System.Windows.Forms;
using ChiikibetsuShobunHoshu.Logic;
...
namespace ChiikibetsuShobunHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ChiikibetsuShobunHoshuForm : SuperForm
    {
        /// <summary>
        /// メニュー権限保守画面ロジック
        /// </summary>
        private ChiikibetsuShobunHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ChiikibetsuShobunHoshuForm(String Cd)
            : base(WINDOW_ID.M_CHIIKIBETSU_SHOBUN, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ChiikibetsuShobunHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.ChiikibetsuShobunHoshuConstans.SHOBUN_HOUHOU_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ChiikibetsuShobunHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
