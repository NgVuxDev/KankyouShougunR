...
/*BEGIN*/WHERE
 ...
 /*END*/
 /*IF data.HAIKI_SHURUI_NAME != null*/AND HAI.HAIKI_SHURUI_NAME LIKE '%' +  /*data.HAIKI_SHURUI_NAME*/'NAME' + '%'/*END*/
 /*IF data.HOUKOKUSHO_BUNRUI_CD != null*/AND HAI.HOUKOKUSHO_BUNRUI_CD LIKE '%' +  /*data.HOUKOKUSHO_BUNRUI_CD*/'000001' + '%'/*END*/
