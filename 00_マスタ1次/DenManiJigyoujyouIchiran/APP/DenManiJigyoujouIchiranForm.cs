...
using DenManiJigyoujyouIchiran.Logic;
...
{
    public partial class DenManiJigyoujyouIchiranForm : Shougun.Core.Common.IchiranCommon.APP.IchiranSuperForm
    {
        /// <summary>
        /// ビジネスロジック
        /// </summary>
        ...
        public DenManiJigyoujyouIchiranForm(DENSHU_KBN denshuKbn)
            : base(denshuKbn)
        {
            InitializeComponent();
