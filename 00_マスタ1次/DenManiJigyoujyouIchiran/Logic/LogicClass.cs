...
using DenManiJigyoujyouIchiran.APP;
...
namespace DenManiJigyoujyouIchiran.Logic
{
    /// <summary>
    /// ビジネスロジック
    /// </summary>
    internal class LogicClass : IBuisinessLogic
    {
        ...
        /// ボタン設定格納ファイル
        /// </summary>
        private readonly string ButtonInfoXmlPath = "DenManiJigyoujyouIchiran.Setting.ButtonSetting.xml";

        /// <summary>
        /// SQLファイル
        /// </summary>
        private readonly string GET_DATA_BY_CD_SQL = "DenManiJigyoujyouIchiran.Sql.GetDataByCdSql.sql";
        ...
        /// 画面連携に使用するキー取得項目名2
        /// </summary>
        internal readonly string KEY_ID2 = "HIDDEN_JIGYOUJOU_CD";

        /// <summary>
        /// 画面オブジェクト
        /// </summary>
        private DenManiJigyoujyouIchiranForm form;
        ...
        /// 電子事業場のDao
        /// </summary>
        private IM_DENSHI_JIGYOUJOUDao daoJigyoujou;
        ...
        public LogicClass(DenManiJigyoujyouIchiranForm targetForm)
        {
            LogUtility.DebugMethodStart(targetForm);

            this.form = targetForm;
            this.headerForm = (IchiranHeaderForm2)((IchiranBaseForm)targetForm.ParentForm).headerForm;
            this.daoJigyoujou = DaoInitUtility.GetComponent<IM_DENSHI_JIGYOUJOUDao>();
        ...
        private void bt_func7_Click(object sender, EventArgs e)
        {
            ...
            this.form.JIGYOUJOU_ADDRESS.Text = string.Empty;
        ...
        {
            if (string.IsNullOrWhiteSpace(DenManiJigyoujyouIchiran.Properties.Settings.Default.JIGYOUSHA_KBN_TEXT))
            {
                this.form.JIGYOUSHA_KBN.Text = "1";
            }
            else
            {
                this.form.JIGYOUSHA_KBN.Text = DenManiJigyoujyouIchiran.Properties.Settings.Default.JIGYOUSHA_KBN_TEXT;
            }
            ...
            if (DenManiJigyoujyouIchiran.Properties.Settings.Default.ICHIRAN_ALERT_KENSUU != "")
            {
                this.headerForm.alertNumber.Text = DenManiJigyoujyouIchiran.Properties.Settings.Default.ICHIRAN_ALERT_KENSUU;
            }

            // 検索条件設定
            this.form.JIGYOUSHA_NAME.Text = DenManiJigyoujyouIchiran.Properties.Settings.Default.JIGYOUSHA_NAME_TEXT;
            this.form.JIGYOUJOU_NAME.Text = DenManiJigyoujyouIchiran.Properties.Settings.Default.JIGYOUJOU_NAME_TEXT;
            this.form.JIGYOUJOU_ADDRESS.Text = DenManiJigyoujyouIchiran.Properties.Settings.Default.JIGYOUJOU_ADDRESS_TEXT;
        }
        ...
        private void OpenWindow(WINDOW_TYPE windowType, bool newFlg = false)
        {
            ...
            {
                r_framework.FormManager.FormManager.OpenFormWithAuth("M312", WINDOW_TYPE.NEW_WINDOW_FLAG, windowType);
            }
            else
            {
                // 表示されている行の取引先CDを取得する
                ...
                //{
                //    M_DENSHI_JIGYOUJOU cond = new M_DENSHI_JIGYOUJOU();
                //    cond.EDI_MEMBER_ID = cd1;
                //    cond.JIGYOUJOU_CD = cd2;
                //    DataTable data = this.daoJigyoujou.GetDataBySqlFile(GET_DATA_BY_CD_SQL, cond);
                ...
                if (windowType == WINDOW_TYPE.UPDATE_WINDOW_FLAG &&
                    !r_framework.Authority.Manager.CheckAuthority("M312", WINDOW_TYPE.UPDATE_WINDOW_FLAG, false))
                {
                    if (!r_framework.Authority.Manager.CheckAuthority("M312", WINDOW_TYPE.REFERENCE_WINDOW_FLAG, false))
                    {
                ...
                r_framework.FormManager.FormManager.OpenFormWithAuth("M312", windowType, windowType, cd1, cd2);
            }
        ...
        public int Search()
        {
            ...
            if (!string.IsNullOrWhiteSpace(this.form.SelectQuery))
            {
                ...
                this.form.Table = this.daoJigyoujou.GetDateForStringSql(sql);
            }
        ...
        private string MakeSearchCondition()
        {
            ...
            try
            {
                ...
                sb.AppendFormat(" , M_DENSHI_JIGYOUJOU.EDI_MEMBER_ID AS {0} ", this.KEY_ID1);
                sb.AppendFormat(" , M_DENSHI_JIGYOUJOU.JIGYOUJOU_CD AS {0} ", this.KEY_ID2);
                ...
                // 電子事業場
                sb.Append(" FROM M_DENSHI_JIGYOUJOU ");
                
                // 電子事業者
                sb.Append(" LEFT JOIN M_DENSHI_JIGYOUSHA ");
                sb.Append(" ON M_DENSHI_JIGYOUJOU.EDI_MEMBER_ID = M_DENSHI_JIGYOUSHA.EDI_MEMBER_ID");
                ...
                // 事業場名
                strTemp = this.form.JIGYOUJOU_NAME.Text;
                if (!string.IsNullOrWhiteSpace(strTemp))
                {
                    sb.AppendFormat(" AND M_DENSHI_JIGYOUJOU.JIGYOUJOU_NAME LIKE '%{0}%'", strTemp);
                }

                // 住所
                strTemp = this.form.JIGYOUJOU_ADDRESS.Text;
                if (!string.IsNullOrWhiteSpace(strTemp))
                {
                    sb.Append(" AND (")
                        .Append("M_DENSHI_JIGYOUJOU.JIGYOUJOU_ADDRESS1").Append(" + ")
                        .Append("M_DENSHI_JIGYOUJOU.JIGYOUJOU_ADDRESS2").Append(" + ")
                        .Append("M_DENSHI_JIGYOUJOU.JIGYOUJOU_ADDRESS3").Append(" + ")
                        .Append("M_DENSHI_JIGYOUJOU.JIGYOUJOU_ADDRESS4").Append(")")
        ...
        public string GetSearchString()
        {
            ...
            if (!string.IsNullOrWhiteSpace(strTemp))
            {
                ...
                result.AppendFormat(" M_DENSHI_JIGYOUJOU.JIGYOUJOU_NAME LIKE '%{0}%'", strTemp);
            }
        ...
        public bool SaveHyoujiJoukenDefault()
        {
            ...
            try
            {
                DenManiJigyoujyouIchiran.Properties.Settings.Default.JIGYOUSHA_KBN_TEXT = this.form.JIGYOUSHA_KBN.Text;
                DenManiJigyoujyouIchiran.Properties.Settings.Default.ICHIRAN_ALERT_KENSUU = this.headerForm.alertNumber.Text;
                DenManiJigyoujyouIchiran.Properties.Settings.Default.JIGYOUSHA_NAME_TEXT = this.form.JIGYOUSHA_NAME.Text;
                DenManiJigyoujyouIchiran.Properties.Settings.Default.JIGYOUJOU_NAME_TEXT = this.form.JIGYOUJOU_NAME.Text;
                DenManiJigyoujyouIchiran.Properties.Settings.Default.JIGYOUJOU_ADDRESS_TEXT = this.form.JIGYOUJOU_ADDRESS.Text;

                DenManiJigyoujyouIchiran.Properties.Settings.Default.Save();
                return false;
            }
            catch (Exception ex)
            {
