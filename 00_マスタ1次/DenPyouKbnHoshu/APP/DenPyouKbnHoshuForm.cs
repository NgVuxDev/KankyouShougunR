// $Id: DenPyouKbnHoshuForm.cs 18834 2014-04-09 06:51:03Z sc.m.moriya@willwave.jp $
using System;
...
namespace DenPyouKbnHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class DenPyouKbnHoshuForm : SuperForm
    {

        /// <summary>
        /// 伝票区分入力画面ロジック
        /// </summary>
        private DenPyouKbnHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public DenPyouKbnHoshuForm()
            : base(WINDOW_ID.M_DENPYOU_KBN, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new DenPyouKbnHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.DenPyouKbnHoshuConstans.DENPYOU_KBN_CD))
            {
