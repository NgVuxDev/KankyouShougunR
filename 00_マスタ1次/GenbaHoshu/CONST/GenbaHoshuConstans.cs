// $Id: GenbaHoshuConstans.cs 18187 2014-03-28 02:59:25Z ogawa@takumi-sys.co.jp $

namespace GenbaHoshu.Const
{
    /// <summary>
    /// 定数クラス
    /// </summary>
    public class GenbaHoshuConstans
    {
        /// <summary>
        ...
        public const string TEIKI_HINMEI_CD = "HINMEI_CD";
        ...
        /// <summary>M_GENBA_TSUKI_HINMEIのDELETE_FLG</summary>
        public static readonly string TSUKI_DELETE_FLG = "DELETE_FLG";

        /// <summary>M_GENBA_TSUKI_HINMEIのDELETE_FLG</summary>
        public static readonly string TEIKI_DELETE_FLG = "DELETE_FLG";
        ...
        public const string TEIKI_BEFORE_HINMEI_CD = "BEFORE_HINMEI_CD";

        public const string MSG_ERR_A_KEIYAKU_KBN = "品名CDを入力してください";
        public const string MSG_ERR_B_KEIYAKU_KBN = "契約区分＝３．回収のみを選択してください";
        public const string MSG_ERR_C_KEIYAKU_KBN = "契約区分＝２．現金　または　３．回収のみ　のいずれかを選択してください";


        public const string MSG_CONF_C_SEIKYUU = "請求書書式１が現場別になっています。請求書送付先が未設定ですがよろしいですか？";
        public const string MSG_CONF_D_SEIKYUU = "請求書書式１が現場別になっています。送付先住所が未設定ですがよろしいですか？";
        public const string MSG_CONF_E_SHIHARAI = "支払明細書書式１が現場別になっています。支払明細書送付先が未設定ですがよろしいですか？";
        public const string MSG_CONF_F_SHIHARAI = "支払明細書書式１が現場別になっています。送付先住所が未設定ですがよろしいですか？";
        public const string MSG_CONF_A_TEIKI_KAISHUU = "定期回収情報をコースへ反映します。よろしいですか？"; // QN Tue Anh #158986
