// $Id: GyoushuHoshuForm.cs 54201 2015-07-01 05:06:18Z quocthang@e-mall.co.jp $
using System;
using System.Windows.Forms;
using GrapeCity.Win.MultiRow;
using GyoushuHoshu.Logic;
...
namespace GyoushuHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class GyoushuHoshuForm : SuperForm
    {
        /// <summary>
        /// 業種保守画面ロジック
        /// </summary>
        private GyoushuHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public GyoushuHoshuForm()
            : base(WINDOW_ID.M_GYOUSHU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new GyoushuHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.GyoushuHoshuConstans.GYOUSHU_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void GyoushuHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
