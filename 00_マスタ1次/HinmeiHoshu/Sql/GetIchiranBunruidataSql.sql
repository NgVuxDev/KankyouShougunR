...
FROM 
	dbo.M_BUNRUI BUNRUI
	LEFT JOIN dbo.M_HINMEI HINMEI ON HINMEI.BUNRUI_CD = BUNRUI.BUNRUI_CD
...
WHERE
 ...
 /*IF data.BUNRUI_CD != null*/AND BUNRUI.BUNRUI_CD LIKE '%' + /*data.BUNRUI_CD*/'000001' + '%'/*END*/
 /*IF data.BUNRUI_NAME_RYAKU != null*/AND BUNRUI.BUNRUI_NAME_RYAKU LIKE '%' +  /*data.BUNRUI_NAME_RYAKU*/ + '%'/*END*/
