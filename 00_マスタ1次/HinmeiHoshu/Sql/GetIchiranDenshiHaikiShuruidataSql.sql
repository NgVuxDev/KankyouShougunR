...
FROM 
	...
	INNER JOIN dbo.M_HINMEI HINMEI ON HINMEI.DM_HAIKI_SHURUI_CD = SHU4.HAIKI_SHURUI_CD
...
/*BEGIN*/WHERE
 /*IF data.HAIKI_SHURUI_CD != null*/SHU4.HAIKI_SHURUI_CD LIKE '%' + /*data.HAIKI_SHURUI_CD*/'000001' + '%'/*END*/
 /*IF data.HAIKI_SHURUI_NAME != null*/AND SHU4.HAIKI_SHURUI_NAME LIKE '%' +  /*data.HAIKI_SHURUI_NAME*/ + '%'/*END*/
