SELECT 
	...
	,ISNULL(HAIKI.HAIKI_NAME_RYAKU,N'') AS HAIKI_MONO_MEISHO_NAME
	,CONVERT(varchar,N'') AS ZEI_KBN_NAME_RYAKU
FROM 
	dbo.M_HAIKI_NAME HAIKI
	INNER JOIN dbo.M_HINMEI HINMEI ON HINMEI.HAIKI_MONO_MEISHO_CD = HAIKI.HAIKI_NAME_CD
...
WHERE
 ...
 /*IF data.HAIKI_MONO_MEISHO_CD != null*/AND HAIKI.HAIKI_NAME_CD LIKE '%' + /*data.HAIKI_MONO_MEISHO_CD_CD*/'000001' + '%'/*END*/
 /*IF data.HAIKI_MONO_MEISHO_NAME != null*/AND HAIKI.HAIKI_NAME_RYAKU LIKE '%' +  /*data.HAIKI_MONO_MEISHO_NAME*/ + '%'/*END*/
