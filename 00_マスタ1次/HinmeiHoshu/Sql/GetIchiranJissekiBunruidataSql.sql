...
FROM 
	...
	LEFT JOIN dbo.M_HINMEI HINMEI ON HINMEI.JISSEKI_BUNRUI_CD = MJB.JISSEKI_BUNRUI_CD
...
WHERE
 ...
 /*IF data.JISSEKI_BUNRUI_CD != null*/AND MJB.JISSEKI_BUNRUI_CD LIKE '%' + /*data.JISSEKI_BUNRUI_CD*/'001' + '%'/*END*/
 /*IF data.JISSEKI_BUNRUI_NAME_RYAKU != null*/AND MJB.JISSEKI_BUNRUI_NAME_RYAKU LIKE '%' +  /*data.JISSEKI_BUNRUI_NAME_RYAKU*/ + '%'/*END*/
