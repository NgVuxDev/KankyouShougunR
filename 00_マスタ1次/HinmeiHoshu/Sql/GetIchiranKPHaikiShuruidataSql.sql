...
FROM 
	...
	INNER JOIN dbo.M_HINMEI HINMEI ON HINMEI.KP_HAIKI_SHURUI_CD = SHU3.HAIKI_SHURUI_CD
...
/*BEGIN*/WHERE
 /*IF data.HAIKI_SHURUI_CD != null*/SHU3.HAIKI_SHURUI_CD LIKE '%' + /*data.HAIKI_SHURUI_CD*/'000001' + '%'/*END*/
 /*IF data.HAIKI_SHURUI_NAME_RYAKU != null*/AND SHU3.HAIKI_SHURUI_NAME_RYAKU LIKE '%' +  /*data.HAIKI_SHURUI_NAME_RYAKU*/ + '%'/*END*/
 AND SHU3.HAIKI_KBN_CD = 2
