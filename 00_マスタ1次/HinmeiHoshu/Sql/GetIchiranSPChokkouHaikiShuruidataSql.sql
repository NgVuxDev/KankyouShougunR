...
FROM 
	...
	INNER JOIN dbo.M_HINMEI HINMEI ON HINMEI.SP_CHOKKOU_HAIKI_SHURUI_CD = SHU1.HAIKI_SHURUI_CD
...
/*BEGIN*/WHERE
 /*IF data.HAIKI_SHURUI_CD != null*/SHU1.HAIKI_SHURUI_CD LIKE '%' + /*data.HAIKI_SHURUI_CD*/'000001' + '%'/*END*/
 /*IF data.HAIKI_SHURUI_NAME_RYAKU != null*/AND SHU1.HAIKI_SHURUI_NAME_RYAKU LIKE '%' +  /*data.HAIKI_SHURUI_NAME_RYAKU*/ + '%'/*END*/
 AND SHU1.HAIKI_KBN_CD = 1
