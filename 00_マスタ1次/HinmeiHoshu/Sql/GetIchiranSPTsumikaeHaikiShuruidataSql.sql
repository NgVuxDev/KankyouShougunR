...
FROM 
	...
	INNER JOIN dbo.M_HINMEI HINMEI ON HINMEI.SP_TSUMIKAE_HAIKI_SHURUI_CD = SHU2.HAIKI_SHURUI_CD
...
/*BEGIN*/WHERE
 /*IF data.HAIKI_SHURUI_CD != null*/SHU2.HAIKI_SHURUI_CD LIKE '%' + /*data.HAIKI_SHURUI_CD*/'000001' + '%'/*END*/
 /*IF data.HAIKI_SHURUI_NAME_RYAKU != null*/AND SHU2.HAIKI_SHURUI_NAME_RYAKU LIKE '%' +  /*data.HAIKI_SHURUI_NAME_RYAKU*/ + '%'/*END*/
 AND SHU2.HAIKI_KBN_CD = 3
 /*IF !deletechuFlg*/AND HINMEI.DELETE_FLG = 0/*END*/
 /*IF deletechuFlg*/AND (1 = 1/*END*/
 /*IF deletechuFlg*/OR HINMEI.DELETE_FLG = /*deletechuFlg*//*END*/
 /*IF deletechuFlg*/ )/*END*/
/*END*/
