...
FROM 
	dbo.M_SHURUI SHURUI
	LEFT JOIN dbo.M_HINMEI HINMEI ON HINMEI.SHURUI_CD = SHURUI.SHURUI_CD
...
WHERE
 ...
 /*IF data.SHURUI_CD != null*/AND SHURUI.SHURUI_CD LIKE '%' + /*data.SHURUI_CD*/'000001' + '%'/*END*/
 /*IF data.SHURUI_NAME_RYAKU != null*/AND SHURUI.SHURUI_NAME_RYAKU LIKE '%' +  /*data.SHURUI_NAME_RYAKU*/ + '%'/*END*/
