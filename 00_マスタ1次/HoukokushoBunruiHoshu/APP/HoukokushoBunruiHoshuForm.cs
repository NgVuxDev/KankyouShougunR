// $Id: HoukokushoBunruiHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
using System.Windows.Forms;
using GrapeCity.Win.MultiRow;
using HoukokushoBunruiHoshu.Logic;
...
namespace HoukokushoBunruiHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class HoukokushoBunruiHoshuForm : SuperForm
    {
        /// <summary>
        /// 報告書分類保守画面ロジック
        /// </summary>
        private HoukokushoBunruiHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public HoukokushoBunruiHoshuForm()
            : base(WINDOW_ID.M_HOUKOKUSHO_BUNRUI, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new HoukokushoBunruiHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.HoukokushoBunruiHoshuConstans.HOUKOKUSHO_BUNRUI_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void HoukokushoBunruiHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
