// $Id: ItakuKeiyakuHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
namespace ItakuKeiyakuHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ItakuKeiyakuHoshuForm : SuperForm
    {
        /// <summary>
        /// システムID
        /// </summary>
        ...
        /// 委託契約登録画面ロジック
        /// </summary>
        protected ItakuKeiyakuHoshuLogic logic;
        ...
        /// コンストラクタ(新規用)
        /// </summary>
        public ItakuKeiyakuHoshuForm(String keiyakuShurui,short tourokuHouhou)
            : base(WINDOW_ID.M_ITAKU_KEIYAKU_SANPAI, WINDOW_TYPE.NEW_WINDOW_FLAG)
        {
            ...
            this.logic = new ItakuKeiyakuHoshuLogic(this);
            ...
            else if (tourokuHouhou.Equals(Const.ItakuKeiyakuHoshuConstans.ITAKU_KEIYAKU_TOUROKU_HOUHOU_KIHON))
            {
                ...
                this.tabItakuKeiyakuData.TabPages.Remove(this.tabPage6);
                this.tabItakuKeiyakuData.TabPages.Remove(this.tabPage7);
        ...
        /// コンストラクタ(修正削除複写参照用)
        /// </summary>
        public ItakuKeiyakuHoshuForm(WINDOW_TYPE windowType, String systemId,short tourokuHouhou)
            : base(WINDOW_ID.M_ITAKU_KEIYAKU_SANPAI, windowType)
        {
            CommonShogunData.Create(SystemProperty.Shain.CD);
            InitializeComponent();
        ...
        public bool HeaderTitleInit()
        {
            try
            {
                ...
                ((DetailedHeaderForm)((BusinessBaseForm)this.ParentForm).headerForm).lb_title.Text =
                    WINDOW_TITLEExt.ToTitleString(WINDOW_ID.M_ITAKU_KEIYAKU_SANPAI);
                return false;
            }
            catch (Exception ex)
            {
        ...
        /// 排出事業者ポップアップ選択後処理
        /// </summary>
        public virtual void HAISHUTSU_JIGYOUSHA_CD_AfterPop()
        {
            if (!this.HAISHUTSU_JIGYOUSHA_CD.Text.Equals(string.Empty))
            {
                // コードから略称、住所をセットする
                bool catchErr = this.logic.SetJigyoushaData(this.HAISHUTSU_JIGYOUSHA_CD.Text, this.GYOUSHA_NAME_RYAKU, this.GYOUSHA_ADDRESS2, this.GYOUSHA_ADDRESS2, this.GYOUSHA_TODOUFUKEN_NAME);
                if (catchErr)
                {
                    return;
                }
        ...
        /// 排出事業者ポップアップ選択前処理
        /// </summary>
        public void HAISHUTSU_JIGYOUSHA_CD_BeforePop()
        {
        ...
        public virtual void PopupAfterHaishutsuJigyoujouCD()
        {
            if (!this.HAISHUTSU_JIGYOUSHA_CD.Text.Equals(string.Empty))
            {
                ...
                if (!this.HAISHUTSU_JIGYOUJOU_CD.Text.Equals(string.Empty) && !this.HAISHUTSU_JIGYOUJOU_CD.Text.Equals(this.PreviousValue))
                {
                    // 排出事業場の設定処理・関連処理を行う
                    catchErr = this.logic.CheckHaishutsuJigyoujouCD(new System.ComponentModel.CancelEventArgs());
                    if (catchErr)
                    {
                        return;
                    }
        ...
        public virtual void PopupAfterHaishutsuJigyoujouCDHstGenba()
        {
            ...
            if (!this.HAISHUTSU_JIGYOUSHA_CD.Text.Equals(string.Empty))
            {
                ...
                if (!Convert.ToString(this.listKihonHstGenba[cell.RowIndex, "GENBA_HAISHUTSU_JIGYOUJOU_CD"].Value).Equals(string.Empty) && !Convert.ToString(this.listKihonHstGenba[cell.RowIndex, "GENBA_HAISHUTSU_JIGYOUJOU_CD"].Value).Equals(this.PreviousValue))
                {
                    // コードから略称、住所をセットする
        ...
        {
            // カレントセルを取得する
            /* Cell eCell = this.listKihonHstGenba.CurrentCell;

             if (!this.HAISHUTSU_JIGYOUSHA_CD.Text.Equals(string.Empty) && !this.listHoukokushoBunrui[eCell.RowIndex, "YOTEI_HAISHUTSU_JIGYOUJOU_CD"].Value.ToString().Equals(string.Empty))
             {
                 // コードから略称、住所をセットする
                 this.logic.SetJigyoujouData(this.HAISHUTSU_JIGYOUSHA_CD.Text, this.listHoukokushoBunrui[eCell.RowIndex, "YOTEI_HAISHUTSU_JIGYOUJOU_CD"].Value.ToString(), this.listHoukokushoBunrui[eCell.RowIndex, "YOTEI_HAISHUTSU_JIGYOUJOU_NAME"], this.listHoukokushoBunrui[eCell.RowIndex, "YOTEI_HAISHUTSU_JIGYOUJOU_ADDRESS1"], this.listHoukokushoBunrui[eCell.RowIndex, "YOTEI_HAISHUTSU_JIGYOUJOU_ADDRESS2"], this.listHoukokushoBunrui[eCell.RowIndex, "YOTEI_HAISHUTSU_JIGYOUJOU_TODOUFUKEN_NAME"]);
             }*/
        }
        ...
        public virtual void PopupAfterUnpanGyousha()
        {
            /*
            // カレントセルを取得する
            Cell eCell = this.listBetsu2.CurrentCell;

            if (this.listBetsu2.Rows.Count > 1 && (this.ITAKU_KEIYAKU_SHURUI.Text == "1" || this.ITAKU_KEIYAKU_SHURUI.Text == "3") && eCell.RowIndex > 0)
            {
                return;
            }

            if (!this.listBetsu2[eCell.RowIndex, "UNPAN_GYOUSHA_CD"].Value.ToString().Equals(string.Empty))
            {
                this.logic.SetJigyoushaData(this.listBetsu2[eCell.RowIndex, "UNPAN_GYOUSHA_CD"].Value.ToString(), this.listBetsu2[eCell.RowIndex, "UNPAN_GYOUSHA_NAME"], this.listBetsu2[eCell.RowIndex, "UNPAN_GYOUSHA_ADDRESS1"], this.listBetsu2[eCell.RowIndex, "UNPAN_GYOUSHA_ADDRESS2"], this.listBetsu2[eCell.RowIndex, "UNPAN_TODOUFUKEN_NAME"]);
                this.PreviousValue = this.listBetsu2[eCell.RowIndex, "UNPAN_GYOUSHA_CD"].Value.ToString();
            }
             */
        ...
        {
            // カレントセルを取得する
            /*Cell eCell = this.listTSUMIKAE.CurrentCell;

            if (!this.listTSUMIKAE[eCell.RowIndex, "TSUMIKAE_HOKANBA_CD"].Value.ToString().Equals(string.Empty))
            {
                // コードから略称、住所をセットする
                this.logic.SetJigyoujouData(this.listTSUMIKAE[eCell.RowIndex, "UNPAN_GYOUSHA_CD"].Value.ToString(), this.listTSUMIKAE[eCell.RowIndex, "TSUMIKAE_HOKANBA_CD"].Value.ToString(), this.listTSUMIKAE[eCell.RowIndex, "TSUMIKAE_HOKANBA_NAME"], this.listTSUMIKAE[eCell.RowIndex, "TSUMIKAE_HOKANBA_ADDRESS1"], this.listTSUMIKAE[eCell.RowIndex, "TSUMIKAE_HOKANBA_ADDRESS2"], this.listTSUMIKAE[eCell.RowIndex, "TSUMIKAE_HOKANBA_TODOUFUKEN_NAME"]);
            }*/
            this.logic.CheckTSUMIKAEGyoushaCD();
        }

        /// <summary>
        /// 積替保管場所ポップアップ選択後処理
        /// </summary>
        public virtual void PopupAfterTsumikaeHokanba()
        {
            // カレントセルを取得する
            ...
            {
                // コードから略称、住所をセットする
                bool catchErr = this.logic.SetJigyoushaData(this.listTsumikae[cell.RowIndex, "UNPAN_GYOUSHA_CD"].Value.ToString(), this.listTsumikae[cell.RowIndex, "UNPAN_GYOUSHA_NAME"], null, null, null);
                if (catchErr)
                {
                    return;
                }
                if (!Convert.ToString(this.listTsumikae[cell.RowIndex, "TSUMIKAE_HOKANBA_CD"].Value).Equals(string.Empty) && !Convert.ToString(this.listTsumikae[cell.RowIndex, "TSUMIKAE_HOKANBA_CD"]).Equals(this.PreviousValue))
                {
                    // コードから略称、住所をセットする
                    ...
                    //this.PreviousValue = this.listTSUMIKAE[eCell.RowIndex, "TSUMIKAE_HOKANBA_CD"].Value.ToString();
                }
            }
        }
        ...
        {
            // カレントセルを取得する
            /*Cell eCell = this.listBetsu3.CurrentCell;

            if (!this.listBetsu3[eCell.RowIndex, "SHOBUN_GYOUSHA_CD"].Value.ToString().Equals(string.Empty))
            {
                // コードから略称、住所をセットする
                this.logic.SetJigyoushaData(this.listBetsu3[eCell.RowIndex, "SHOBUN_GYOUSHA_CD"].Value.ToString(), this.listBetsu3[eCell.RowIndex, "SHOBUN_GYOUSHA_NAME"], this.listBetsu3[eCell.RowIndex, "SHOBUN_GYOUSHA_ADDRESS1"], this.listBetsu3[eCell.RowIndex, "SHOBUN_GYOUSHA_ADDRESS2"], this.listBetsu3[eCell.RowIndex, "SHOBUN_GYOUSHA_TODOUFUKEN_NAME"]);
            }*/
            this.logic.CheckShobunGyoushaCD();
        }

        /// <summary>
        /// 別表3一覧内の処分事業場ポップアップ選択後処理
        /// </summary>
        public virtual void PopupAfterShobunJigyoujouCDBetsu3()
        {
            ...
            if (!Convert.ToString(this.listBetsu3[cell.RowIndex, "SHOBUN_GYOUSHA_CD"].Value).Equals(string.Empty))
            {
                // コードから略称、住所をセットする
                ...
                if (!Convert.ToString(this.listBetsu3[cell.RowIndex, "SHOBUN_JIGYOUJOU_CD"].Value).Equals(string.Empty) && !Convert.ToString(this.listBetsu3[cell.RowIndex, "SHOBUN_JIGYOUJOU_CD"].Value).Equals(this.PreviousValue))
                {
                    // コードから略称、住所をセットする
                    catchErr = false;
                    ...
                    //this.PreviousValue = this.listBetsu3[eCell.RowIndex, "SHOBUN_JIGYOUJOU_CD"].Value.ToString();
                }
            }
        }
        ...
        /// <summary>
        /// 別表4一覧内の処分事業者ポップアップ選択後処理
        /// </summary>
        public virtual void PopupAfterShobunGyoushaCDBetsu4()
        {
            // カレントセルを取得する
            /*Cell eCell = this.listBetsu4.CurrentCell;

            if (!this.listBetsu4[eCell.RowIndex, "LAST_SHOBUN_GYOUSHA_CD"].Value.ToString().Equals(string.Empty))
            {
                // コードから略称、住所をセットする
                this.logic.SetJigyoushaData(this.listBetsu4[eCell.RowIndex, "LAST_SHOBUN_GYOUSHA_CD"].Value.ToString(), this.listBetsu4[eCell.RowIndex, "LAST_SHOBUN_GYOUSHA_NAME"], this.listBetsu4[eCell.RowIndex, "LAST_SHOBUN_GYOUSHA_ADDRESS1"], this.listBetsu4[eCell.RowIndex, "LAST_SHOBUN_GYOUSHA_ADDRESS2"], this.listBetsu4[eCell.RowIndex, "LAST_SHOBUN_GYOUSHA_TODOUFUKEN_NAME"]);
            }*/
            //this.listBetsu4[eCell.RowIndex, "LAST_SHOBUN_GYOUSHA_CD"]
            this.logic.CheckLastShobunGyoushaCD();
        }

        /// <summary>
        /// 別表4一覧内の処分事業場ポップアップ選択後処理
        /// </summary>
        public virtual void PopupAfterShobunJigyoujouCDBetsu4()
        {
            ...
            if (!Convert.ToString(this.listBetsu4[cell.RowIndex, "LAST_SHOBUN_GYOUSHA_CD"].Value).Equals(string.Empty))
            {
                // コードから略称、住所をセットする
                ...
                if (!Convert.ToString(this.listBetsu4[cell.RowIndex, "LAST_SHOBUN_JIGYOUJOU_CD"].Value).Equals(string.Empty) && !Convert.ToString(this.listBetsu4[cell.RowIndex, "LAST_SHOBUN_JIGYOUJOU_CD"].Value).Equals(this.PreviousValue))
                {
                    // コードから略称、住所をセットする
                    ...
                    //this.PreviousValue = this.listBetsu4[eCell.RowIndex, "LAST_SHOBUN_JIGYOUJOU_CD"].Value.ToString();
                }
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        internal virtual void ListBetsu1YoteiCellEnter(object sender, CellEventArgs e)
        {
            this.logic.ListBetsu1YoteiCellEnter(e);
        }

        /// <summary>
        /// 委託契約 別表1予定一覧の行エンターイベント
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        internal virtual void ListBetsu1YoteiRowEnter(object sender, CellEventArgs e)
        {
            /*var eRow = this.listHoukokushoBunrui.Rows[e.RowIndex];
            if (!eRow.IsNewRow)
            {
                if (eRow["YOTEI_KIKAN"].Value == null || string.IsNullOrEmpty(Convert.ToString(eRow["YOTEI_KIKAN"].Value)))
                {
                    eRow["YOTEI_KIKAN"].Value = 1;
                }
            }
            else
            {
                //新し行の場合、デフォルト値「年」で設定
                if (String.IsNullOrEmpty(Convert.ToString(eRow["YOTEI_KIKAN"].Value)))
                {
                    eRow["YOTEI_KIKAN"].Value = 1;
                }
            }*/
        ...
        {
            //if (this.logic.IsYoteiTabSelect)
            //{
        ...
        internal virtual void ListTsumikaeCellFormatting(object sender, CellFormattingEventArgs e)
        {
            ...
            {
                e.Value = this.logic.FormatSystemSuuryou(Convert.ToDecimal(e.Value), out catchErr);
            }
            if (catchErr)
            {
                return;
        ...
        /// <summary>
        /// 委託契約 積替一覧のデータエラーイベント
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        internal virtual void ListTsumikaeDataError(object sender, DataErrorEventArgs e)
        {
            // 例外を無視する
            if (e.CellIndex < 0)
                return;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        internal virtual void UpnKyokaKbnTextChanged(object sender, EventArgs e)
        {
            //this.logic.ChangeKyokaKbnText(this.UPNKYOKA_KBN, this.UPNKYOKA_NAME);
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        internal virtual void SbnKyokaKbnTextChanged(object sender, EventArgs e)
        {
            //this.logic.ChangeKyokaKbnText(this.SBNKYOKA_KBN, this.SBNKYOKA_NAME);
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        //public void ListBetsu3EditingControlShowing(object sender, EditingControlShowingEventArgs e)
        //{
        //    e.Control.KeyDown -= this.ListBetsu3EditingControlKeyDown;
        //    e.Control.KeyDown += this.ListBetsu3EditingControlKeyDown;
        //}
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        //private void ListBetsu3EditingControlKeyDown(object sender, KeyEventArgs e)
        //{
        //    this.logic.CheckListBetsu3Popup(e);
        //}
                ...
                foreach (Row dr in this.listHinmei.Rows)
                {
                    if (dr.IsNewRow ||
                        ((dr["HINMEI_CD"].Value == null || string.IsNullOrWhiteSpace(dr["HINMEI_CD"].Value.ToString())) &&
                         ...
                         (dr["YUNYU"].Value == null || string.IsNullOrWhiteSpace(dr["YUNYU"].Value.ToString()) || !bool.Parse(dr["YUNYU"].Value.ToString())) &&
                         (dr["BUNSEKISHOUMEISHO_TEIJIJIKI"].Value == null || string.IsNullOrWhiteSpace(dr["BUNSEKISHOUMEISHO_TEIJIJIKI"].Value.ToString())) &&
