...
AND CK.FUTSUU_KYOKA_END >= CONVERT(DATETIME, /*data.FUTSUU_KYOKA_BEGIN*/'2013-01-01', 120)
/*END*/
/*IF !data.FUTSUU_KYOKA_END.IsNull*/
AND CK.FUTSUU_KYOKA_END <= CONVERT(DATETIME, /*data.FUTSUU_KYOKA_END*/'2013-01-01', 120)
/*END*/
AND CK.DELETE_FLG = 0