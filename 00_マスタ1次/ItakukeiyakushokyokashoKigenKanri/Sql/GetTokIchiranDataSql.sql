SELECT 
	...
	KYO.KYOKA_KBN,
	KYO.TOKUBETSU_KYOKA_NO AS KYOKA_NO,
...
FROM 
	...
	LEFT JOIN dbo.M_ITAKU_UPN_KYOKASHO UPN ON UPN.GYOUSHA_CD = KYO.GYOUSHA_CD AND UPN.GENBA_CD = KYO.GENBA_CD AND UPN.CHIIKI_CD = KYO.CHIIKI_CD AND UPN.KYOKA_KBN = (KYO.KYOKA_KBN * 2) AND UPN.KYOKA_NO = KYO.TOKUBETSU_KYOKA_NO
	LEFT JOIN dbo.M_ITAKU_SBN_KYOKASHO SBN ON SBN.GYOUSHA_CD = KYO.GYOUSHA_CD AND SBN.GENBA_CD = KYO.GENBA_CD AND SBN.CHIIKI_CD = KYO.CHIIKI_CD AND SBN.KYOKA_KBN = (KYO.KYOKA_KBN * 2) AND SBN.KYOKA_NO = KYO.TOKUBETSU_KYOKA_NO
...
WHERE KYO.DELETE_FLG = 0
  AND (KYO.TOKUBETSU_KYOKA_NO IS NOT NULL AND KYO.TOKUBETSU_KYOKA_NO != '')
  ...
  /*IF data.TOKUBETSU_KYOKA_NO != null*//*IF data.TOKUBETSU_KYOKA_NO != ''*/AND KYO.TOKUBETSU_KYOKA_NO = /*data.TOKUBETSU_KYOKA_NO*/'00000000000'/*END*//*END*/
  /*IF !data.TOKUBETSU_KYOKA_BEGIN.IsNull*/AND KYO.TOKUBETSU_KYOKA_END >= CONVERT(DATETIME, /*data.TOKUBETSU_KYOKA_BEGIN*/null, 120)/*END*/
  /*IF !data.TOKUBETSU_KYOKA_END.IsNull*/AND KYO.TOKUBETSU_KYOKA_END <= CONVERT(DATETIME, /*data.TOKUBETSU_KYOKA_END*/null, 120)/*END*/
ORDER BY KYO.KYOKA_KBN, KYO.GYOUSHA_CD, KYO.GENBA_CD, KYO.CHIIKI_CD, KYO.TOKUBETSU_KYOKA_NO
