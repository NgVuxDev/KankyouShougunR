// $Id: UIForm.cs 50589 2015-05-26 00:19:54Z ueda $
using System;
using System.Windows.Forms;
using GrapeCity.Win.MultiRow;
using Seasar.Quill;
using Seasar.Quill.Attrs;
using JissekiBunruiHoshu.Logic;
...
namespace JissekiBunruiHoshu.APP
{
    ...
    public partial class UIForm : SuperForm
    {
        ...
        /// </summary>
        public UIForm()
            : base(WINDOW_ID.M_JISSEKI_BUNRUI, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();
        ...
        public virtual void Regist(object sender, EventArgs e)
        {
            ...
            #region 県央資源カスタマイズ(権限チェック)
            // 権限チェック
            if (!r_framework.Authority.Manager.CheckAuthority("G24060415_007", r_framework.Const.WINDOW_TYPE.UPDATE_WINDOW_FLAG, false))
            {
                MessageBoxShowLogic msgLogic = new MessageBoxShowLogic();
                msgLogic.MessageBoxShow("E158", "登録");
                return;
            }
            #endregion
        ...
        public virtual void LogicalDelete(object sender, EventArgs e)
        {
            ...
            {
                MessageBoxShowLogic msgLogic = new MessageBoxShowLogic();
                msgLogic.MessageBoxShow("E158", "削除");
                return;
            }
            #endregion
        ...
        {
            // 実績分類CDの重複チェック
            if (e.CellName.Equals(Const.ConstCls.JISSEKI_BUNRUI_CD))
            {
