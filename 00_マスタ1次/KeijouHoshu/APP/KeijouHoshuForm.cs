// $Id: KeijouHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
namespace KeijouHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class KeijouHoshuForm : SuperForm
    {
        /// <summary>
        /// 形状保守画面ロジック
        /// </summary>
        private KeijouHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public KeijouHoshuForm()
            : base(WINDOW_ID.M_KEIJOU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new KeijouHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.KeijouHoshuConstans.KEIJOU_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void KeijouHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
