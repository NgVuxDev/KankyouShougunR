...
FROM
    ...
    INNER JOIN dbo.M_KEIRYOU_CHOUSEI KEI ON HIN.HINMEI_CD = KEI.HINMEI_CD
...
/*BEGIN*/WHERE
 /*IF data.SHURUI_CD != null*/HIN.SHURUI_CD LIKE '%' +  /*data.SHURUI_CD*/ + '%'/*END*/
 /*IF data.HINMEI_CD != null*/AND HIN.HINMEI_CD LIKE '%' +  /*data.HINMEI_CD*/ + '%'/*END*/
