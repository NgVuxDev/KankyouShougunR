// $Id: KeitaiKbnHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
using System.Windows.Forms;
using GrapeCity.Win.MultiRow;
using KeitaiKbnHoshu.Logic;
...
namespace KeitaiKbnHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class KeitaiKbnHoshuForm : SuperForm
    {
        /// <summary>
        /// 形態区分保守画面ロジック
        /// </summary>
        private KeitaiKbnHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public KeitaiKbnHoshuForm()
            : base(WINDOW_ID.M_KEITAI_KBN, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new KeitaiKbnHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.KeitaiKbnHoshuConstans.KEITAI_KBN_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void KeitaiKbnHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
