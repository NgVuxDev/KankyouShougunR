// $Id: KensakuKyoutsuuPopupForm.cs 43381 2015-03-02 00:24:25Z nagata $
using System;
using System.Windows.Forms;
using KensakuKyoutsuuPopup1.Logic;
...
namespace KensakuKyoutsuuPopup1.APP
{
    ...
    /// 検索共通ポップアップ画面
    /// </summary>
    public partial class KensakuKyoutsuuPopupForm : SuperPopupForm
    {
        #region フィールド
        /// <summary>
        /// 共通ロジック
        /// </summary>
        public KensakuKyoutsuuPopupLogic logic;
        ...
        /// コンストラクタ
        /// </summary>
        public KensakuKyoutsuuPopupForm()
        {
            InitializeComponent();
        ...
        protected override void OnLoad(System.EventArgs e)
        {
            ...
            logic = new KensakuKyoutsuuPopupLogic(this);
        ...
        /// <param name="e"></param>
        private void KensakuKyoutsuuPopupForm_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void KensakuKyoutsuuPopupForm_KeyDown(object sender, KeyEventArgs e)
        {
            if (this.imeStatus.IsConversion)
            {
                return;
        ...
        internal void CONDITION_VALUE_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            ...
            {
                if (string.IsNullOrEmpty(this.CONDITION_VALUE.Text))
                {
        ...
        {
            this.KensakuKyoutsuuPopupForm_KeyUp(sender, e);
        }
