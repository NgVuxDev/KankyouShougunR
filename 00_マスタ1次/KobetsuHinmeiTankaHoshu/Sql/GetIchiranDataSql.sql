SELECT
    KON.SYS_ID
    ,KON.DENPYOU_KBN_CD
    ,ISNULL(KON.TORIHIKISAKI_CD,'') AS TORIHIKISAKI_CD
    ,ISNULL(KON.GYOUSHA_CD,'') AS GYOUSHA_CD
    ,ISNULL(KON.GENBA_CD,'') AS GENBA_CD
...
WHERE
	KON.DENPYOU_KBN_CD =/*data.DENPYOU_KBN_CD*/0
