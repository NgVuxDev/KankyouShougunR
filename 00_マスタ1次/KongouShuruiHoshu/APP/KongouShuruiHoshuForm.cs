// $Id:KongouShuruiHoshuForm.cs 233 2013-07-10 09:00:34Z sanbongi $
using System;
using System.Windows.Forms;
using GrapeCity.Win.MultiRow;
using KongouShuruiHoshu.Logic;
...
namespace KongouShuruiHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class KongouShuruiHoshuForm : SuperForm
    {
        /// <summary>
        /// 混合種類保守画面ロジック
        /// </summary>
        private KongouShuruiHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public KongouShuruiHoshuForm()
            : base(WINDOW_ID.M_KONGOU_SHURUI, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new KongouShuruiHoshuLogic(this);
        ...
        public virtual void Search(object sender, EventArgs e)
        {
            ...
            {
                messageShowLogic.MessageBoxShow("E001", "廃棄物区分");
        ...
        public virtual void FormClose(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.HaikiValue_Text = this.HAIKI_KBN_CD.Text;
        ...
        {
            if (e.CellName.Equals(Const.KongouShuruiHoshuConstans.KONGOU_SHURUI_CD))
            {
        ...
        private void HAIKI_CD_TextChanged(object sender, EventArgs e)
        {
            ...
            if (this.HAIKI_KBN_CD.Text.Length > 1)
            {
                this.logic.SearchHaikiName();
            }
        ...
        {
            this.HAIKI_KBN_CD.Enabled = !this.HAIKI_KBN_CD.Enabled;
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void KongouShuruiHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
