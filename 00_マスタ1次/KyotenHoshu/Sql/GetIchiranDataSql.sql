...
/*BEGIN*/WHERE
 ...
 /*IF data.KEIRYOU_SHOUMEI_1 != null*/AND KYO.KEIRYOU_SHOUMEI_1 LIKE '%' +  /*data.KEIRYOU_SHOUMEI_1*/ + '%'/*END*/
 /*IF data.KEIRYOU_SHOUMEI_2 != null*/AND KYO.KEIRYOU_SHOUMEI_2 LIKE '%' +  /*data.KEIRYOU_SHOUMEI_2*/ + '%'/*END*/
 /*IF data.KEIRYOU_SHOUMEI_3 != null*/AND KYO.KEIRYOU_SHOUMEI_3 LIKE '%' +  /*data.KEIRYOU_SHOUMEI_3*/ + '%'/*END*/
/*END*/
