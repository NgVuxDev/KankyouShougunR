// $Id: ManiFestShuRuiHoshuForm.cs 18911 2014-04-10 04:23:30Z sc.m.moriya@willwave.jp $
using System;
...
using ManiFestShuRuiHoshu.Logic;
...
namespace ManiFestShuRuiHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ManiFestShuRuiHoshuForm : SuperForm
    {

        /// <summary>
        /// マニフェスト種類画面ロジック
        /// </summary>
        private ManiFestShuRuiHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ManiFestShuRuiHoshuForm()
            : base(WINDOW_ID.M_MANIFEST_SHURUI, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ManiFestShuRuiHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.ManiFestShuRuiHoshuConstans.MANIFEST_SHURUI_CD))
            {
        ...
        //{
        //    if (e.CellName.Equals("MANIFEST_SHURUI_CD"))
        //    {
