// $Id: NisugataHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
namespace NisugataHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class NisugataHoshuForm : SuperForm
    {
        /// <summary>
        /// 荷姿保守画面ロジック
        /// </summary>
        private NisugataHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public NisugataHoshuForm()
            : base(WINDOW_ID.M_NISUGATA, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new NisugataHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.NisugataHoshuConstans.NISUGATA_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void NisugataHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
