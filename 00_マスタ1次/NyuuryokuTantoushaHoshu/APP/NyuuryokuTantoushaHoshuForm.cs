// $Id: NyuuryokuTantoushaHoshuForm.cs 19014 2014-04-11 04:23:12Z sc.h.hashimoto $
using System;
...
using NyuuryokuTantoushaHoshu.Logic;
...
namespace NyuuryokuTantoushaHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class NyuuryokuTantoushaHoshuForm : SuperForm
    {
        /// <summary>
        /// 入力担当者保守画面ロジック
        /// </summary>
        private NyuuryokuTantoushaHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public NyuuryokuTantoushaHoshuForm()
            : base(WINDOW_ID.M_NYUURYOKU_TANTOUSHA, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new NyuuryokuTantoushaHoshuLogic(this);
