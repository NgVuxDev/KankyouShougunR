// $Id: NyuushukkinKbnHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
using System.Windows.Forms;
using GrapeCity.Win.MultiRow;
using NyuushukkinKbnHoshu.Logic;
...
namespace NyuushukkinKbnHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class NyuushukkinKbnHoshuForm : SuperForm
    {
        /// <summary>
        /// 入出金区分保守画面ロジック
        /// </summary>
        private NyuushukkinKbnHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public NyuushukkinKbnHoshuForm()
            : base(WINDOW_ID.M_NYUUSHUKKIN_KBN, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new NyuushukkinKbnHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.NyuushukkinKbnHoshuConstans.NYUUSHUKKIN_KBN_CD))
            {
        ...
        //{
        //    if (e.CellName.Equals("NYUUSHUKKIN_KBN_CD"))
        //    {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void NyuushukkinKbnHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
