// $Id: ShaShuHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
namespace ShashuHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ShashuHoshuForm : SuperForm
    {
        /// <summary>
        /// 車種保守画面ロジック
        /// </summary>
        private ShashuHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ShashuHoshuForm()
            : base(WINDOW_ID.M_SHASHU , WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ShashuHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.ShashuHoshuConstans.SHASHU_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ShashuHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
