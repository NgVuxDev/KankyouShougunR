// $Id:ShobunHouhouHoshuForm.cs 208 2013-06-26 09:49:42Z sanbongi $
using System;
...
namespace ShobunHouhouHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ShobunHouhouHoshuForm : SuperForm
    {
        /// <summary>
        /// 処分方法保守画面ロジック
        /// </summary>
        private ShobunHouhouHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ShobunHouhouHoshuForm()
            : base(WINDOW_ID.M_SHOBUN_HOUHOU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ShobunHouhouHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.ShobunHouhouHoshuConstans.SHOBUN_HOUHOU_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ShobunHouhouHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
