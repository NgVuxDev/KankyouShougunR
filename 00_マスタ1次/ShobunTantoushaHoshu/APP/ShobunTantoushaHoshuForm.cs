// $Id: ShobunTantoushaHoshuForm.cs 19021 2014-04-11 05:01:14Z sc.m.moriya@willwave.jp $
using System;
...
using ShobunTantoushaHoshu.Logic;
...
namespace ShobunTantoushaHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ShobunTantoushaHoshuForm : SuperForm
    {

        /// <summary>
        /// 処分担当者保守画面ロジック
        /// </summary>
        private ShobunTantoushaHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ShobunTantoushaHoshuForm()
            : base(WINDOW_ID.M_SHOBUN_TANTOUSHA, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ShobunTantoushaHoshuLogic(this);
        ...
        public virtual void FormClose(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.ICHIRAN_HYOUJI_JOUKEN_DELETED = this.ICHIRAN_HYOUJI_JOUKEN_TEKIYOU.Checked;
        ...
        {
            if (e.CellName.Equals(Const.ShobunTantoushaHoshuConstans.SHAIN_CD))
            {
