// $Id: ShuruiHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
namespace ShuruiHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ShuruiHoshuForm : SuperForm
    {
        /// <summary>
        /// 種類保守画面ロジック
        /// </summary>
        private ShuruiHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ShuruiHoshuForm()
            : base(WINDOW_ID.M_SHURUI, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ShuruiHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.ShuruiHoshuConstans.SHURUI_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ShuruiHoshuForm_Shown(object sender, EventArgs e)
        {
            this.logic.EditableToPrimaryKey();
        }
