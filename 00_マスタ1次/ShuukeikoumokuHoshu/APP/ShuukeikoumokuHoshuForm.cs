// $Id: ShuukeikoumokuHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
using ShuukeikoumokuHoshu.Logic;
...
namespace ShuukeikoumokuHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class ShuukeikoumokuHoshuForm : SuperForm
    {

        /// <summary>
        /// 集計項目保守画面ロジック
        /// </summary>
        private ShuukeikoumokuHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ShuukeikoumokuHoshuForm()
            : base(WINDOW_ID.M_SHUUKEI_KOUMOKU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new ShuukeikoumokuHoshuLogic(this);
        ...
        public virtual void FormClose(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.ICHIRAN_HYOUJI_JOUKEN_DELETED = this.ICHIRAN_HYOUJI_JOUKEN_DELETE.Checked;
        ...
        {
            if (e.CellName.Equals(Const.ShuukeikoumokuHoshuConstans.SHUUKEI_KOUMOKU_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ShuukeikoumokuHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
