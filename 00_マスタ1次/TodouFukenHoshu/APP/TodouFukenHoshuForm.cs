// $Id: TodouFukenHoshuForm.cs 38244 2014-12-25 07:16:22Z fangjk@oec-h.com $
using System;
...
namespace TodouFukenHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class TodouFukenHoshuForm : SuperForm
    {

        /// <summary>
        /// 都道府県入力画面ロジック
        /// </summary>
        private TodouFukenHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public TodouFukenHoshuForm()
            : base(WINDOW_ID.M_TODOUFUKEN, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new TodouFukenHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.TodouFukenHoshuConstans.TODOUFUKEN_CD))
            {
        ...
        //{
        //    if (e.CellName.Equals("TODOUFUKEN_CD"))
        //    {
