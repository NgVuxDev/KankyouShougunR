// $Id: TorihikikubunHoshuForm.cs 18849 2014-04-09 09:06:29Z sc.m.moriya@willwave.jp $
using System;
...
using TorihikikubunHoshu.Logic;
...
namespace TorihikikubunHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class TorihikikubunHoshuForm : SuperForm
    {
        /// <summary>
        /// 取引区分保守画面ロジック
        /// </summary>
        private TorihikikubunHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public TorihikikubunHoshuForm()
            : base(WINDOW_ID.M_TORIHIKI_KBN, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new TorihikikubunHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.TorihikikubunHoshuConstans.TORIHIKI_KBN_CD))
            {
