// $Id: TorihikisakiHoshuConstans.cs 49000 2015-05-07 04:53:56Z y-hosokawa@takumi-sys.co.jp $
namespace TorihikisakiHoshu.Const
{
    public class TorihikisakiHoshuConstans
    {
        /// <summary>
        ...
        /// <summary>M_TORIHIKISAKIのTORIHIKISAKI_CD</summary>
        ...
        public const string MSG_CONF_A = "請求書書式１が請求先別になっています。請求書送付先が未設定ですがよろしいですか？";
        public const string MSG_CONF_B = "請求書書式１が請求先別になっています。送付先住所が未設定ですがよろしいですか？";
        public const string MSG_CONF_C = "支払明細書書式１が支払先別になっています。支払明細書送付先が未設定ですがよろしいですか？";
        public const string MSG_CONF_D = "支払明細書書式１が支払先別になっています。送付先住所が未設定ですがよろしいですか？";
