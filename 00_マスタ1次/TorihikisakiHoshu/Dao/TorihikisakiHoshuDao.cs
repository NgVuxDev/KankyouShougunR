...
namespace TorihikisakiHoshu.Dao
{
    ...
    public interface IDenshiShinseiEntryDao : IS2Dao
    {
        ...
        [SqlFile("TorihikisakiHoshu.Sql.GetShouninzumiDenshiShinseiEntryList.sql")]
    ...
    public interface GenbaDao : IS2Dao
    {
        ...
        [SqlFile("TorihikisakiHoshu.Sql.UpdateGenbaCD.sql")]
        bool UpdateGenba(string oldTORIHIKISAKI_CD, string newTORIHIKISAKI_CD);
    }
}
