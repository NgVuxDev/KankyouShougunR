// $Id: UnitHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
namespace UnitHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class UnitHoshuForm : SuperForm
    {

        /// <summary>
        /// 単位入力画面ロジック
        /// </summary>
        private UnitHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public UnitHoshuForm()
            : base(WINDOW_ID.M_UNIT, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new UnitHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.UnitHoshuConstans.UNIT_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UnitHoshuForm_Shown(object sender, EventArgs e)
        {
        	// 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
