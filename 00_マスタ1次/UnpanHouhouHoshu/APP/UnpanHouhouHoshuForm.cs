// $Id: UnpanHouhouHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
namespace UnpanHouhouHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class UnpanHouhouHoshuForm : SuperForm
    {
        /// <summary>
        /// 運搬方法保守画面ロジック
        /// </summary>
        private UnpanHouhouHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public UnpanHouhouHoshuForm()
            : base(WINDOW_ID.M_UNPAN_HOUHOU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new UnpanHouhouHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.UnpanHouhouHoshuConstans.UNPAN_HOUHOU_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void UnpanHouhouHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
