// $Id: UntenshaHoshuForm.cs 19011 2014-04-11 04:12:53Z sc.h.hashimoto $
using System;
...
namespace UntenshaHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class UntenshaHoshuForm : SuperForm
    {
        /// <summary>
        /// 運転者保守画面ロジック
        /// </summary>
        private UntenshaHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public UntenshaHoshuForm()
            : base(WINDOW_ID.M_UNTENSHA, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new UntenshaHoshuLogic(this);
