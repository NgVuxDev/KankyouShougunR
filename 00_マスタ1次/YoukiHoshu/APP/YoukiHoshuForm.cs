// $Id: YoukiHoshuForm.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
namespace YoukiHoshu.APP
{
    ...
    /// </summary>
    [Implementation]
    public partial class YoukiHoshuForm : SuperForm
    {
        /// <summary>
        /// 容器保守画面ロジック
        /// </summary>
        private YoukiHoshuLogic logic;
        internal MessageBoxShowLogic errmessage = new MessageBoxShowLogic();

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public YoukiHoshuForm()
            : base(WINDOW_ID.M_YOUKI, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new YoukiHoshuLogic(this);
        ...
        {
            if (e.CellName.Equals(Const.YoukiHoshuConstans.YOUKI_CD))
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void YoukiHoshuForm_Shown(object sender, EventArgs e)
        {
            // 主キーを非活性にする
            this.logic.EditableToPrimaryKey();
        }
