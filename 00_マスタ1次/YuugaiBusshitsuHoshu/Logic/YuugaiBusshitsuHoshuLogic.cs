// $Id: YuugaiBusshitsuHoshuLogic.cs 51723 2015-06-08 06:14:52Z hoangvu@e-mall.co.jp $
using System;
...
using YuugaiBusshitsuHoshu.APP;
using YuugaiBusshitsuHoshu.Validator;

namespace YuugaiBusshitsuHoshu.Logic
{
    /// <summary>
    /// 有害物質保守画面のビジネスロジック
    /// </summary>
    public class YuugaiBusshitsuHoshuLogic : IBuisinessLogic
    {
        #region フィールド

        private readonly string ButtonInfoXmlPath = "YuugaiBusshitsuHoshu.Setting.ButtonSetting.xml";

        private readonly string GET_ICHIRAN_YUUGAI_BUSSHITSU_DATA_SQL = "YuugaiBusshitsuHoshu.Sql.GetIchiranYuugaiBusshitsudataSql.sql";

        private readonly string GET_YUUGAI_BUSSHITSU_DATA_SQL = "YuugaiBusshitsuHoshu.Sql.GetYuugaiBusshitsudataSql.sql";

        /// <summary>
        /// 有害物質保守画面Form
        /// </summary>
        private YuugaiBusshitsuHoshuForm form;
        ...
        private M_YUUGAI_BUSSHITSU[] entitys;
        ...
        /// 有害物質のDao
        /// </summary>
        private IM_YUUGAI_BUSSHITSUDao dao;
        ...
        /// 検索条件
        /// </summary>
        public M_YUUGAI_BUSSHITSU SearchString { get; set; }
        ...
        public YuugaiBusshitsuHoshuLogic(YuugaiBusshitsuHoshuForm targetForm)
        {
        ...
        public int Search()
        {
            try
            {
                ...
                this.SearchResultAll = dao.GetDataBySqlFile(this.GET_YUUGAI_BUSSHITSU_DATA_SQL, new M_YUUGAI_BUSSHITSU());
        ...
        public bool CreateEntity(bool isDelete)
        {
            try
            {
                ...
                var entityList = new M_YUUGAI_BUSSHITSU[this.form.Ichiran.Rows.Count];
                for (int i = 0; i < entityList.Length; i++)
                {
                    entityList[i] = new M_YUUGAI_BUSSHITSU();
                }

                var dataBinderLogic = new DataBinderLogic<r_framework.Entity.M_YUUGAI_BUSSHITSU>(entityList);
                ...
                foreach (DataColumn column in dt.Columns)
                {
                    ...
                    if (column.ColumnName.Equals(Const.YuugaiBusshitsuHoshuConstans.TIME_STAMP))
                    {
                        column.Unique = false;
                    }
                }
                ...
                var yuugaiBusshitsuEntityList = dataBinderLogic.CreateEntityForDataTable(this.form.Ichiran);

                List<M_YUUGAI_BUSSHITSU> addList = new List<M_YUUGAI_BUSSHITSU>();
                foreach (var yuugaiBusshitsuEntity in yuugaiBusshitsuEntityList)
                {
                    foreach (Row row in this.form.Ichiran.Rows)
                    {
                        if (row.Cells.Any(n => (n.DataField.Equals(Const.YuugaiBusshitsuHoshuConstans.YUUGAI_BUSSHITSU_CD) && n.Value.ToString().Equals(yuugaiBusshitsuEntity.YUUGAI_BUSSHITSU_CD))) &&
                            row.Cells.Any(n => (n.DataField.Equals(Const.YuugaiBusshitsuHoshuConstans.DELETE_FLG) && bool.Parse(n.FormattedValue.ToString()) == isDelete)))
                        {
                            MasterCommonLogic.SetFooterProperty(MasterCommonLogic.GetCurrentShain(this.form), yuugaiBusshitsuEntity);
                            addList.Add(yuugaiBusshitsuEntity);
                            break;
                        }
                    }
                }
        ...
        public bool DuplicationCheck()
        {
            try
            {
                ...
                YuugaiBusshitsuHoshuValidator vali = new YuugaiBusshitsuHoshuValidator();
        ...
        public bool Preview()
        {
            try
            {
                ...
                msgLogic.MessageBoxShow("C011", "有害一覧表");
        ...
        public virtual void Regist(bool errorFlag)
        {
            try
            {
                ...
                if (!errorFlag)
                {
                    ...
                    {
                        foreach (M_YUUGAI_BUSSHITSU yuugaiBusshitsuEntity in this.entitys)
                        {
                            M_YUUGAI_BUSSHITSU entity = this.dao.GetDataByCd(yuugaiBusshitsuEntity.YUUGAI_BUSSHITSU_CD);
                            if (entity == null)
                            {
        ...
        public override bool Equals(object other)
        {
            ...
            YuugaiBusshitsuHoshuLogic localLogic = other as YuugaiBusshitsuHoshuLogic;
        ...
        internal bool SetIchiran()
        {
            try
            {
                ...
                // 権限チェック
                if (r_framework.Authority.Manager.CheckAuthority("M270", r_framework.Const.WINDOW_TYPE.UPDATE_WINDOW_FLAG, false))
                {
        ...
        {
            M_YUUGAI_BUSSHITSU entity = new M_YUUGAI_BUSSHITSU();
        ...
        private void UpdateRelationInfo(M_YUUGAI_BUSSHITSU entity, bool isDelete)
        {
            if (entity == null
        ...
        {
            var objValue = row[Const.YuugaiBusshitsuHoshuConstans.YUUGAI_BUSSHITSU_CD].Value;

            bool catchErr = false;
            if (this.CheckFixedRow(row, out catchErr) && !catchErr)
            {
                foreach (var columnName in Const.YuugaiBusshitsuHoshuConstans.fixedColumnList)
                {
        ...
        internal bool CheckFixedRow(Row row, out bool catchErr)
        {
            try
            {
                ...
                if (row != null && objValue != null)
                {
                    ...
                    if (Const.YuugaiBusshitsuHoshuConstans.fixedRowList.Contains(strCd))
                    {
                        return true;
                    }
                }
