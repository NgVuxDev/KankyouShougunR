...
WHERE
ENT.TORIHIKISAKI_CD = /*SEIKYU_CD*/
/*IF SEIKYUSHIMEBI_FROM != null && SEIKYUSHIMEBI_FROM != ''*/
AND CONVERT(DateTime,/*SEIKYUSHIMEBI_FROM*/nul, 111) <= ENT.DENPYOU_DATE/*END*/
AND ENT.DENPYOU_DATE <= CONVERT(DateTime,/*SEIKYUSHIMEBI_TO*/null, 111)
