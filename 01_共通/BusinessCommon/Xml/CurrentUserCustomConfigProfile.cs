...
namespace Shougun.Core.Common.BusinessCommon.Xml
{
    /// <summary>
    ...
    public class CurrentUserCustomConfigProfile
    {
        ...
        public class SettingsCls
        {
            ...
            public List<ProgramInfos> ExternalProgram { get; set; }
            ...
            {
                public CtiScanCls Values { get; set; }

                //内部クラス（最下層）
                [Serializable]
                public class CtiScanCls
                {
                    [XmlAttribute]
                    public string Use { get; set; }
                    [XmlAttribute]
