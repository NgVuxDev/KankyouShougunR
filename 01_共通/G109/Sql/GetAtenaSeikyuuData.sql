SELECT
	...
	ATN.SEIKYUU_SOUFU_NAME1 AS NAME1,
	ATN.SEIKYUU_SOUFU_NAME2 AS NAME2,
	ATN.SEIKYUU_SOUFU_KEISHOU1 AS KEISHOU1,
	ATN.SEIKYUU_SOUFU_KEISHOU2 AS KEISHOU2,
	ATN.SEIKYUU_SOUFU_POST AS POST,
	ATN.SEIKYUU_SOUFU_ADDRESS1 AS ADDRESS1,
	ATN.SEIKYUU_SOUFU_ADDRESS2 AS ADDRESS2,
	ATN.SEIKYUU_SOUFU_BUSHO AS BUSHO,
	ATN.SEIKYUU_SOUFU_TANTOU AS TANTOU
FROM
	/*IF printKubun == 1*/M_TORIHIKISAKI AS MT 
						   LEFT JOIN M_TORIHIKISAKI_SEIKYUU AS ATN ON MT.TORIHIKISAKI_CD = ATN.TORIHIKISAKI_CD/*END*/
