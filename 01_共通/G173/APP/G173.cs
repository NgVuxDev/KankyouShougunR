...
{
    class G173 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// フォーム作成
        /// </summary>
        ...
        public Form CreateForm(params object[] args)
        {
            ...
            var callForm = new Shougun.Core.Common.KokyakuKarute.APP.G173Form(torihikisakiCd, gyoushaCd, genbaCd);
            var HeaderForm = new Shougun.Core.Common.KokyakuKarute.APP.G173HeaderForm();
        ...
        public bool IsSameContentForm(Form form, params object[] args)
        {
            ...
            var uiForm = baseForm.inForm as Shougun.Core.Common.KokyakuKarute.APP.G173Form;
