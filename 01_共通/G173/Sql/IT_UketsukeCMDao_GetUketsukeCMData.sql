SELECT TOP(100)
	...
	T1.TAIOU_END__DATE AS TAIOU_END__DATE,
	T1.TITLE_NAME AS TITLE_NAME,
	T1.EIGYOU_TANTOUSHA_NAME,
...
/*IF !fromDate.IsNull && ''!=fromDate*/AND CONVERT(varchar(10), T1.UKETSUKE_DATE, 120) >= /*fromDate*//*END*/
/*IF !toDate.IsNull && ''!=toDate*/AND CONVERT(varchar(10), T1.UKETSUKE_DATE, 120) <= /*toDate*//*END*/
AND T1.SEQ = TX.SEQ  AND T1.SYSTEM_ID = TX.SYSTEM_ID
AND T1.DELETE_FLG = 0

ORDER BY T1.UKETSUKE_DATE desc, T1.SYSTEM_ID asc
