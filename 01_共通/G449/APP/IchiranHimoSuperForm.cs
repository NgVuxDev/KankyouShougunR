...
{
    public partial class IchiranHimoSuperForm : SuperForm
    {
        /// <summary>
        /// 社員コード
        /// </summary>
        ...
        /// 一覧のロジック処理
        /// </summary>
        protected IchiranHimoBaseLogic logic;
        ...
        public IchiranHimoSuperForm(DENSHU_KBN denshuKbn)
        {
            InitializeComponent();
            ...
            if (!this.DesignMode)
            {
                ...
                this.PatternNo = 0;
                this.logic = new IchiranHimoBaseLogic(this);
            }
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="IchiranHimoSuperForm"/> class.
        /// </summary>
        /// <param name="denshuKbn">denshuKbn</param>
        /// <param name="isDataload">データの読み込みをSuperForm側で行うかどうかを表す値</param>
        public IchiranHimoSuperForm(DENSHU_KBN denshuKbn, bool isDataload)
        {
            InitializeComponent();
            ...
            if (!this.DesignMode)
            {
                this.DenshuKbn = denshuKbn;
                this.PatternNo = 0;
                this.logic = new IchiranHimoBaseLogic(this, isDataload);
            }
        }
        ...
        private void IchiranHimoSuperForm_FormClosing(object sender, FormClosingEventArgs e)
        {
