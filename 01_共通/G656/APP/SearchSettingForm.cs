...
namespace Shougun.Core.Common.DenpyouRenkeiIchiran
{
    ...
    public partial class SearchSettingForm : Form
    {
        ...
        /// </summary>
        private List<r_framework.CustomControl.DataGridCustomControl.MySearchGridRecord> myDataSource;
        ...
        public SearchSettingForm(SearchSettingInfo searchSettingInfo)
        {
            ...
            this.myDataSource = new List<r_framework.CustomControl.DataGridCustomControl.MySearchGridRecord>();
            foreach (var viewColumn in this.searchSettingInfo.ViewColumns)
            {
                var gridRec = new r_framework.CustomControl.DataGridCustomControl.MySearchGridRecord();
        ...
        private void OnExecute()
        {
            ...
            var records = this.grid.DataSource as List<r_framework.CustomControl.DataGridCustomControl.MySearchGridRecord>;
        ...
        private bool HasErrorInputValue(int columnIndex, int rowIndex, string text)
        {
            ...
            if ("条件".Equals(name))
            {
                ...
                if (t == typeof(DateTime) || this.grid.Rows[rowIndex].Cells["列名"].Value.ToString().Contains("日付"))
                {
