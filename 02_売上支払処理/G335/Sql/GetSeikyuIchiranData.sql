...
/*IF endDay != null*/AND UE.URIAGE_DATE <= /*endDay*//*END*/
  AND NOT EXISTS ( 
    SELECT
      1
    FROM
...
UNION ALL (
	...
	/*IF endDay != null*/AND SE.URIAGE_DATE <= /*endDay*//*END*/
		AND NOT EXISTS ( 
		    SELECT
		      1
		    FROM
...
UNION ALL (
	...
	/*IF endDay != null*/AND U_SE.URIAGE_DATE <= /*endDay*//*END*/
		AND NOT EXISTS ( 
		    SELECT
		      1
		    FROM
...
UNION ALL (
	...
	/*IF endDay != null*/AND NE.DENPYOU_DATE <= /*endDay*//*END*/
		AND NOT EXISTS ( 
		    SELECT
		      1
		    FROM
