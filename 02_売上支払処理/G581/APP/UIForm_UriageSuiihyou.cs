...
namespace Shougun.Core.SalesPayment.UriageSuiiChouhyou
{
    ...
    /// 売上推移表画面クラス
    /// </summary>
    public partial class UIForm_UriageSuiihyou : SuperForm
    {
        /// <summary>
        /// 売上推移表ロジッククラス
        /// </summary>
        private UriageSuiihyouLogicClass logic;

        /// <summary>
        /// 売上集計表DTOを取得・設定します
        /// </summary>
        internal UriageSuiihyouDtoClass FormDataDto { get; set; }
        ...
        /// コンストラクタ
        /// </summary>
        public UIForm_UriageSuiihyou(WINDOW_ID windowId)
        {
            ...
            this.logic = new UriageSuiihyouLogicClass(this);
        ...
        public virtual void ButtonFunc4_Clicked(object sender, EventArgs e)
        {
            ...
            if (this.PATTERN_LIST_BOX.GetSelectedPatternDto() != null)
            {
                if (!this.ShowTourokuPopup(WINDOW_TYPE.DELETE_WINDOW_FLAG, this.PATTERN_LIST_BOX.GetSelectedPatternDto()))
                {
                    return;
                }
                if (this.PATTERN_LIST_BOX.GetSelectedPatternDto() == null)
        ...
        public virtual void ButtonFunc5_Clicked(object sender, EventArgs e)
        {
            ...
            if (this.PATTERN_LIST_BOX.GetSelectedPatternDto() == null)
            {
                ...
                this.RecoveryFocusOutCheckMethod(); //PhuocLoc 2020/12/07 #136224
                return;
            }
        ...
        private void SetDtoData()
        {
            ...
            this.FormDataDto = new UriageSuiihyouDtoClass();
        ...
        private void SHARYOU_CD_FROM_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                var sharyouList = this.logic.GetSharyou(this.SHARYOU_CD_FROM.Text);
        ...
        private void SHARYOU_CD_TO_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                var sharyouList = this.logic.GetSharyou(this.SHARYOU_CD_TO.Text);
                if (sharyouList.Count() == 0)
                {
                    new MessageBoxShowLogic().MessageBoxShow("E020", "車輌");
                    e.Cancel = true;
        ...
        /// </param>
        /// <returns></returns>
        private string CreateConditionString(UriageSuiihyouDtoClass dto, int pattern)
        {
        ...
        public void CsvReport(DataTable dt)
        {
            ...
            if (msgLogic.MessageBoxShow("C013") == DialogResult.Yes)
            {
                ...
                csvExport.ConvertDataTableToCsv(dt, true, true, "売上推移表", this);
            }
        }
