...
{
    /// <summary>
    /// ReportInfoBase(売上推移表)
    /// </summary>
    public class ReportInfoR582 : ReportInfoBase
    {
        #region Const

        /// <summary>帳票テンプレート - ファイルパス</summary>
        const string FORM_FULL_PATH_NAME = "./Template/R582-Form.xml";
        ...
        public ReportInfoR582(DataTable headerTable, DataTable detailTable)
        {
        ...
        /// レポートデータ作成を実行します
        /// </summary>
        public void CreateR582(string LayOut)
        {
            this.layOut = LayOut;
            // 実行
