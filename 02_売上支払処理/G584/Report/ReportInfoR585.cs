...
{
    /// <summary>
    /// ReportInfoBase(支払推移表)
    /// </summary>
    public class ReportInfoR585 : ReportInfoBase
    {
        #region Const

        /// <summary>帳票テンプレート - ファイルパス</summary>
        const string FORM_FULL_PATH_NAME = "./Template/R585-Form.xml";

        /// <summary>帳票テンプレート - レイアウト名1(表示項目数2以下)</summary>
        const string LAYOUT_NAME1 = "LAYOUT1";
        /// <summary>帳票テンプレート - レイアウト名2((表示項目数2以上)</summary>
        ...
        public ReportInfoR585(DataTable headerTable, DataTable detailTable)
        {
        ...
        /// レポートデータ作成を実行します
        /// </summary>
        public void CreateR585(string LayOut)
        {
            this.layOut = LayOut;
            // 実行
