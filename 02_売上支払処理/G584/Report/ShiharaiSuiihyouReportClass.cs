...
namespace Shougun.Core.SalesPayment.ShiharaiSuiiChouhyou
{
    ...
    internal class UriageSuiihyouReportClass
    {
        ...
        internal void CreateReport(DataTable dt, ShiharaiSuiihyouDtoClass dto)
        {
            ...
            ReportInfoR585 reportInfo = new ReportInfoR585(headerDataTable, chouhyouDataTable);
            reportInfo.CreateR585(layOut);
            reportInfo.Title = "支払推移表(" + dto.Pattern.PATTERN_NAME + ")";
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        private DataTable CreateHeaderDt(ShiharaiSuiihyouDtoClass dto)
        {
            ...
            // Header項目の値
            // タイトル
            dr["TITLE"] = "支払推移表 (" + dto.Pattern.PATTERN_NAME + ")";
            // 自社
