...
namespace Shougun.Core.SalesPayment.UriageJunihyo
{
    ...
    public partial class UIForm : SuperForm
    {
        ...
        public UIForm()
        {
            ...
            this.WindowId = WINDOW_ID.T_URIAGE_JUNIHYO;
        ...
        public void ButtonFunc5_Clicked(object sender, EventArgs e)
        {
            ...
            if (dtos == null)
            {
                ...
                this.RecoveryFocusOutCheckMethod(); //PhuocLoc 2020/12/07 #136225
                return;
            }
        ...
        public void CsvReport(DataTable dt)
        {
            ...
            if (msgLogic.MessageBoxShow("C013") == DialogResult.Yes)
            {
                ...
                csvExport.ConvertDataTableToCsv(dt, true, true, WINDOW_TITLEExt.ToTitleString(WINDOW_ID.R_URIAGE_JYUNNIHYOU), this);
            }
        }
