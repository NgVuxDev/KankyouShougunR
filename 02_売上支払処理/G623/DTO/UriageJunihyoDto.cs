...
namespace Shougun.Core.SalesPayment.UriageJunihyo
{
    public class UriageJunihyoDto
    {
        ...
        /// 売上日付_From
        /// </summary>
        public string URIAGE_DATE_FROM { set; get; }

        /// <summary>
        /// 売上日付_To
        /// </summary>
        public string URIAGE_DATE_TO { set; get; }
        ...
        public UriageJunihyoDto()
        {
            ...
            URIAGE_DATE_FROM = string.Empty;            // 売上日付_From
            URIAGE_DATE_TO = string.Empty;              // 売上日付_To
            ...
            BUNRUI_CD_FROM = string.Empty;              // 分類CD_From
            BUNRUI_CD_TO = string.Empty;                // 分類CD_To
            SHURUI_CD_FROM = string.Empty;              // 種類CD_From
            SHURUI_CD_TO = string.Empty;                // 種類CD_To
            RANK = 0;                                   // 順位
        }
