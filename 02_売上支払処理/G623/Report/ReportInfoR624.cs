...
{
    /// <summary>
    /// ReportInfoBase(売上順位表)
    /// </summary>
    public class ReportInfoR624 : ReportInfoBase
    {
        #region Const

        /// <summary>帳票テンプレート - ファイルパス</summary>
        const string FORM_FULL_PATH_NAME = "./Template/R624-Form.xml";
        ...
        public ReportInfoR624(DataTable headerTable, DataTable detailTable)
        {
