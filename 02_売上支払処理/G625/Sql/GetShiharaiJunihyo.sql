		...
		FROM (
			...
			FROM
				...
				LEFT JOIN (SELECT
					...
					ON SEISAN.DENPYOU_SYSTEM_ID = DT.SYSTEM_ID
						AND SEISAN.DENPYOU_SEQ = DT.SEQ
						AND SEISAN.DETAIL_SYSTEM_ID = DT.DETAIL_SYSTEM_ID
						AND SEISAN.DENPYOU_NUMBER = DT.UKEIRE_NUMBER
				--PhuocLoc 2020/12/07 #136228 -Start
			...
			WHERE
				...
				/*END*/
				--支払日付_FROM
				/*IF dto.SHIHARAI_DATE_FROM != null && dto.SHIHARAI_DATE_FROM != ''*/
				AND ET.SHIHARAI_DATE >= /*dto.SHIHARAI_DATE_FROM*/'2015/4/1'
				/*END*/
				--支払日付_TO
				/*IF dto.SHIHARAI_DATE_TO != null && dto.SHIHARAI_DATE_TO != ''*/
				AND ET.SHIHARAI_DATE <= /*dto.SHIHARAI_DATE_TO*/'2015/4/1'
				/*END*/
				--入力日付_FROM
				...
				AND ET.SHIHARAI_TORIHIKI_KBN_CD = /*dto.TORIHIKI_KBN*/1
				/*END*/
				--確定区分
			...
			FROM
				...
				LEFT JOIN (SELECT
					...
					ON SEISAN.DENPYOU_SYSTEM_ID = DT.SYSTEM_ID
						AND SEISAN.DENPYOU_SEQ = DT.SEQ
						AND SEISAN.DETAIL_SYSTEM_ID = DT.DETAIL_SYSTEM_ID
						AND SEISAN.DENPYOU_NUMBER = DT.SHUKKA_NUMBER
				--PhuocLoc 2020/12/07 #136228 -Start
				LEFT JOIN M_SHUUKEI_KOUMOKU SHUUKEI
                    ON ET.MOD_SHUUKEI_KOUMOKU_CD = SHUUKEI.SHUUKEI_KOUMOKU_CD 
                --PhuocLoc 2020/12/07 #136228 -End
			...
			WHERE
				...
				--支払日付_FROM
				/*IF dto.SHIHARAI_DATE_FROM != null && dto.SHIHARAI_DATE_FROM != ''*/
				AND ET.KENSHU_SHIHARAI_DATE >= /*dto.SHIHARAI_DATE_FROM*/'2015/4/1'
				/*END*/
				--支払日付_TO
				/*IF dto.SHIHARAI_DATE_TO != null && dto.SHIHARAI_DATE_TO != ''*/
				AND ET.KENSHU_SHIHARAI_DATE <= /*dto.SHIHARAI_DATE_TO*/'2015/4/1'
				/*END*/
				--入力日付_FROM
				/*IF dto.UPDATE_DATE_FROM != null && dto.UPDATE_DATE_FROM != ''*/
				AND CONVERT(date, ET.UPDATE_DATE, 111) >= /*dto.UPDATE_DATE_FROM*/'2015/4/1'
				...
				AND EXISTS
					(
						...
						WHERE SEISAN.DENPYOU_SYSTEM_ID = DT.SYSTEM_ID
							AND SEISAN.DENPYOU_SEQ = DT.SEQ
							AND SEISAN.DETAIL_SYSTEM_ID = DT.DETAIL_SYSTEM_ID
							AND SEISAN.DENPYOU_NUMBER = DT.SHUKKA_NUMBER
					)
			...
			FROM
				...
				LEFT JOIN (SELECT
					...
					ON SEISAN.DENPYOU_SYSTEM_ID = DT.SYSTEM_ID
						AND SEISAN.DENPYOU_SEQ = DT.SEQ
						AND SEISAN.DETAIL_SYSTEM_ID = DT.DETAIL_SYSTEM_ID
						AND SEISAN.DENPYOU_NUMBER = DT.UR_SH_NUMBER
				--PhuocLoc 2020/12/07 #136228 -Start
				LEFT JOIN M_SHUUKEI_KOUMOKU SHUUKEI
                    ON ET.MOD_SHUUKEI_KOUMOKU_CD = SHUUKEI.SHUUKEI_KOUMOKU_CD
                --PhuocLoc 2020/12/07 #136228 -End
