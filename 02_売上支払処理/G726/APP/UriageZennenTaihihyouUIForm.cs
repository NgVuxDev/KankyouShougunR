...
namespace Shougun.Core.SalesPayment.UriageZennenTaihihyou
{
    ...
    /// 売上集計表画面クラス
    /// </summary>
    public partial class UriageZennenTaihihyouUIForm : SuperForm
    {
        /// <summary>
        /// 売上集計表ロジッククラス
        /// </summary>
        private UriageZennenTaihihyouLogic logic;

        /// <summary>
        /// 売上集計表DTOを取得・設定します
        /// </summary>
        internal UriageZennenTaihihyouDto FormDataDto { get; set; }
        ...
        /// コンストラクタ
        /// </summary>
        public UriageZennenTaihihyouUIForm()
        {
            LogUtility.DebugMethodStart();

            this.InitializeComponent();

            this.WindowId = WINDOW_ID.T_URIAGE_ZENNEN_TAIHIHYOU;

            this.logic = new UriageZennenTaihihyouLogic(this);
        ...
        private bool SetDefault()
        {
            try
            {
                this.DATE_SHURUI.Text = UriageZennenTaihihyouConst.DATE_SHURUI_CD_DENPYOU;
                this.DATE_RANGE.Text = UriageZennenTaihihyouConst.DATE_RANGE_CD_TOUJITSU;
                this.DENPYOU_SHURUI.Text = UriageZennenTaihihyouConst.DENPYOU_SHURUI_CD_SUBETE;
                this.TORIHIKI_KBN.Text = UriageZennenTaihihyouConst.TORIHIKI_KBN_CD_SUBETE;
                this.KAKUTEI_KBN.Text = UriageZennenTaihihyouConst.KAKUTEI_KBN_CD_SUBETE;
                this.SHIME_KBN.Text = UriageZennenTaihihyouConst.SHIME_KBN_CD_SUBETE;
                this.KYOTEN_CD.Text = UriageZennenTaihihyouConst.KYOTEN_CD_ZENSHA;
                this.KYOTEN_NAME.Text = UriageZennenTaihihyouConst.KYOTEN_NAME_99;
            }
            catch (Exception ex)
            {
        ...
        private bool SetDtoData()
        {
            try
            {
                ...
                this.FormDataDto = new UriageZennenTaihihyouDto();
                ...
                {
                    this.FormDataDto.DateShuruiName = UriageZennenTaihihyouConst.DATE_SHURUI_1;
                }
                else if (this.DATE_SHURUI_2.Checked)
                {
                    this.FormDataDto.DateShuruiName = UriageZennenTaihihyouConst.DATE_SHURUI_2;
                }
                else
                {
                    this.FormDataDto.DateShuruiName = UriageZennenTaihihyouConst.DATE_SHURUI_3;
                }
                if (this.DATE_RANGE.Text == UriageZennenTaihihyouConst.DATE_RANGE_CD_TOUJITSU)
                {
                    this.FormDataDto.DateFrom = this.logic.parentForm.sysDate.Date;
                    this.FormDataDto.DateTo = this.logic.parentForm.sysDate.Date;
                }
                else if (this.DATE_RANGE.Text == UriageZennenTaihihyouConst.DATE_RANGE_CD_TOUGETSU)
                {
                ...
                {
                    this.FormDataDto.DenpyouShuruiName = UriageZennenTaihihyouConst.DENPYOU_SHURUI_1;
                }
                else if (this.DENPYOU_SHURUI_2.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = UriageZennenTaihihyouConst.DENPYOU_SHURUI_2;
                }
                else if (this.DENPYOU_SHURUI_3.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = UriageZennenTaihihyouConst.DENPYOU_SHURUI_3;
                }
                // 20150513 伝種「4.代納」追加(不具合一覧(つ) 23) Start
                else if (this.DENPYOU_SHURUI_4.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = UriageZennenTaihihyouConst.DENPYOU_SHURUI_4;
                }
                else
                {
                    this.FormDataDto.DenpyouShuruiName = UriageZennenTaihihyouConst.DENPYOU_SHURUI_5;
                }
                ...
                {
                    this.FormDataDto.TorihikiKbnName = UriageZennenTaihihyouConst.TORIHIKI_KBN_1;
                }
                else if (this.TORIHIKI_KBN_2.Checked)
                {
                    this.FormDataDto.TorihikiKbnName = UriageZennenTaihihyouConst.TORIHIKI_KBN_2;
                }
                else
                {
                    this.FormDataDto.TorihikiKbnName = UriageZennenTaihihyouConst.TORIHIKI_KBN_3;
                }
                this.FormDataDto.KakuteiKbn = Int32.Parse(this.KAKUTEI_KBN.Text);
                if (this.KAKUTEI_KBN_1.Checked)
                {
                    this.FormDataDto.KakuteiKbnName = UriageZennenTaihihyouConst.KAKUTEI_KBN_1;
                }
                else if (this.KAKUTEI_KBN_2.Checked)
                {
                    this.FormDataDto.KakuteiKbnName = UriageZennenTaihihyouConst.KAKUTEI_KBN_2;
                }
                else
                {
                    this.FormDataDto.KakuteiKbnName = UriageZennenTaihihyouConst.KAKUTEI_KBN_3;
                }
                this.FormDataDto.ShimeKbn = Int32.Parse(this.SHIME_KBN.Text);
                if (this.SHIME_KBN_1.Checked)
                {
                    this.FormDataDto.ShimeKbnName = UriageZennenTaihihyouConst.SHHIME_KBN_1;
                }
                else if (this.SHIME_KBN_2.Checked)
                {
                    this.FormDataDto.ShimeKbnName = UriageZennenTaihihyouConst.SHHIME_KBN_2;
                }
                else
                {
                    this.FormDataDto.ShimeKbnName = UriageZennenTaihihyouConst.SHHIME_KBN_3;
                }
        ...
        private void DATE_RANGE_TextChanged(object sender, EventArgs e)
        {
            ...
            if (this.DATE_RANGE.Text == UriageZennenTaihihyouConst.DATE_RANGE_CD_SHITEI)
            {
        ...
        private bool SetDaikanName(CustomNumericTextBox2 cdTextBox, CustomTextBox nameTextBox)
        {
            try
            {
                ...
                if (cd == UriageZennenTaihihyouConst.DAIKAN_CD_JISHA)
                {
                    name = UriageZennenTaihihyouConst.DAIKAN_NAME_1;
                }
                else if (cd == UriageZennenTaihihyouConst.DAIKAN_CD_TASHA)
                {
                    name = UriageZennenTaihihyouConst.DAIKAN_NAME_2;
                }
