...
namespace Shougun.Core.SalesPayment.UriageZennenTaihihyou
{
    ...
    /// 売上集計表固定値クラス
    /// </summary>
    internal static class UriageZennenTaihihyouConst
    {
        /// <summary>
        /// ボタン設定ファイルのパス
        /// </summary>
        internal static readonly String BUTTON_SETTING_XML = "Shougun.Core.SalesPayment.UriageZennenTaihihyou.Setting.ButtonSetting.xml";

        /// <summary>
        /// 帳票テンプレートファイルのパス
        /// </summary>
        internal static readonly String FORM_FILE = "./Template/R727-Form.xml";
        ...
        /// 日付種類「売上日付」
        /// </summary>
        internal static readonly String DATE_SHURUI_2 = "売上日付";
