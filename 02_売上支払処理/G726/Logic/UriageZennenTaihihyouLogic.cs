...
namespace Shougun.Core.SalesPayment.UriageZennenTaihihyou
{
    ...
    /// 売上集計表ロジッククラス
    /// </summary>
    internal class UriageZennenTaihihyouLogic : IBuisinessLogic
    {
        /// <summary>
        /// 売上集計表画面クラス
        /// </summary>
        private UriageZennenTaihihyouUIForm form;
        ...
        /// </summary>
        internal List<UriageZennenTaihihyouReportDto> ShukeiHyoReportDtoList { get; private set; }
        ...
        public UriageZennenTaihihyouLogic(UriageZennenTaihihyouUIForm targetForm)
        {
        ...
        public int Search()
        {
            ...
            try
            {
                var dao = DaoInitUtility.GetComponent<UriageZennenTaihihyouDao>();
                ...
                if (this.form.FormDataDto.DenpyouShurui.ToString() == UriageZennenTaihihyouConst.DENPYOU_SHURUI_CD_UKEIRE || this.form.FormDataDto.DenpyouShurui.ToString() == UriageZennenTaihihyouConst.DENPYOU_SHURUI_CD_SUBETE)
                {
                ...
                if (this.form.FormDataDto.DenpyouShurui.ToString() == UriageZennenTaihihyouConst.DENPYOU_SHURUI_CD_SHUKKA || this.form.FormDataDto.DenpyouShurui.ToString() == UriageZennenTaihihyouConst.DENPYOU_SHURUI_CD_SUBETE)
                {
                ...
                if (this.form.FormDataDto.DenpyouShurui.ToString() == UriageZennenTaihihyouConst.DENPYOU_SHURUI_CD_URIAGE_SHIHARAI ||
                    this.form.FormDataDto.DenpyouShurui.ToString() == UriageZennenTaihihyouConst.DENPYOU_SHURUI_CD_DAINOU ||
                    this.form.FormDataDto.DenpyouShurui.ToString() == UriageZennenTaihihyouConst.DENPYOU_SHURUI_CD_SUBETE)
                {
        ...
        internal bool CSVPrint()
        {
            try
            {
                ...
                {
                    var reportLogic = new UriageZennenTaihihyouReportLogic();
        ...
        public void Creat_CSV(DataTable dt)
        {
            try
            {
                ...
                csvDT.Columns.Add("今年売上金額");
                csvDT.Columns.Add("前年売上金額");
                ...
                if (this.errmessage.MessageBoxShow("C013") == DialogResult.Yes)
                {
                    ...
                    // CSV出力
                    csvExport.ConvertDataTableToCsv(csvDT, true, true, "売上前年対比表", this.form);
                }
            }
            catch (Exception ex)
            {
        ...
        private void CreateReportDtoList()
        {
            ...
            this.ShukeiHyoReportDtoList = this.ShukeiDataList.Select(u => new UriageZennenTaihihyouReportDto()
                                                             {
                                                                 COLUMN_1 = column1,
                                                                 COLUMN_2 = column2,
                                                                 COLUMN_3 = column3,
        ...
        private void CreateSummaryData()
        {
            ...
            this.ShukeiHyoReportDtoList = this.ShukeiHyoReportDtoList.GroupBy(u => new { u.CD_1, u.CD_2, u.CD_3, u.CD_4 })
                                                                     .Select(u => new UriageZennenTaihihyouReportDto()
                                                                     {
        ...
        private void CreateJoukenFieldData()
        {
            this.ShukeiHyoReportDtoList.ForEach(u =>
            {
                u.TITLE = "売上前年対比表（" + this.form.FormDataDto.Pattern.PATTERN_NAME + "）";
            ...
            jouken2.Append("　[1] ");
            jouken2.Append("今年売上金額");
            jouken2.AppendLine(String.Empty);
            jouken2.Append("　[2] ");
            jouken2.Append("前年売上金額");
            jouken2.AppendLine(String.Empty);
            jouken2.Append("　[3] ");
            jouken2.Append("差額");
            jouken2.AppendLine(String.Empty);
        ...
        private ButtonSetting[] CreateButtonInfo()
        {
            try
            {
                ...
                return buttonSetting.LoadButtonSetting(thisAssembly, UriageZennenTaihihyouConst.BUTTON_SETTING_XML);
            }
            catch (Exception e)
            {
                LogUtility.Error(e.Message, e);
