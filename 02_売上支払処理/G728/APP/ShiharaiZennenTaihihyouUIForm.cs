...
namespace Shougun.Core.SalesPayment.ShiharaiZennenTaihihyou
{
    ...
    /// 支払集計表画面クラス
    /// </summary>
    public partial class ShiharaiZennenTaihihyouUIForm : SuperForm
    {
        #region 宣言
        /// <summary>
        /// 支払集計表ロジッククラス
        /// </summary>
        private ShiharaiZennenTaihihyouLogic logic;

        /// <summary>
        /// 支払集計表DTOを取得・設定します
        /// </summary>
        internal ShiharaiZennenTaihihyouDto FormDataDto { get; set; }
        ...
        /// コンストラクタ
        /// </summary>
        public ShiharaiZennenTaihihyouUIForm()
        {
            LogUtility.DebugMethodStart();

            this.InitializeComponent();
            this.WindowId = WINDOW_ID.T_SHIHARAI_ZENNEN_TAIHIHYOU;
            this.logic = new ShiharaiZennenTaihihyouLogic(this);
        ...
        private bool SetDefault()
        {
            try
            {
                this.DATE_SHURUI.Text = ShiharaiZennenTaihihyouConst.DATE_SHURUI_CD_DENPYOU;
                this.DATE_RANGE.Text = ShiharaiZennenTaihihyouConst.DATE_RANGE_CD_TOUJITSU;
                this.DENPYOU_SHURUI.Text = ShiharaiZennenTaihihyouConst.DENPYOU_SHURUI_CD_SUBETE;
                this.TORIHIKI_KBN.Text = ShiharaiZennenTaihihyouConst.TORIHIKI_KBN_CD_SUBETE;
                this.KAKUTEI_KBN.Text = ShiharaiZennenTaihihyouConst.KAKUTEI_KBN_CD_SUBETE;
                this.SHIME_KBN.Text = ShiharaiZennenTaihihyouConst.SHIME_KBN_CD_SUBETE;
                this.KYOTEN_CD.Text = ShiharaiZennenTaihihyouConst.KYOTEN_CD_ZENSHA;
                this.KYOTEN_NAME.Text = ShiharaiZennenTaihihyouConst.KYOTEN_NAME_99;
            }
            catch (Exception ex)
            {
        ...
        public virtual void ButtonFunc5_Clicked(object sender, EventArgs e)
        {
            ...
            if (this.RegistErrorFlag == false)
            {
                ...
                //Hoa 2020/04/06 #135411 str
                bool isErr2 = this.IsErrorDateFromTo2(this.DATE_FROM, this.DATE_TO, out catchErr);
                if (!catchErr)
                {
                    return;
                }
                //Hoa 2020/04/06 #135411 end
                ...
                {
                    string strMsg = "12カ月を超える日付範囲は指定できません。";
        ...
        private bool SetDtoData()
        {
            try
            {
                ...
                this.FormDataDto = new ShiharaiZennenTaihihyouDto();
                ...
                {
                    this.FormDataDto.DateShuruiName = ShiharaiZennenTaihihyouConst.DATE_SHURUI_1;
                }
                else if (this.DATE_SHURUI_2.Checked)
                {
                    this.FormDataDto.DateShuruiName = ShiharaiZennenTaihihyouConst.DATE_SHURUI_2;
                }
                else
                {
                    this.FormDataDto.DateShuruiName = ShiharaiZennenTaihihyouConst.DATE_SHURUI_3;
                }
                if (this.DATE_RANGE.Text == ShiharaiZennenTaihihyouConst.DATE_RANGE_CD_TOUJITSU)
                {
                    this.FormDataDto.DateFrom = this.logic.parentForm.sysDate.Date;
                    this.FormDataDto.DateTo = this.logic.parentForm.sysDate.Date;
                }
                else if (this.DATE_RANGE.Text == ShiharaiZennenTaihihyouConst.DATE_RANGE_CD_TOUGETSU)
                {
                ...
                this.FormDataDto.DateFromPast = this.FormDataDto.DateFrom.AddYears(-1);
                this.FormDataDto.DateToPast = this.FormDataDto.DateTo.AddYears(-1);
                this.FormDataDto.DenpyouShurui = Int32.Parse(this.DENPYOU_SHURUI.Text);
                
                if (this.DENPYOU_SHURUI_1.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = ShiharaiZennenTaihihyouConst.DENPYOU_SHURUI_1;
                }
                else if (this.DENPYOU_SHURUI_2.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = ShiharaiZennenTaihihyouConst.DENPYOU_SHURUI_2;
                }
                else if (this.DENPYOU_SHURUI_3.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = ShiharaiZennenTaihihyouConst.DENPYOU_SHURUI_3;
                }
                else if (this.DENPYOU_SHURUI_4.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = ShiharaiZennenTaihihyouConst.DENPYOU_SHURUI_4;
                }
                else
                {
                    this.FormDataDto.DenpyouShuruiName = ShiharaiZennenTaihihyouConst.DENPYOU_SHURUI_5;
                }
                
                this.FormDataDto.TorihikiKbn = Int32.Parse(this.TORIHIKI_KBN.Text);
                if (this.TORIHIKI_KBN_1.Checked)
                {
                    this.FormDataDto.TorihikiKbnName = ShiharaiZennenTaihihyouConst.TORIHIKI_KBN_1;
                }
                else if (this.TORIHIKI_KBN_2.Checked)
                {
                    this.FormDataDto.TorihikiKbnName = ShiharaiZennenTaihihyouConst.TORIHIKI_KBN_2;
                }
                else
                {
                    this.FormDataDto.TorihikiKbnName = ShiharaiZennenTaihihyouConst.TORIHIKI_KBN_3;
                }
                
                this.FormDataDto.KakuteiKbn = Int32.Parse(this.KAKUTEI_KBN.Text);
                if (this.KAKUTEI_KBN_1.Checked)
                {
                    this.FormDataDto.KakuteiKbnName = ShiharaiZennenTaihihyouConst.KAKUTEI_KBN_1;
                }
                else if (this.KAKUTEI_KBN_2.Checked)
                {
                    this.FormDataDto.KakuteiKbnName = ShiharaiZennenTaihihyouConst.KAKUTEI_KBN_2;
                }
                else
                {
                    this.FormDataDto.KakuteiKbnName = ShiharaiZennenTaihihyouConst.KAKUTEI_KBN_3;
                }
                
                this.FormDataDto.ShimeKbn = Int32.Parse(this.SHIME_KBN.Text);
                if (this.SHIME_KBN_1.Checked)
                {
                    this.FormDataDto.ShimeKbnName = ShiharaiZennenTaihihyouConst.SHHIME_KBN_1;
                }
                else if (this.SHIME_KBN_2.Checked)
                {
                    this.FormDataDto.ShimeKbnName = ShiharaiZennenTaihihyouConst.SHHIME_KBN_2;
                }
                else
                {
                    this.FormDataDto.ShimeKbnName = ShiharaiZennenTaihihyouConst.SHHIME_KBN_3;
                }
        ...
        //Hoa 2020/04/06 #135411 str
        private bool IsErrorDateFromTo2(CustomDateTimePicker fromTextBox, CustomDateTimePicker toTextBox, out bool catchErr)
        {
            LogUtility.DebugMethodStart(fromTextBox, toTextBox);
            ...
            try
            {
                ...
                if (String.IsNullOrEmpty(fromDate) == false && String.IsNullOrEmpty(toDate) == false)
                {
                    DateTime date_from = DateTime.Parse(fromDate);
                    DateTime date_to = DateTime.Parse(toDate);
                    ...
                    long monthDiff = DateAndTime.DateDiff(DateInterval.Month, fromBeginMonth, toBeginMonth);
            ...
            {
                LogUtility.Error("IsErrorDateFromTo2", ex);
                this.logic.errmessage.MessageBoxShow("E245", "");
                catchErr = false;
            }
        ...
        private void DATE_RANGE_TextChanged(object sender, EventArgs e)
        {
            ...
            if (this.DATE_RANGE.Text == ShiharaiZennenTaihihyouConst.DATE_RANGE_CD_SHITEI)
            {
        ...
        private bool SetDaikanName(CustomNumericTextBox2 cdTextBox, CustomTextBox nameTextBox)
        {
            try
            {
                ...
                if (cd == ShiharaiZennenTaihihyouConst.DAIKAN_CD_JISHA)
                {
                    name = ShiharaiZennenTaihihyouConst.DAIKAN_NAME_1;
                }
                else if (cd == ShiharaiZennenTaihihyouConst.DAIKAN_CD_TASHA)
                {
                    name = ShiharaiZennenTaihihyouConst.DAIKAN_NAME_2;
                }
