...
namespace Shougun.Core.SalesPayment.ShiharaiShukeiHyo
{
    ...
    /// 支払集計表画面クラス
    /// </summary>
    public partial class ShiharaiShukeiHyoUIForm : SuperForm
    {
        /// <summary>
        /// 支払集計表ロジッククラス
        /// </summary>
        private ShiharaiShukeiHyoLogic logic;

        /// <summary>
        /// 支払集計表DTOを取得・設定します
        /// </summary>
        internal ShiharaiShukeiHyoDto FormDataDto { get; set; }
        ...
        /// コンストラクタ
        /// </summary>
        public ShiharaiShukeiHyoUIForm()
        {
            LogUtility.DebugMethodStart();

            this.InitializeComponent();

            this.WindowId = WINDOW_ID.T_SHIHARAI_SHUUKEIHYOU;

            this.logic = new ShiharaiShukeiHyoLogic(this);
        ...
        {
            this.DATE_SHURUI.Text = ShiharaiShukeiHyoConst.DATE_SHURUI_CD_DENPYOU;
            this.DATE_RANGE.Text = ShiharaiShukeiHyoConst.DATE_RANGE_CD_TOUJITSU;
            this.DENPYOU_SHURUI.Text = ShiharaiShukeiHyoConst.DENPYOU_SHURUI_CD_SUBETE;
            this.TORIHIKI_KBN.Text = ShiharaiShukeiHyoConst.TORIHIKI_KBN_CD_SUBETE;
            this.KAKUTEI_KBN.Text = ShiharaiShukeiHyoConst.KAKUTEI_KBN_CD_SUBETE;
            this.SHIME_KBN.Text = ShiharaiShukeiHyoConst.SHIME_KBN_CD_SUBETE;
            this.KYOTEN_CD.Text = ShiharaiShukeiHyoConst.KYOTEN_CD_ZENSHA;
            this.KYOTEN_NAME.Text = ShiharaiShukeiHyoConst.KYOTEN_NAME_99;
        }
        ...
        public virtual void ButtonFunc5_Clicked(object sender, EventArgs e)
        {
            ...
            if (this.PATTERN_LIST_BOX.GetSelectedPatternDto() == null)
            {
                ...
                this.RecoveryFocusOutCheckMethod(); //PhuocLoc 2020/12/08 #136226
                return;
            }
        ...
        private void SetDtoData()
        {
            ...
            this.FormDataDto = new ShiharaiShukeiHyoDto();
            ...
            {
                this.FormDataDto.DateShuruiName = ShiharaiShukeiHyoConst.DATE_SHURUI_1;
            }
            else if (this.DATE_SHURUI_2.Checked)
            {
                this.FormDataDto.DateShuruiName = ShiharaiShukeiHyoConst.DATE_SHURUI_2;
            }
            else
            {
                this.FormDataDto.DateShuruiName = ShiharaiShukeiHyoConst.DATE_SHURUI_3;
            }
            if (this.DATE_RANGE.Text == ShiharaiShukeiHyoConst.DATE_RANGE_CD_TOUJITSU)
            {
                this.FormDataDto.DateFrom = this.logic.parentForm.sysDate.Date;
                this.FormDataDto.DateTo = this.logic.parentForm.sysDate.Date;
            }
            else if (this.DATE_RANGE.Text == ShiharaiShukeiHyoConst.DATE_RANGE_CD_TOUGETSU)
            {
            ...
            {
                this.FormDataDto.DenpyouShuruiName = ShiharaiShukeiHyoConst.DENPYOU_SHURUI_1;
            }
            else if (this.DENPYOU_SHURUI_2.Checked)
            {
                this.FormDataDto.DenpyouShuruiName = ShiharaiShukeiHyoConst.DENPYOU_SHURUI_2;
            }
            else if (this.DENPYOU_SHURUI_3.Checked)
            {
                this.FormDataDto.DenpyouShuruiName = ShiharaiShukeiHyoConst.DENPYOU_SHURUI_3;
            }
            // 20150513 伝種「4.代納」追加(不具合一覧(つ) 23) Start
            else if (this.DENPYOU_SHURUI_4.Checked)
            {
                this.FormDataDto.DenpyouShuruiName = ShiharaiShukeiHyoConst.DENPYOU_SHURUI_4;
            }
            else
            {
                this.FormDataDto.DenpyouShuruiName = ShiharaiShukeiHyoConst.DENPYOU_SHURUI_5;
            }
            ...
            {
                this.FormDataDto.TorihikiKbnName = ShiharaiShukeiHyoConst.TORIHIKI_KBN_1;
            }
            else if (this.TORIHIKI_KBN_2.Checked)
            {
                this.FormDataDto.TorihikiKbnName = ShiharaiShukeiHyoConst.TORIHIKI_KBN_2;
            }
            else
            {
                this.FormDataDto.TorihikiKbnName = ShiharaiShukeiHyoConst.TORIHIKI_KBN_3;
            }
            this.FormDataDto.KakuteiKbn = Int32.Parse(this.KAKUTEI_KBN.Text);
            if (this.KAKUTEI_KBN_1.Checked)
            {
                this.FormDataDto.KakuteiKbnName = ShiharaiShukeiHyoConst.KAKUTEI_KBN_1;
            }
            else if (this.KAKUTEI_KBN_2.Checked)
            {
                this.FormDataDto.KakuteiKbnName = ShiharaiShukeiHyoConst.KAKUTEI_KBN_2;
            }
            else
            {
                this.FormDataDto.KakuteiKbnName = ShiharaiShukeiHyoConst.KAKUTEI_KBN_3;
            }
            this.FormDataDto.ShimeKbn = Int32.Parse(this.SHIME_KBN.Text);
            if (this.SHIME_KBN_1.Checked)
            {
                this.FormDataDto.ShimeKbnName = ShiharaiShukeiHyoConst.SHHIME_KBN_1;
            }
            else if (this.SHIME_KBN_2.Checked)
            {
                this.FormDataDto.ShimeKbnName = ShiharaiShukeiHyoConst.SHHIME_KBN_2;
            }
            else
            {
                this.FormDataDto.ShimeKbnName = ShiharaiShukeiHyoConst.SHHIME_KBN_3;
            }
        ...
        private void DATE_RANGE_TextChanged(object sender, EventArgs e)
        {
            ...
            if (this.DATE_RANGE.Text == ShiharaiShukeiHyoConst.DATE_RANGE_CD_SHITEI)
            {
        ...
        private void SetDaikanName(CustomNumericTextBox2 cdTextBox, CustomTextBox nameTextBox)
        {
            ...
            if (cd == ShiharaiShukeiHyoConst.DAIKAN_CD_JISHA)
            {
                name = ShiharaiShukeiHyoConst.DAIKAN_NAME_1;
            }
            else if (cd == ShiharaiShukeiHyoConst.DAIKAN_CD_TASHA)
            {
                name = ShiharaiShukeiHyoConst.DAIKAN_NAME_2;
            }
