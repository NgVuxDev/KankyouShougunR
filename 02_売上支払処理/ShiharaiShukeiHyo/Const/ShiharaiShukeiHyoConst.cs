...
namespace Shougun.Core.SalesPayment.ShiharaiShukeiHyo
{
    ...
    /// 支払集計表固定値クラス
    /// </summary>
    internal static class ShiharaiShukeiHyoConst
    {
        /// <summary>
        /// ボタン設定ファイルのパス
        /// </summary>
        internal static readonly String BUTTON_SETTING_XML = "Shougun.Core.SalesPayment.ShiharaiShukeiHyo.Setting.ButtonSetting.xml";

        /// <summary>
        /// 帳票テンプレートファイルのパス
        /// </summary>
        internal static readonly String FORM_FILE = "./Template/R580-Form.xml";
