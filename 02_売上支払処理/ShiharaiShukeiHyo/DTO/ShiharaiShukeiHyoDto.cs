...
namespace Shougun.Core.SalesPayment.ShiharaiShukeiHyo
{
    ...
    /// 支払集計表DTOクラス
    /// </summary>
    public class ShiharaiShukeiHyoDto
    {
        /// <summary>
        /// デフォルトコンストラクタ
        /// </summary>
        public ShiharaiShukeiHyoDto()
        {
        }
        ...
        /// 取引区分を取得・設定します
        /// </summary>
        public int TorihikiKbn { get; set; }

        /// <summary>
        /// 取引区分名を取得・設定します
        /// </summary>
        public String TorihikiKbnName { get; set; }

        /// <summary>
        /// 確定区分を取得・設定します
        /// </summary>
        public int KakuteiKbn { get; set; }

        /// <summary>
        /// 確定区分名を取得・設定します
        /// </summary>
        public String KakuteiKbnName { get; set; }

        /// <summary>
        /// 締区分を取得・設定します
        /// </summary>
        public int ShimeKbn { get; set; }

        /// <summary>
        /// 締区分名を取得・設定します
        /// </summary>
        public String ShimeKbnName { get; set; }
        ...
        /// <summary>
        /// 台貫区分CD Fromを取得・設定します
        /// </summary>
        public String DaikanKbnCdFrom { get; set; }

        /// <summary>
        /// 台貫区分名 Fromを取得・設定します
        /// </summary>
        public String DaikanKbnNameFrom { get; set; }

        /// <summary>
        /// 台貫区分 Fromを取得します
        /// </summary>
        public String DaikanKbnFrom { get { return this.DaikanKbnCdFrom + " " + this.DaikanKbnNameFrom; } }

        /// <summary>
        /// 台貫区分CD Toを取得・設定します
        /// </summary>
        public String DaikanKbnCdTo { get; set; }

        /// <summary>
        /// 台貫区分名 Toを取得・設定します
        /// </summary>
        public String DaikanKbnNameTo { get; set; }

        /// <summary>
        /// 台貫区分 Toを取得します
        /// </summary>
        public String DaikanKbnTo { get { return this.DaikanKbnCdTo + " " + this.DaikanKbnNameTo; } }

        /// <summary>
        /// 台貫を取得します
        /// </summary>
        public String DaikanKbn
        {
            get
            {
                if (String.IsNullOrEmpty(this.DaikanKbnCdFrom) && String.IsNullOrEmpty(this.DaikanKbnCdTo))
                {
                    return String.Empty;
                }
                else
                {
                    return "　[台貫] " + this.DaikanKbnFrom + " ～ " + this.DaikanKbnTo + "\r\n";
                }
            }
        }

        /// <summary>
        /// 種類区分CD Fromを取得・設定します
        /// </summary>
        ...
        public String Bunrui
        {
            get
            {
                ...
                {
                    return "　[分類] " + this.BunruiFrom + " ～ " + this.BunruiTo + "\r\n";
                }
            }
        }

        //VAN 20200330 #134976 S
        /// <summary>抽出対象に[品名]を含めるフラグ</summary>
        public bool SearchHinmeiFlg { get; set; }

        /// <summary>抽出対象に[正味重量]を含めるフラグ</summary>
        public bool SearchNetJuuryouFlg { get; set; }

        /// <summary>抽出対象に[数量/単位]を含めるフラグ</summary>
        public bool SearchSuuryouTaniFlg { get; set; }
        //VAN 20200330 #134976 E

        //PhuocLoc 2020/12/08 #136226 -Start
        /// <summary>
        /// 伝票集計項目CD Fromを取得・設定します
        /// </summary>
        public String ShuukeiKoumokuCdFrom { get; set; }

        /// <summary>
        /// 伝票集計項目名 Fromを取得・設定します
        /// </summary>
        public String ShuukeiKoumokuNameFrom { get; set; }

        /// <summary>
        /// 伝票集計項目 Fromを取得します
        /// </summary>
        public String ShuukeiKoumokuFrom { get { return this.ShuukeiKoumokuCdFrom + " " + this.ShuukeiKoumokuNameFrom; } }

        /// <summary>
        /// 伝票集計項目CD Toを取得・設定します
        /// </summary>
        ...
        /// 伝票集計項目名 Toを取得・設定します
        /// </summary>
        public String ShuukeiKoumokuNameTo { get; set; }

        /// <summary>
        /// 伝票集計項目 Toを取得します
        /// </summary>
        public String ShuukeiKoumokuTo { get { return this.ShuukeiKoumokuCdTo + " " + this.ShuukeiKoumokuNameTo; } }

        /// <summary>
        /// 伝票集計項目を取得します
        /// </summary>
        public String ShuukeiKoumoku
        {
            get
            {
                if (String.IsNullOrEmpty(this.ShuukeiKoumokuCdFrom) && String.IsNullOrEmpty(this.ShuukeiKoumokuCdTo))
                {
                    return String.Empty;
                }
                else
                {
                    return "　[伝票集計項目] " + this.ShuukeiKoumokuFrom + " ～ " + this.ShuukeiKoumokuTo + "\r\n";
                }
            }
        }
