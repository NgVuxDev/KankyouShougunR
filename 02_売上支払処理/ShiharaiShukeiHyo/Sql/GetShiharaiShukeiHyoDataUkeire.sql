...
/*END*/
/*IF dto.DateShurui == 2*/
  AND T_UKEIRE_ENTRY.SHIHARAI_DATE >= /*dto.DateFrom*/''
  AND T_UKEIRE_ENTRY.SHIHARAI_DATE <= /*dto.DateTo*/''
/*END*/
/*IF dto.DateShurui == 3*/
  AND T_UKEIRE_ENTRY.UPDATE_DATE >= /*dto.DateFrom*/''
  AND T_UKEIRE_ENTRY.UPDATE_DATE <= /*dto.DateTo*/''
/*END*/
