...
namespace Shougun.Core.SalesPayment.UriageShiharaiKoteiChouhyou
{
    ...
    /// </summary>
    internal class UriageShiharaiMeisaihyouDenpyouNoReportClass
    {
        /// <summary>
        /// システム設定エンティティ
        /// </summary>
        ...
        /// 帳票テンプレートのパス
        /// </summary>
        private static readonly string OutputFormFullPathName = "./Template/R570_R573DenpyouNo-Form.xml";
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        internal UriageShiharaiMeisaihyouDenpyouNoReportClass()
        {
