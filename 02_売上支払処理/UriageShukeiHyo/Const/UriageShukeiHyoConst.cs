...
namespace Shougun.Core.SalesPayment.UriageShukeiHyo
{
    ...
    /// 売上集計表固定値クラス
    /// </summary>
    internal static class UriageShukeiHyoConst
    {
        /// <summary>
        /// ボタン設定ファイルのパス
        /// </summary>
        internal static readonly String BUTTON_SETTING_XML = "Shougun.Core.SalesPayment.UriageShukeiHyo.Setting.ButtonSetting.xml";

        /// <summary>
        /// 帳票テンプレートファイルのパス
        /// </summary>
        internal static readonly String FORM_FILE = "./Template/R578-Form.xml";
