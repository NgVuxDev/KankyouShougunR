...
namespace Shougun.Core.ReceiptPayManagement.NyuuSyutuKinIchiran.DBAccesser
{
    ...
    public class DBAccessor
    {
        ...
        /// IT_UKEIRE_ENTRYDao
        /// </summary>
        Shougun.Core.SalesPayment.Uriagekakutenyuryoku.DAO.DAOClass myDao;
        ...
        public DBAccessor()
        {
            ...
            myDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.Uriagekakutenyuryoku.DAO.DAOClass>();
