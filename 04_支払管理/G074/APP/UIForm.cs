...
namespace Shougun.Core.PaymentManagement.KaikakekinItiranHyo
{
    ...
    public partial class UIForm : SuperForm
    {
        ...
        public UIForm(UIHeader headerForm)
            : base(WINDOW_ID.T_KAIKAKEKIN_ICHIRANHYOU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            // コンポーネントの初期化
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (this.KaikakekinItiranHyo != null)
            {
                this.KaikakekinItiranHyo.Anchor = AnchorStyles.Top | AnchorStyles.Right | AnchorStyles.Bottom | AnchorStyles.Left;
            }
        }
        ...
        {
            // 範囲条件指定画面表示
            this.logic.ShowPopUp(Shougun.Core.Common.Kakepopup.Const.UIConstans.DispType.KAIKAKE);
        }
        ...
        /// <param name="e"></param>
        private void KaikakekinItiranHyo_SortCompare(object sender, DataGridViewSortCompareEventArgs e)
        {
