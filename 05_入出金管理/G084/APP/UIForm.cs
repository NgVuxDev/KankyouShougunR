...
namespace Shougun.Core.ReceiptPayManagement.NyukinKeshikomi
{
    ...
    public partial class UIForm : IchiranSuperForm
    {
        ...
        private NyukinKeshikomi.LogicClass Logic;
        ...
        public UIForm(UIHeader headerForm, String strNyuukinNum, string kyotenCd, string denpyouHidukeForm)
            : base(DENSHU_KBN.NYUUKIN_KESHIKOMI_RIEKI_ICHIRAN, false)
        {
            this.InitializeComponent();

            this.header_new = headerForm;

            //header_new.form = this;
            ...
            //入金番号
            //if (this.header_new.txtNum_HidukeSentaku.Text == "3")
            //{
                this.Nyuukin_CD.Text = strNyuukinNum;
            //}
        ...
        private void HideSystemColumn()
        {
            ...
            // 入金番号
            if (this.customDataGridView1.Columns.Contains(this.Logic.HIDDEN_NYUUKIN_NUMBER))
            {
                this.customDataGridView1.Columns[this.Logic.HIDDEN_NYUUKIN_NUMBER].Visible = false;
            }
