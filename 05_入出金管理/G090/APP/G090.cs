...
namespace Shougun.Core.ReceiptPayManagement.Syukinnyuryoku
{
    ...
    /// G090 出金入力
    /// </summary>
    class G090 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// フォームを作成します
        /// </summary>
        ...
        public bool IsSameContentForm(Form form, params object[] args)
        {
            if (args.Length > 1)
            {
                String SHUKKIN_CD = (String)args[1];
                var footerForm = form as BusinessBaseForm;
                var uiForm = footerForm.inForm as Shougun.Core.ReceiptPayManagement.Syukinnyuryoku.UIForm;
                if (uiForm.SHUKKIN_NUMBER.Text == SHUKKIN_CD)
                {
                    return true;
                }
            }
