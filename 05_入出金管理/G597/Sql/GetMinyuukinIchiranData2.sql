...
LEFT JOIN (
    ...
    GROUP BY TORIHIKISAKI_CD, SEIKYUU_NUMBER, KAGAMI_NUMBER
) AS TNK
    ON MTS.TORIHIKISAKI_CD = TNK.TORIHIKISAKI_CD AND TNK.SEIKYUU_NUMBER = 0 AND TNK.KAGAMI_NUMBER = 0
...
SELECT
    ...
    ISNULL(TSDK.KONKAI_URIAGE_GAKU, 0) + ISNULL(TSDK.KONKAI_SEI_UTIZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_SEI_SOTOZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_DEN_UTIZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_DEN_SOTOZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_MEI_UTIZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_MEI_SOTOZEI_GAKU, 0) AS SEIKYUU_GAKU,
    ISNULL(TNK.NYUUKIN_GAKU, 0) AS NYUUKIN_GAKU,
    (ISNULL(TSDK.KONKAI_URIAGE_GAKU, 0) + ISNULL(TSDK.KONKAI_SEI_UTIZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_SEI_SOTOZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_DEN_UTIZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_DEN_SOTOZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_MEI_UTIZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_MEI_SOTOZEI_GAKU, 0)) - ISNULL(TNK.NYUUKIN_GAKU, 0) AS MINYUUKIN_GAKU,
    TSD.SHIMEBI,
...
JOIN T_SEIKYUU_DENPYOU_KAGAMI TSDK
...
LEFT JOIN (SELECT
           ...
           GROUP BY TNK.SEIKYUU_NUMBER, KAGAMI_NUMBER
		   ) TNK
...
AND (ISNULL(TSDK.KONKAI_URIAGE_GAKU, 0) + ISNULL(TSDK.KONKAI_SEI_UTIZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_SEI_SOTOZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_DEN_UTIZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_DEN_SOTOZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_MEI_UTIZEI_GAKU, 0) + ISNULL(TSDK.KONKAI_MEI_SOTOZEI_GAKU, 0)) - ISNULL(TNK.NYUUKIN_GAKU, 0) <> 0
AND CONVERT(varchar, TSD.NYUUKIN_YOTEI_BI, 111) <= CONVERT(varchar, GETDATE(), 111)

/*IF dto.Sort2 == 1*/
ORDER BY TORIHIKISAKI_CD, GYOUSHA_CD, GENBA_CD, EIGYOUSHA_CD, SEIKYUU_NUMBER
/*END*/
/*IF dto.Sort2 == 2*/
ORDER BY TORIHIKISAKI_FURIGANA, TORIHIKISAKI_CD, GYOUSHA_CD, GENBA_CD, EIGYOUSHA_CD, SEIKYUU_NUMBER
/*END*/