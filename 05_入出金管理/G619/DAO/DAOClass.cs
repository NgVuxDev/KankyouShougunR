...
namespace Shougun.Core.ReceiptPayManagement.NyukinNyuryoku3
{
    ...
    public interface IT_NYUUKIN_SUM_DETAILDao : IS2Dao
    {
        ...
        /// <returns>追加した行数</returns>
        [NoPersistentProps("TIME_STAMP")]
        int Update(T_NYUUKIN_SUM_DETAIL entity);
    ...
    public interface IT_NYUUKIN_ENTRYDao : IS2Dao
    {
        ...
        T_NYUUKIN_ENTRY GetNyuukinEntry(T_NYUUKIN_ENTRY entity);
        ...
        /// <param name="entity">条件エンティティ</param>
        /// <returns>入金入力エンティティリスト</returns>
        [SqlFile("Shougun.Core.ReceiptPayManagement.NyukinNyuryoku3.Sql.GetKeshikomiData.sql")]
        DataTable GetKeshikomiData(T_NYUUKIN_ENTRY data);
        ...
        [SqlFile("Shougun.Core.ReceiptPayManagement.NyukinNyuryoku3.Sql.GetPrevNyuukinNumber.sql")]
        T_NYUUKIN_ENTRY GetPrevNyuukinNumber(string nyuukinNumber, string kyotenCd);
        ...
        /// <param name="nyuukinNumber">基準の入金番号</param>
        /// <returns>入金番号</returns>
        [SqlFile("Shougun.Core.ReceiptPayManagement.NyukinNyuryoku3.Sql.GetNextNyuukinNumber.sql")]
        T_NYUUKIN_ENTRY GetNextNyuukinNumber(string nyuukinNumber, string kyotenCd);
    }
    ...
    public interface IT_NYUUKIN_DETAILDao : IS2Dao
    {
        ...
        /// <returns>追加した行数</returns>
        [NoPersistentProps("TIME_STAMP")]
        int Update(T_NYUUKIN_DETAIL entity);
    ...
    public interface IT_NYUUKIN_KESHIKOMIDao : IS2Dao
    {
        ...
        List<T_NYUUKIN_KESHIKOMI> GetNyuukinKeshikomi(SqlInt64 nyuukinNumber);
        ...
        /// <param name="nyuukinNumber">入金番号</param>
        /// <returns>入金消込エンティティリスト</returns>
        T_NYUUKIN_KESHIKOMI[] GetKeshikomi(T_NYUUKIN_KESHIKOMI data);
    }
    ...
    public interface IT_SHIME_SHORI_CHUUDao : IS2Dao
    {
        ...
        [Query("HIDUKE_HANI_BEGIN <= /*denpyouDate*/ AND HIDUKE_HANI_END >= /*denpyouDate*/ AND TORIHIKISAKI_CD = /*cd*/ AND SHORI_KBN = 1")]
    ...
    public interface IT_SEIKYUU_DENPYOUDao : IS2Dao
    {
        ...
        T_SEIKYUU_DENPYOU GetLastSeikyuuDenpyou(string torihikisakiCd, DateTime denpyouDate);
    }
    ...
    public interface IT_SEIKYUU_DETAILDao : IS2Dao
    {
        ...
        [SqlFile("Shougun.Core.ReceiptPayManagement.NyukinNyuryoku3.Sql.GetDataByNyuukinNumber.sql")]
        List<T_SEIKYUU_DETAIL> GetDataByNyuukinNumber(SqlInt64 nyuukinNumber);
        ...
        /// <returns>請求明細エンティティリスト</returns>
        [SqlFile("Shougun.Core.ReceiptPayManagement.NyukinNyuryoku3.Sql.GetDataBySeikyuuNumber.sql")]
        List<T_SEIKYUU_DETAIL> GetDataBySeikyuuNumber(SqlInt64 seikyuuNumber);
    }
