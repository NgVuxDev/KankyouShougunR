...
,inview.SEIKYUU_DATE
,ISNULL(inview.SEIKYUUGAKU,0) AS SEIKYUUGAKU
...
,inview.KESHIKOMI_BIKOU
 ...
 SELECT
	...
	MTS.KAISHI_URIKAKE_ZANDAKA AS SEIKYUUGAKU,
	TNK.KESHIKOMI_GAKU AS KESHIKOMIGAKU,
    TNK2.KESHIKOMI_GAKU_TOTAL AS KESHIKOMIGAKU_TOTAL,
	(MTS.KAISHI_URIKAKE_ZANDAKA - ISNULL(TNK2.KESHIKOMI_GAKU_TOTAL, 0)) AS MIKESHIKOMIGAKU,
	0 AS SEIKYUU_NUMBER,
	0 AS KAGAMI_NUMBER,
...
SELECT
	...
	(TSDK.KONKAI_URIAGE_GAKU + TSDK.KONKAI_SEI_UTIZEI_GAKU + TSDK.KONKAI_SEI_SOTOZEI_GAKU 
	+ TSDK.KONKAI_DEN_UTIZEI_GAKU + TSDK.KONKAI_DEN_SOTOZEI_GAKU + TSDK.KONKAI_MEI_UTIZEI_GAKU
	+ TSDK.KONKAI_MEI_SOTOZEI_GAKU) AS SEIKYUUGAKU,
	TNK.KESHIKOMI_GAKU AS KESHIKOMIGAKU,
	TNK2.KESHIKOMI_GAKU_TOTAL AS KESHIKOMIGAKU_TOTAL,
	(TSDK.KONKAI_URIAGE_GAKU + TSDK.KONKAI_SEI_UTIZEI_GAKU + TSDK.KONKAI_SEI_SOTOZEI_GAKU 
	+ TSDK.KONKAI_DEN_UTIZEI_GAKU + TSDK.KONKAI_DEN_SOTOZEI_GAKU + TSDK.KONKAI_MEI_UTIZEI_GAKU
...
WHERE
	...
	/*END*/
	/*IF data.SEIKYUU_DATE_FROM != null && data.SEIKYUU_DATE_FROM != ''*/
	AND TSD.SEIKYUU_DATE >= /*data.SEIKYUU_DATE_FROM*/
	/*END*/
	/*IF data.SEIKYUU_DATE_TO != null && data.SEIKYUU_DATE_TO != ''*/
	AND TSD.SEIKYUU_DATE <= /*data.SEIKYUU_DATE_TO*/
	/*END*/
	AND TSD.DELETE_FLG = 0
) inview
 order by ROW_NUMBER, GYOUSHA_CD, GENBA_CD, NYUUKIN_NUMBER
