...
namespace Shougun.Core.ReceiptPayManagement.NyuukinShuukeiChouhyou.Controls
{
    ...
    public partial class PatternList : UserControl
    {
        ...
        public PatternList()
        {
            ...
            this.SHUTSURYOKU_KOUMOKU_3.DataSource = new List<S_LIST_COLUMN_SELECT>();
            this.SHUTSURYOKU_KOUMOKU_4.DataSource = new List<S_LIST_COLUMN_SELECT>();
            this.SHUTSURYOKU_KOUMOKU_5.DataSource = new List<S_LIST_COLUMN_SELECT>();
        ...
        private void PATTERN_LIST_BOX_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.SHUTSURYOKU_KOUMOKU_3.DataSource = new List<S_LIST_COLUMN_SELECT>() { select3 };
                this.SHUTSURYOKU_KOUMOKU_4.DataSource = new List<S_LIST_COLUMN_SELECT>() { select4 };
                this.SHUTSURYOKU_KOUMOKU_5.DataSource = new List<S_LIST_COLUMN_SELECT>() { select5 };
        ...
        public void ClearKoumoku()
        {
            ...
            this.SHUTSURYOKU_KOUMOKU_3.SelectedIndex = -1;
            this.SHUTSURYOKU_KOUMOKU_4.SelectedIndex = -1;
            this.SHUTSURYOKU_KOUMOKU_5.SelectedIndex = -1;
