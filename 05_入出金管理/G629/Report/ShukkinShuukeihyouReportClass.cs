...
namespace Shougun.Core.ReceiptPayManagement.ShukkinShuukeiChouhyou
{
    ...
    /// 入金集計表帳票作成クラス
    /// </summary>
    internal class ShukkinShuukeihyouReportClass
    {
        /// <summary>
        /// システム設定エンティティ
        /// </summary>
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        internal ShukkinShuukeihyouReportClass()
        {
        ...
        internal void CreateReport(DataTable dt, ShukkinShuukeihyouDtoClass dto)
        {
            ...
            ReportInfoR630 reportInfo = new ReportInfoR630(headerDataTable, chouhyouDataTable);
            reportInfo.CreateR630();
            reportInfo.Title = "出金集計表(" + dto.Pattern.PATTERN_NAME + ")";
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        private DataTable CreateHeaderDt(ShukkinShuukeihyouDtoClass dto)
        {
            ...
            // Header項目の値
            // タイトル
            dr["TITLE"] = "出金集計表" + " (" + dto.Pattern.PATTERN_NAME + ")";
            // 自社
        ...
        /// <returns></returns>
        public DataTable CreateChouhyouDt(DataTable dt, ShukkinShuukeihyouDtoClass dto)
        {
            DataTable retDt = new DataTable();
