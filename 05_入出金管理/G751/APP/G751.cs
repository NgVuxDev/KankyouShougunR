...
namespace Shougun.Core.ReceiptPayManagement.ShukkinKeshikomiShusei
{
    ...
    /// G751 出金消込修正入力
    /// </summary>
    class G751 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// フォーム作成
        /// </summary>
        ...
        public Form CreateForm(params object[] args)
        {
            ...
            string SEISAN_DATE_TO = string.Empty;
            if (args.Length > 0)
            {
            ...
            var shukkinNumber = string.Empty;
            if (args.Length > 4 && args[4] != null)
            {
                shukkinNumber = (String)args[4];
            }

            var HeaderForm = new HeaderBaseForm();
            var callForm = new UIForm(windowType, SEISAN_DATE_TO, TORIHIKISAKI_CD, TORIHIKISAKI_NAME, shukkinNumber);
