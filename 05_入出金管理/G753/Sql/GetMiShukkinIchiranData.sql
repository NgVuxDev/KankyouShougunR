...
LEFT JOIN (
    ...
    GROUP BY TORIHIKISAKI_CD, SEISAN_NUMBER
) AS TNK
    ON MTS.TORIHIKISAKI_CD = TNK.TORIHIKISAKI_CD AND TNK.SEISAN_NUMBER = 0
...
SELECT
    ...
    ISNULL(TSD.KONKAI_SHIHARAI_GAKU, 0) + ISNULL(TSD.KONKAI_SEI_UTIZEI_GAKU, 0) + ISNULL(TSD.KONKAI_SEI_SOTOZEI_GAKU, 0) + ISNULL(TSD.KONKAI_DEN_UTIZEI_GAKU, 0) + ISNULL(TSD.KONKAI_DEN_SOTOZEI_GAKU, 0) + ISNULL(TSD.KONKAI_MEI_UTIZEI_GAKU, 0) + ISNULL(TSD.KONKAI_MEI_SOTOZEI_GAKU, 0) AS SEISAN_GAKU,
    ISNULL(TNK.SHUKKIN_GAKU, 0) AS SHUKKIN_GAKU,
    (ISNULL(TSD.KONKAI_SHIHARAI_GAKU, 0) + ISNULL(TSD.KONKAI_SEI_UTIZEI_GAKU, 0) + ISNULL(TSD.KONKAI_SEI_SOTOZEI_GAKU, 0) + ISNULL(TSD.KONKAI_DEN_UTIZEI_GAKU, 0) + ISNULL(TSD.KONKAI_DEN_SOTOZEI_GAKU, 0) + ISNULL(TSD.KONKAI_MEI_UTIZEI_GAKU, 0) + ISNULL(TSD.KONKAI_MEI_SOTOZEI_GAKU, 0)) - ISNULL(TNK.SHUKKIN_GAKU, 0) AS MISHUKKIN_GAKU,
    TSD.SHIMEBI,
...
GROUP BY TNK.SEISAN_NUMBER) TNK
    ON TSD.SEISAN_NUMBER = TNK.SEISAN_NUMBER
...
AND (ISNULL(TSD.KONKAI_SHIHARAI_GAKU, 0) + ISNULL(TSD.KONKAI_SEI_UTIZEI_GAKU, 0) + ISNULL(TSD.KONKAI_SEI_SOTOZEI_GAKU, 0) + ISNULL(TSD.KONKAI_DEN_UTIZEI_GAKU, 0) + ISNULL(TSD.KONKAI_DEN_SOTOZEI_GAKU, 0) + ISNULL(TSD.KONKAI_MEI_UTIZEI_GAKU, 0) + ISNULL(TSD.KONKAI_MEI_SOTOZEI_GAKU, 0)) - ISNULL(TNK.SHUKKIN_GAKU, 0) <> 0
AND CONVERT(varchar, TSD.SHUKKIN_YOTEI_BI, 111) <= CONVERT(varchar, GETDATE(), 111)

/*IF dto.Sort1 == 1 && dto.Sort2 == 1*/
ORDER BY EIGYOUSHA_CD, TORIHIKISAKI_CD, SEISAN_NUMBER
/*END*/
/*IF dto.Sort1 == 1 && dto.Sort2 == 2*/
ORDER BY SHAIN_FURIGANA, EIGYOUSHA_CD, TORIHIKISAKI_CD, SEISAN_NUMBER
/*END*/
/*IF dto.Sort1 == 2 && dto.Sort2 == 1*/
ORDER BY TORIHIKISAKI_CD, EIGYOUSHA_CD, SEISAN_NUMBER
/*END*/
/*IF dto.Sort1 == 2 && dto.Sort2 == 2*/
ORDER BY TORIHIKISAKI_FURIGANA, TORIHIKISAKI_CD, EIGYOUSHA_CD, SEISAN_NUMBER
/*END*/