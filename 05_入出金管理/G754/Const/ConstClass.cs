...
namespace Shougun.Core.ReceiptPayManagement.ShukkinYoteiIchiran
{
    ...
    internal static class ConstClass
    {
        ...
        /// 帳票タイトル「出金予定一覧表」
        /// </summary>
        internal static readonly string SHUKKIN_YOTEI_ICHIRAN_TITLE = "出金予定一覧表";
        ...
        /// 帳票サブタイトル「取引先」
        /// </summary>
        internal static readonly string SORT_SHUKKIN_YOTEI_HI_SUB_TITLE = "出金予定日";
        ...
        /// カラム「出金予定日」
        /// </summary>
        internal static readonly string COLUMN_SHUKKIN_YOTEI_HI = "出金予定日";
        ...
        /// 並び順１「出金予定日」
        /// </summary>
        internal static readonly int SORT_1_SHUKKIN_YOTEI_BI = 3;
        ...
        /// 出金消込状況 1.する
        /// </summary>
        internal static readonly int SHUKKIN_KESHIGOMU_JOUKYOU_SURU = 1;

        /// <summary>
        /// 出金消込状況 2.しない
        /// </summary>
        internal static readonly int SHUKKIN_KESHIGOMU_JOUKYOU_SHINAI = 2;
    }
}
