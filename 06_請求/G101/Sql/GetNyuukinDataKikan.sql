...
WHERE
T_N.TORIHIKISAKI_CD = /*data.SEIKYU_CD*/
/*IF data.SEIKYUSHIMEBI_FROM != "" && data.SEIKYUSHIMEBI_FROM != null*/
AND CONVERT(DateTime,/*data.SEIKYUSHIMEBI_FROM*/null, 111) <= T_N.DENPYOU_DATE/*END*/
AND T_N.DENPYOU_DATE <= CONVERT(DateTime,/*data.SEIKYUSHIMEBI_TO*/null, 111)
