...
namespace Shougun.Core.Billing.Seikyucheckhyo.DAO
{
    ...
    public interface MTSDaoCls : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Billing.Seikyucheckhyo.Sql.GetTorihikisakiDataSql.sql")]
    ...
    public interface SSEDaoCls : IS2Dao
    {
        ...
        /// <param name="date"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Billing.Seikyucheckhyo.Sql.GetShimeShoriErrorDataSql.sql")]
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [Sql("SELECT * FROM T_SHIME_SHORI_ERROR")]
        T_SHIME_SHORI_ERROR[] GetAllData();
