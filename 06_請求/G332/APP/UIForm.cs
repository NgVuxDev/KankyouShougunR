...
namespace Shougun.Core.Billing.SeikyuuShimeError
{
    ...
    public partial class UIForm : SuperForm
    {
        ...
        /// ヘッダー
        /// </summary>
        HeaderSeikyuuShimeError headerForm;
        ...
        public UIForm(DataTable dt, HeaderSeikyuuShimeError headerForm, string kyotenCd)
            : base(WINDOW_ID.T_SEIKYU_SHIME_ERROR, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
