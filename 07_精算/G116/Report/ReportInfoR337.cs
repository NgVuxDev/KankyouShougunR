...
namespace Shougun.Core.Adjustment.ShiharaiMeisaishoHakko
{
    ...
    /// <summary> R337(請求書)帳票を表すクラス・コントロール </summary>
    public class ReportInfoR337 : ReportInfoBase
    {
        #region - Fields -
        ...
        public ReportInfoR337()
        {
            // パスとレイアウトのデフォルト値を設定しておく

            // 帳票出力フルパスフォーム名
            this.OutputFormFullPathName = "./Template/R337-Form.xml";
