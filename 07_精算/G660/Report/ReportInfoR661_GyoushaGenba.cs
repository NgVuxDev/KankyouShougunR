...
namespace Shougun.Core.Adjustment.ShiharaiMeisaiMeisaihyou
{
    ...
    //R661 支払明細明細表（業者・現場別）
    public class ReportInfoR661_GyoushaGenba : ReportInfoBase
    {
        ...
        public ReportInfoR661_GyoushaGenba(DataTable dataTableInput, DTOClass dto)
            : base(dataTableInput)
        {

            this.Title = "支払明細明細表（業者・現場別）";
        ...
        private void InputDataToMem(DataTable dataTable)
        {
            ...
            foreach (DataRow dtRow in dataTable.Rows)
            {
                ...
                //今回御精算額
                decimal konkaiSeisanGaku = this.GetDecimal(dtRow["KONKAI_SEISAN_GAKU"]);
                konkaiSeisanGaku = this.FractionCalc(konkaiSeisanGaku, 3);
                newRow["PHY_KONKAI_SEISAN_GAKU_VLB"] = this.FormatDecimal(konkaiSeisanGaku, 1);
                KONKAI_SEISAN_GAKU_TOTAL += konkaiSeisanGaku;
            ...
            if (this.chouhyouDataTable.Rows.Count > 0)
            {
                ...
                //今回御精算額 合計
                lastRow["PHN_KONKAI_SEISAN_GAKU_TOTAL_VLB"] = this.FormatDecimal(KONKAI_SEISAN_GAKU_TOTAL, 1);
            }
        }
        /// <summary>
        /// 
