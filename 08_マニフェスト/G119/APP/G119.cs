...
namespace Shougun.Core.PaperManifest.SampaiManifestoChokkou
{
    ...
    /// G119 産廃マニフェスト(直行)
    /// </summary>
    class G119 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// フォーム作成
        /// </summary>
        ...
        public Form CreateForm(params object[] args)
        {
            ...
            // 引数 arg[6] :業者CD
            // 引数 arg[7] :現場CD
            SampaiManifestoChokkou callForm = null;
            //データ移動モード判定
            if (window_type == WINDOW_TYPE.NEW_WINDOW_FLAG &&
                ...
                args[4] == null)
            {
                callForm = new Shougun.Core.PaperManifest.SampaiManifestoChokkou.SampaiManifestoChokkou(window_type, RDentatuKbn, SystemId, RMeisaiId, iMode,
            ...
            var callHeader = new Shougun.Core.PaperManifest.SampaiManifestoChokkou.SampaiManifestoChokkouHeader();
        ...
        public bool IsSameContentForm(Form form, params object[] args)
        {
            ...
            if (args.Length > 4)
            {
                ...
                var uiForm = callForm.inForm as SampaiManifestoChokkou;
