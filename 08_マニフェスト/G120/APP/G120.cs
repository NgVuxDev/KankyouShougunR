...
namespace Shougun.Core.PaperManifest.SampaiManifestoThumiKae
{
    ...
    /// G120 産廃マニフェスト(積替)
    /// </summary>
    class G120 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// フォーム作成
        /// </summary>
        ...
        public Form CreateForm(params object[] args)
        {
            ...
            // 引数 arg[6] :業者CD
            // 引数 arg[7] :現場CD
            SampaiManifestoThumiKae callForm = null;
            //データ移動モード判定
            if (window_type == WINDOW_TYPE.NEW_WINDOW_FLAG &&
                ...
                args[4] == null)
            {
                callForm = new Shougun.Core.PaperManifest.SampaiManifestoThumiKae.SampaiManifestoThumiKae(window_type, RDentatuKbn, SystemId, RMeisaiId, iMode,
            ...
            var callHeader = new Shougun.Core.PaperManifest.SampaiManifestoThumiKae.SampaiManifestoThumiKaeHeader();
            // 20140606 syunrei No.730 規定値機能の追加について start
            callHeader.form1 = callForm;
        ...
        public bool IsSameContentForm(Form form, params object[] args)
        {
            ...
            if (args.Length > 4)
            {
                ...
                var uiForm = callForm.inForm as SampaiManifestoThumiKae;
