...
FROM
    ...
    LEFT OUTER JOIN M_GENBA AS MG
    ON  MG.GYOUSHA_CD = R18EX.HST_GYOUSHA_CD
    AND MG.GENBA_CD = R18EX.HST_GENBA_CD
    LEFT JOIN M_GYOUSHA AS HST_GYOUSHA ON R18EX.HST_GYOUSHA_CD = HST_GYOUSHA.GYOUSHA_CD
WHERE
    (R18EX.HST_GENBA_CD IS NOT NULL OR  R18EX.HST_GENBA_CD <> '')
AND ISNULL(MG.HAISHUTSU_NIZUMI_GENBA_KBN, 0) != 1
