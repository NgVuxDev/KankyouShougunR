SELECT
    ...
    CASE
      WHEN R19EX.UPN_ROUTE_NO = '1' THEN '101'
      WHEN R19EX.UPN_ROUTE_NO = '2' THEN '102'
      WHEN R19EX.UPN_ROUTE_NO = '3' THEN '103'
      WHEN R19EX.UPN_ROUTE_NO = '4' THEN '104'
      WHEN R19EX.UPN_ROUTE_NO = '5' THEN '105'
    ELSE ''
    END AS CK_KOUMOKU
FROM
    DT_R18 AS R18
...
WHERE
    ((R19EX.UPNSAKI_GENBA_CD IS NOT NULL OR R19EX.UPNSAKI_GENBA_CD <> '') AND MG.GENBA_CD IS NULL)
