SELECT
    ...
    CASE
      WHEN R19EX.UPN_ROUTE_NO = '1' THEN '101_2'
      WHEN R19EX.UPN_ROUTE_NO = '2' THEN '102_2'
      WHEN R19EX.UPN_ROUTE_NO = '3' THEN '103_2'
      WHEN R19EX.UPN_ROUTE_NO = '4' THEN '104_2'
      WHEN R19EX.UPN_ROUTE_NO = '5' THEN '105_2'
    ELSE ''
    END AS CK_KOUMOKU
FROM
    DT_R18 AS R18
...
WHERE
    (R19EX.UPNSAKI_GENBA_CD IS NOT NULL OR R19EX.UPNSAKI_GENBA_CD <> '')
AND ISNULL(MG.TSUMIKAEHOKAN_KBN, 0) != 1
AND ISNULL(MG.SHOBUN_NIOROSHI_GENBA_KBN, 0) != 1
AND ISNULL(MG.SAISHUU_SHOBUNJOU_KBN, 0) != 1
