SELECT
    ...
    CASE
      WHEN R19EX.UPN_ROUTE_NO = '1' THEN '81_3'
      WHEN R19EX.UPN_ROUTE_NO = '2' THEN '92_3'
      WHEN R19EX.UPN_ROUTE_NO = '3' THEN '93_3'
      WHEN R19EX.UPN_ROUTE_NO = '4' THEN '94_3'
      WHEN R19EX.UPN_ROUTE_NO = '5' THEN '95_3'
    ELSE ''
    END AS CK_KOUMOKU
FROM
    DT_R18 AS R18
...
WHERE
    (R19EX.UPN_GYOUSHA_CD IS NOT NULL OR R19EX.UPN_GYOUSHA_CD <> '')
