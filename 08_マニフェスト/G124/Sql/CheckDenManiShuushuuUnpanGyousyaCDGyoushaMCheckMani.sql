SELECT
    ...
    CASE
      WHEN R19EX.UPN_ROUTE_NO = '1' THEN '81_2'
      WHEN R19EX.UPN_ROUTE_NO = '2' THEN '92_2'
      WHEN R19EX.UPN_ROUTE_NO = '3' THEN '93_2'
      WHEN R19EX.UPN_ROUTE_NO = '4' THEN '94_2'
      WHEN R19EX.UPN_ROUTE_NO = '5' THEN '95_2'
    ELSE ''
    END AS CK_KOUMOKU
FROM
    DT_R18 AS R18
