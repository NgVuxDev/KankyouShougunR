...
FROM (
        SELECT
            DT_R18.FIRST_MANIFEST_FLAG,
            DT_R18.MANIFEST_ID,
            DT_R18.KANRI_ID,DT_R18.SEQ,
            DT_R18.HIKIWATASHI_DATE,
            DT_R18.SBN_END_DATE,
            DT_R18.LAST_SBN_END_DATE,
            (CASE WHEN R18EX.DETAIL_SYSTEM_ID IS NOT NULL
                THEN R18EX.HAIKI_UNIT_CD
                ELSE DT_R18.HAIKI_UNIT_CODE
            END) AS HAIKI_UNIT_CODE,
    ...
    LEFT JOIN M_GYOUSHA AS HST_GYOUSHA ON R18.HST_GYOUSHA_CD = HST_GYOUSHA.GYOUSHA_CD
WHERE
    (R18.HAIKI_UNIT_CODE IS NULL OR R18.HAIKI_UNIT_CODE = '')
...
/*END*/
/*IF data.SBNJ_CD != null && data.SBNJ_CD != ''*/AND R18.SBN_GYOUSHA_CD = /*data.SBNJ_CD*/''/*END*/
/*IF data.SBNB_CD != null && data.SBNB_CD != ''*/AND R18.SBN_GENBA_CD = /*data.SBNB_CD*/''/*END*/
/*IF data.JOUKEN == '1'*/
            AND
                (exists
                    (
