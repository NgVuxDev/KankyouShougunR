SELECT
    ...
    TME.SYSTEM_ID,
    CASE
      WHEN MUPN.UPN_ROUTE_NO = '1' THEN '81_3'
      WHEN MUPN.UPN_ROUTE_NO = '2' THEN '92_3'
      WHEN MUPN.UPN_ROUTE_NO = '3' THEN '93_3'
    ELSE ''
    END AS CK_KOUMOKU
FROM
...
/*IF !data.UPN_ROUTE_NO.IsNull && data.UPN_ROUTE_NO != ''*/AND MUPN.UPN_ROUTE_NO = /*data.UPN_ROUTE_NO*/1/*END*/
AND ((MUPN.UPN_GYOUSHA_CD IS NOT NULL OR MUPN.UPN_GYOUSHA_CD <> ''))
AND ISNULL(MG.UNPAN_JUTAKUSHA_KAISHA_KBN, 0) != 1
