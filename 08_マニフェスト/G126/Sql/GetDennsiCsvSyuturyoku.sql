...
SELECT R05_1.RENRAKU_ID AS RENRAKU_ID_1,
       ...
       --排出事業場コード
	   JIGYOUJOU_HS.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_HS,
       --引渡し担当者
	   ...
	   --運搬先事業場番号
	   --JIGYOUJOU_SU_1.JWNET_JIGYOUJOU_CD AS UPNSAKI_JOU_ID_1,
       CASE JIGYOUJOU_SU_1.JWNET_JIGYOUJOU_CD
		WHEN NULL THEN ''
		ELSE RIGHT('000' + CONVERT(VARCHAR(3), JIGYOUJOU_SU_1.JWNET_JIGYOUJOU_CD), 3)
	   ...
	   --運搬先事業場番号
	   --JIGYOUJOU_SU_2.JWNET_JIGYOUJOU_CD AS UPNSAKI_JOU_ID_2,
       CASE JIGYOUJOU_SU_2.JWNET_JIGYOUJOU_CD
		WHEN NULL THEN ''
		ELSE RIGHT('000' + CONVERT(VARCHAR(3), JIGYOUJOU_SU_2.JWNET_JIGYOUJOU_CD), 3)
	   ...
	   --運搬先事業場番号
	   --JIGYOUJOU_SU_3.JWNET_JIGYOUJOU_CD AS UPNSAKI_JOU_ID_3,
       CASE JIGYOUJOU_SU_3.JWNET_JIGYOUJOU_CD
		WHEN NULL THEN ''
		ELSE RIGHT('000' + CONVERT(VARCHAR(3), JIGYOUJOU_SU_3.JWNET_JIGYOUJOU_CD), 3)
	   ...
	   --運搬先事業場番号
	   --JIGYOUJOU_SU_4.JWNET_JIGYOUJOU_CD AS UPNSAKI_JOU_ID_4,
       CASE JIGYOUJOU_SU_4.JWNET_JIGYOUJOU_CD
		WHEN NULL THEN ''
		ELSE RIGHT('000' + CONVERT(VARCHAR(3), JIGYOUJOU_SU_4.JWNET_JIGYOUJOU_CD), 3)
	   ...
	   --運搬先事業場番号
	   --JIGYOUJOU_SU_5.JWNET_JIGYOUJOU_CD AS UPNSAKI_JOU_ID_5,
       CASE JIGYOUJOU_SU_5.JWNET_JIGYOUJOU_CD
		WHEN NULL THEN ''
		ELSE RIGHT('000' + CONVERT(VARCHAR(3), JIGYOUJOU_SU_5.JWNET_JIGYOUJOU_CD), 3)
       ...
       --処分事業場コード
       CASE JIGYOUJOU_SB.JWNET_JIGYOUJOU_CD
		WHEN NULL THEN ''
		ELSE RIGHT('000' + JIGYOUJOU_SB.JWNET_JIGYOUJOU_CD, 3)
       ...
       --最終処分事業場１コード
	   JIGYOUJOU_SBYT_1.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_1,
       --最終処分事業場２コード
	   JIGYOUJOU_SBYT_2.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_2,
       --最終処分事業場３コード
	   JIGYOUJOU_SBYT_3.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_3,
       --最終処分事業場４コード
	   JIGYOUJOU_SBYT_4.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_4,
       --最終処分事業場５コード
	   JIGYOUJOU_SBYT_5.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_5,
       --最終処分事業場６コード
	   JIGYOUJOU_SBYT_6.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_6,
       --最終処分事業場７コード
	   JIGYOUJOU_SBYT_7.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_7,
       --最終処分事業場８コード
	   JIGYOUJOU_SBYT_8.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_8,
       --最終処分事業場９コード
	   JIGYOUJOU_SBYT_9.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_9,
       --最終処分事業場１０コード
	   JIGYOUJOU_SBYT_10.JWNET_JIGYOUJOU_CD AS JIGYOUJOU_CD_SBYT_10,
       --備考１
