...
(
SELECT
          R13EX.LAST_SBN_GYOUSHA_CD AS LAST_SBN_GYOUSHA_CD,R13EX.LAST_SBN_GENBA_CD AS LAST_SBN_GENBA_CD,
...
--          ,R18EX.KANSAN_SUU AS KANSAN_SUU
...
LEFT JOIN
  ...
  AND        R13EX.LAST_SBN_GENBA_CD IS NOT NULL AND R13EX.LAST_SBN_GENBA_CD <> ''
  AND        R13EX.LAST_SBN_GYOUSHA_CD IS NOT NULL AND R13EX.LAST_SBN_GYOUSHA_CD <> ''
...
GROUP BY  R13EX.LAST_SBN_GYOUSHA_CD,R13EX.LAST_SBN_GENBA_CD,
