-- マニフェスト推移表 電子マニフェスト 運搬受託者別  --

SELECT
	'電子' AS HAIKI_KBN_CD
,	R19EX.UPN_GYOUSHA_CD AS UPN_GYOUSHA_CD
...
--運搬受託者別 WHERE句 >>
AND R19EX.UPN_GYOUSHA_CD IS NOT NULL AND R19EX.UPN_GYOUSHA_CD <> ''
--運搬受託者別 WHERE句 <<

GROUP BY  R19EX.UPN_GYOUSHA_CD,
