...
namespace Shougun.Core.PaperManifest.HenkyakuIchiran.DAO
{
    ...
    [Bean(typeof(M_GENBA))]
    public interface MGENBADao : IS2Dao
    {
        /// <summary>
        /// Entityで絞り込んで現場、業者情報を取得
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.PaperManifest.HenkyakuIchiran.Sql.GetgenbagyoushaMst.sql")]
        DataTable GetGenbaGyoushaDataForEntity(M_GENBA data);

        /// <summary>
        /// Entityで絞り込んで現場情報を取得
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.PaperManifest.HenkyakuIchiran.Sql.GetgenbaMst.sql")]
        DataTable GetGenbaDataForEntity(M_GENBA data);
        /// <summary>
        /// Entityで絞り込んで現場情報を取得
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.PaperManifest.HenkyakuIchiran.Sql.GetgenbaSbn.sql")]
        DataTable GetGenbaSbnDataForEntity(M_GENBA data);//157020
    }
   
    [Bean(typeof(M_GYOUSHA))]
    public interface MGYOUSHADao : IS2Dao
    {
        ...
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.PaperManifest.HenkyakuIchiran.Sql.GetgyoushaMst.sql")]
        DataTable GetGyoushaDataForEntity(M_GYOUSHA data);

    }
  
    [Bean(typeof(M_TORIHIKISAKI))]
    public interface MTORIHIKISAKIDao : IS2Dao
    {

        /// <summary>
        /// Entityで絞り込んで取引先情報を取得
        /// </summary>
        /// <returns></returns>
        [SqlFile("Shougun.Core.PaperManifest.HenkyakuIchiran.Sql.GettorihikisakiMst.sql")]
