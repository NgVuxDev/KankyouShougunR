...
namespace Shougun.Core.PaperManifest.ManifestShukeihyo
{
    ...
    internal static class ConstClass
    {
        ...
        /// 換算後数量の文言
        /// </summary>
        internal static readonly string SURYO = "換算後数量{0}";

        /// <summary>
        /// 廃棄物種類 - 画面表示名
        /// </summary>
        internal static readonly string HAIKIBUTSU_SHURUI_SCREEN_NAME = "廃棄物種類（報告書分類）";

        /// <summary>
        /// 廃棄物種類 - 印刷表示名
        /// </summary>
        internal static readonly string HAIKIBUTSU_SHURUI_PRINT_NAME = "廃棄物種類";
    }
}
