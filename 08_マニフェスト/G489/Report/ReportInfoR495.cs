...
namespace Report
{
    public class ReportInfoR495 : Shougun.Core.PaperManifest.InsatsuBusuSettei.Report.ReportInfoBaseG489
    {
        ...
        public ReportInfoR495()
        {
            // 帳票出力フルパスフォーム名
            //this.OutputFormFullPathName = TEMPLATE_PATH + "R495-Form.xml";
            this.OutputFormFullPathName = "Template/R495-Form.xml";
            //this.OutputFormFullPathName = "R495-Form.xml";
        ...
        public void R495_Report(DataTable chouhyouData)
        {
        ...
        private void InputDataToMem(DataTable dataTable)
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                else if (list[0] == "2-1")
                {
                    ...
                    for (var i = 0; i < 2; i++)
                    {
                        var idx = i * ReportInfoR495.UpnFieldCount;
                        // 運搬受託者
                    ...
                    for (var i = 0; i < 2; i++)
                    {
                        var idx = (i * 3) + (ReportInfoR495.UpnFieldCount * 2);
