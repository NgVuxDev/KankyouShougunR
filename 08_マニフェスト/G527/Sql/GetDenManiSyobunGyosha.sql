...
(
SELECT
          R19EX.UPNSAKI_GYOUSHA_CD AS UPN_SAKI_GYOUSHA_CD,R19EX.UPNSAKI_GENBA_CD AS UPN_SAKI_GENBA_CD,
...
--処分受託者別 WHERE句 >>
AND R19EX.UPNSAKI_GYOUSHA_CD IS NOT NULL AND R19EX.UPNSAKI_GYOUSHA_CD <> ''
AND R19EX.UPNSAKI_GENBA_CD IS NOT NULL AND R19EX.UPNSAKI_GENBA_CD <> ''
--処分受託者別 WHERE句 <<

GROUP BY  R19EX.UPNSAKI_GYOUSHA_CD,R19EX.UPNSAKI_GENBA_CD,
