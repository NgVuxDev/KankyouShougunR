...
namespace Shougun.Core.PaperManifest.JissekiHokokuSyuseiShobun
{
    ...
    public partial class JissekiHokokuSyuseiShobunForm : SuperForm
    {
        ...
        /// 画面ロジック
        /// </summary>
        private JissekiHokokuSyuseiShobunLogic logic;
        ...
        /// UIForm
        /// </summary>
        public JissekiHokokuSyuseiShobunForm(HeaderForm headerForm, WINDOW_ID windowId, WINDOW_TYPE windowType, string systemid)
            : base(windowId, windowType)
        {
            ...
            this.logic = new JissekiHokokuSyuseiShobunLogic(this);
        ...
        /// 委託先パップアップ後
        /// </summary>
        public void HikiWataShi_PopupAfter()
        {
            this.logic.HikiWataShi_PopupAfter(this.index);
        }
        ...
        /// 業者パップアップ後
        /// </summary>
        public void SbnGenba_PopupAfter()
        {
            this.logic.SbnGenba_PopupAfter(this.index);
        }
