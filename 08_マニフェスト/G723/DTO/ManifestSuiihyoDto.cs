...
{
    public class ManifestSuiihyoDto
    {
        /// <summary>
        /// デフォルトコンストラクタ
        /// </summary>
        public ManifestSuiihyoDto()
        {
        }
        ...
        /// </summary>
        public ArrayList ArrayPivot { get; set; }
        ...
        /// マニフェスト換算の基本単位名
        /// </summary>
        public string maniUnitName { get; set; }
