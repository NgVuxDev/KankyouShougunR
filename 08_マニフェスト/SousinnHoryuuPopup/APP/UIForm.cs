...
namespace Shougun.Core.PaperManifest.SousinnHoryuuPopup
{
    public partial class UIForm : SuperForm
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            logic = new LogicClass(this, this.Params);
            //メッセージクラス
        ...
        /// JWNET送信ボタン押下処理
        /// </summary>
        private void bt_JWNETsend_Click(object sender, EventArgs e)
        {
            logic.JWNETsend();
        }
        ...
        /// 保留保存ボタン押下処理
        /// </summary>
        private void bt_horyuhozonn_Click(object sender, EventArgs e)
        {
            logic.saveSyori();
        }
