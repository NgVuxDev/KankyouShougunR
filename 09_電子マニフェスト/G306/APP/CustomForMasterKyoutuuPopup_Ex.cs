...
using Shougun.Core.ElectronicManifest.UnpanShuryouHoukokuIkkatuNyuuryoku;
    ...
    public partial class CustomForMasterKyoutuuPopup_Ex : CustomAlphaNumTextBox
    {
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Space)
            {
                ...
                //    {
                //        //検索画面のタイトルを設定  
                //        this.PopupDataHeaderTitle = new string[] { "現場CD", "事業場名", "郵便番号", "電話番号", "住所" ,"事業場番号"};
                //        this.PopupGetMasterField = "GENBA_CD,JIGYOUJOU_NAME,JIGYOUJOU_POST,JIGYOUJOU_TEL,JIGYOUJOU_ADDRESS,JIGYOUJOU_CD";
                //        this.PopupDataSource = dt;
