// $Id: UIFormG536_G537_G538.cs 10981 2013-12-13 06:33:42Z sys_dev_18 $
...
namespace Shougun.Core.ReportOutput.CommonChouhyouViewer
{
    ...
    /// 計量集計表/一覧画面
    /// </summary>
    public partial class UIFormG536_G537_G538 : SuperForm
    {
        #region フィールド
        /// <summary>
        /// 画面ロジック
        /// </summary>
        private G536_G537_G538_LogicClass logic;
        ...
        public UIFormG536_G537_G538(UIHeaderForm headerForm,WINDOW_ID windowID)
            : base(windowID, WINDOW_TYPE.NONE)
        {
            try
            {
                ...
                this.logic = new G536_G537_G538_LogicClass(this);
