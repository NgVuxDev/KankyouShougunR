...
namespace Shougun.Core.Common.MeisaihyoSyukeihyoJokenShiteiPopup
{
    ...
    #region - ReportInfoR358_R362_R355 -

    /// <summary>売上明細表(R384)のレポート情報を表すクラス・コントロール</summary>
    internal class ReportInfoR358_R362_R355 : ReportInfoCommon
    {
        #region - Constructors -

        /// <summary>Initializes a new instance of the <see cref="ReportInfoR358_R362_R355" /> class.</summary>
        /// <param name="windowID">画面ＩＤ</param>
        /// <param name="dataTable">データーテーブル</param>
        /// <param name="commonChouhyouBase">共通帳票ベース</param>
        public ReportInfoR358_R362_R355(WINDOW_ID windowID, DataTable dataTable, CommonChouhyouBase commonChouhyouBase)
            ...
            try
            {
                ...
                switch (this.WindowID)
                {
                    ...
                    case WINDOW_ID.R_URIAGE_SHIHARAI_MEISAIHYOU:    // R355(売上／支払明細表)
                        ...
                        //this.SetFieldName("PHY_URIAGE_SHURUI_FLB", "売上種類");   // No.3513
                        this.SetFieldName("PHY_URIAGE_SHURUI_FLB", "");   // No.3513
    ...
    #endregion - ReportInfoR358_R362_R355 -
