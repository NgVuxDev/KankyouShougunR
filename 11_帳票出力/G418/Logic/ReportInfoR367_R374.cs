...
namespace Shougun.Core.Common.MeisaihyoSyukeihyoJokenShiteiPopup
{
    ...
    #region - ReportInfoR367_R374 -

    /// <summary>入金集計表(R367)・出金集計表(R374)のレポート情報を表すクラス・コントロール</summary>
    internal class ReportInfoR367_R374 : ReportInfoCommon
    {
        #region - Constructors -

        /// <summary>Initializes a new instance of the <see cref="ReportInfoR367_R374" /> class.</summary>
        /// <param name="windowID">画面ＩＤ</param>
        /// <param name="dataTable">データーテーブル</param>
        /// <param name="chusyutsuJoken">抽出条件</param>
        public ReportInfoR367_R374(WINDOW_ID windowID, DataTable dataTable, CommonChouhyouBase commonChouhyouBase)
                        ...
                        for (itemColumnIndex = 0; itemColumnIndex < syuukeiKoumokuEnableGroup; itemColumnIndex++)
                        {
                            ...
                            switch (itemColumnIndex)
                            {
                                case 0: // 集計項目１が有効
                                    ...
                                    this.SetFieldName("G2F_FILL_COND_ID_1_TOTAL_LBL_CTL", name + "合計");

                                    break;
                                case 1: // 集計項目２が有効
                                    this.SetGroupVisible("GROUP3", false, true);
                                    this.SetFieldName("G3F_FILL_COND_ID_2_TOTAL_LBL_CTL", name + "合計");

                                    break;
                                case 2: // 集計項目３が有効
                                    this.SetGroupVisible("GROUP4", false, true);
                                    this.SetFieldName("G4F_FILL_COND_ID_3_TOTAL_LBL_CTL", name + "合計");

                                    break;
                                case 3: // 集計項目４が有効
                                    //this.SetGroupVisible("GROUP4", false, true);
                                    //this.SetFieldName("G2F_FILL_COND_ID_4_TOTAL_LBL_CTL", name + "合計");
