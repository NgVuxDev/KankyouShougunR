...
namespace Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku
{
    ...
    public interface T_UKETSUKE_SS_DETAILDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.GetUketsukeSSDetailData.sql")]
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.GetSyuusyuuUketukeDetailData.sql")]
