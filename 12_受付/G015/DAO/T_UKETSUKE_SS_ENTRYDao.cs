// $Id: T_UKETSUKE_SS_ENTRYDao.cs 55371 2015-07-10 11:07:15Z t-thanhson@e-mall.co.jp $
...
namespace Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku
{
    ...
    public interface T_UKETSUKE_SS_ENTRYDao : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.UpdatePrintFlg.sql")]
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.UpdateShashuDaisu.sql")]
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.GetListUketsukeSSEntryData.sql")]
        ...
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.GetUketsukeSSEntryData.sql")]
        ...
        /// <summary>
        /// Get Inxs Pickup request data
        /// </summary>
        /// <param name="data">検索条件</param>
        /// <returns>DataTable</returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.GetPickupRequestInxsData.sql")]
        DataTable GetPickupRequestInxsData(DTOClass data);
        ...
        /// <param name="data">検索条件</param>
        /// <returns>DataTable</returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.GetDetailForMiTourokuUketuke.sql")]
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.GetHinmei3MonthData.sql")]
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.GetSharyou3MonthData.sql")]
        ...
        [Sql("SELECT ISNULL(MAX(SEQ),1) FROM T_UKETSUKE_SS_ENTRY WHERE UKETSUKE_NUMBER = /*uketsukeNumber*/")]
        ...
        [SqlFile("Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku.Sql.GetSmsJokyoData.sql")]
