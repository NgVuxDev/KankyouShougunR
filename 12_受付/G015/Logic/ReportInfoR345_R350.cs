...
namespace Shougun.Core.Reception.UketsukeSyuusyuuNyuuryoku
{
    ...
    public class ReportInfoR345_R350 : ReportInfoBase
    {
        ...
        public void CreateSampleData()
        {
            ...
            // 配車状況
            dataTableTmp.Columns.Add("HAISHA_JOKYO_NM");
            // 運転者CD
            ...
            if (isPrint)
            {
                ...
                // 配車状況
                rowTmp["HAISHA_JOKYO_NM"] = "あいうえお";
                // 運転者CD
                rowTmp["UNTENSHA_CD"] = "123456";
                // 運転者名
                rowTmp["UNTENSHA_NM"] = "あいうえおかきくけこさしすせそ";
                // 補助員CD
                rowTmp["HOJOIN_CD"] = "123456";
                // 補助員名
                rowTmp["HOJOIN_NM"] = "あいうえおかきくけこさしすせそ";
                // 車種CD
                rowTmp["SHASHU_CD"] = "123";
                // 車種名
                rowTmp["SHASHU_NM"] = "あいうえお";
                // 車輌CD
                rowTmp["SHARYO_CD"] = "123456";
                // 車輌名
                ...
                // 受付番号
                rowTmp["UKETSUKE_NO"] = "1234567";
                // 営業担当者CD
                rowTmp["EIGYOTANTO_CD"] = "123456";
                // 営業担当者名
                ...
                // 業者CD
                rowTmp["GYOSHA_CD"] = "123456";
                // 業者名
                rowTmp["GYOSHA_NM"] = "あいうえおかきくけこさしすせそたちつてとなにぬねの";
                // 現場名CD
                rowTmp["GENBA_CD"] = "123456";
                // 現場名
                rowTmp["GENBA_NM"] = "あいうえおかきくけこ";
                // 現場住所
                rowTmp["GENBA_JUSHO"] = "あいうえおかきくけこさしすせそたちつてとなにぬね";
                // 現場電話
                rowTmp["GENBA_DENWA_NO"] = "1234567890123";
                // 担当者
                rowTmp["TANTOSHA_NM"] = "あいうえおかきくけこさしすせそ";
                // 担当携帯
                rowTmp["TANTO_KEITAI_NO"] = "12345678901234567890";
                // 荷降業者CD/荷積業者CD
                rowTmp["NIOROSHIGYOSHA_CD"] = "123456";
                // 荷降業者名/荷積業者名
                rowTmp["NIOROSHIGYOSHA_NM"] = "あいうえおかきくけこさしすせそ";
                // 荷降場CD/荷積CD
                rowTmp["NIOROSHIJO_CD"] = "123456";
                // 荷降場名/荷積場名
                rowTmp["NIOROSHIJO_NM"] = "あいうえおかきくけこさしすせそ";
                // マニ種類CD
                rowTmp["MANI_TYPE_CD"] = "1";
                // マニ種類
                rowTmp["MANI_TYPE_NM"] = "あいうえお";
                // マニ手配CD
                rowTmp["MANI_TEHAI_CD"] = "1";
                // マニ手配
                rowTmp["MANI_TEHAI_NM"] = "あいうえお";
                // コース組込CD
                rowTmp["COURSE_KK_CD"] = "1";
                // コース組込名称
                rowTmp["COURSE_KK_NM"] = "あい";
                // コース名CD
                rowTmp["COURSE_CD"] = "123456";
                // コース名
                rowTmp["COURSE_NM"] = "あいうえおかきくけこ";
                // 受付備考１
            ...
            if (isPrint)
            {
                for (int i = 0; i < 5; i++)
                {
                    ...
                    // コンテナ項番
                    rowTmp["KONTENA_KBN"] = "12";
                    // コンテナ種類CD
                    rowTmp["KONTENA_TYPE_CD"] = "123";
                    // コンテナ種類名称
                    rowTmp["KONTENA_TYPE_NM"] = "あいうえお";
                    // コンテナCD
                    rowTmp["KONTENA_CD"] = "1234567890";
                    // コンテナ名称
                    rowTmp["KONTENA_NM"] = "あいうえおかきくけこ";
                    // コンテナ状況CD
                    rowTmp["KONTENA_JOKYO_CD"] = "1";
                    // コンテナ状況
                    rowTmp["KONTENA_JOKYO_NM"] = "あい";
                    // 台数
                    rowTmp["DAISU"] = "12";
            ...
            if (isPrint)
            {
                for (int i = 0; i < 5; i++)
                {
                    ...
                    // 品目項番
                    rowTmp["HINMOKU_KBN"] = "12";
                    // 品名CD
                    rowTmp["HINMOKU_CD"] = "123456";
                    // 品名
                    rowTmp["HINMOKU_NM"] = "あいうえおかきくけこ";
                    // 予定数量
                    ...
                    // 明細備考
                    rowTmp["MEISAI_BKO"] = "あいうえおかきくけこさしすせそたちつてと";
        ...
        protected override void CreateDataTableInfo()
        {
            ...
            for (int roopCount = 1; roopCount <= roopMaxCount; roopCount++)
            {
                ...
                if (roopCount == 1)
                {
                    ...
                    ctrlName = string.Format("PHN_PRINT_DATE_VLB");
                    this.dataTable.Columns.Add(ctrlName);
                    // 20151030 katen #12048 「システム日付」の基準作成、適用 end

                    // 配車状況
                    ctrlName = string.Format("DH_HAISHA_JOKYO_CTL");
                    this.dataTable.Columns.Add(ctrlName);
                ...
                {
                    maxPage = (int)Math.Ceiling((decimal)detail1MaxCount / ConstMaxDispDetail1RowCount);
                }
                else
                {
                    maxPage = (int)Math.Ceiling((decimal)detail2MaxCount / ConstMaxDispDetail2RowCount);
                }
                ...
                for (int pageNo = 1; pageNo <= maxPage; pageNo++)
                {
                    ...
                    if (dataTableHeaderTmp.Rows.Count > 0)
                    {
                        ...
                        {
                            // 配車状況
                            index = dataTableHeaderTmp.Columns.IndexOf("HAISHA_JOKYO_NM");
                            ctrlName = string.Format("DH_HAISHA_JOKYO_CTL");
                    ...
                    // 20151030 katen #12048 「システム日付」の基準作成、適用 start
                    row["PHN_PRINT_DATE_VLB"] = this.getDBDateTime().ToString("yyyy/MM/dd H:mm:ss") + "　発行";
                    // 20151030 katen #12048 「システム日付」の基準作成、適用 end
        ...
        private void SetChouhyouInfo()
        {
            ...
            if (dataTableHeaderTmp.Rows.Count > 0)
            {
                ...
                if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                {
                    this.SetFieldName("DH_HAISHA_JOKYO_CTL", (string)dataTableHeaderTmp.Rows[0].ItemArray[index]);
                }
                else
                {
                    this.SetFieldName("DH_HAISHA_JOKYO_CTL", string.Empty);
                }
        ...
        private string GetSqlStringHeader()
        {
            ...
            stringBuilder.Append(tableNameEntry + ".HAISHA_JOKYO_CD AS HAISHA_JOKYO_CD, ");
            stringBuilder.Append(tableNameEntry + ".HAISHA_JOKYO_NAME AS HAISHA_JOKYO_NAME, ");
            ...
            stringBuilder.Append("(CASE WHEN M_GENBA.SHOKUCHI_KBN = 1 THEN (" + tableNameEntry + ".GENBA_NAME) ELSE (M_GENBA.GENBA_NAME1 + M_GENBA.GENBA_NAME2) END) AS GENBA_NAME, ");
            stringBuilder.Append("M_TODOUFUKEN.TODOUFUKEN_NAME AS GENBA_TODOUFUKEN_NAME, ");
            stringBuilder.Append(tableNameEntry + ".GENBA_ADDRESS1 AS GENBA_ADDRESS1, ");
            stringBuilder.Append(tableNameEntry + ".GENBA_ADDRESS2 AS GENBA_ADDRESS2, ");
            ...
            stringBuilder.Append("LEFT JOIN M_TODOUFUKEN ");
            stringBuilder.Append("ON M_GENBA.GENBA_TODOUFUKEN_CD = M_TODOUFUKEN.TODOUFUKEN_CD ");
        ...
        private void GetDatabaseData()
        {
            ...
            // コンテナ状況
            M_CONTENA_JOUKYOU[] contenaJoukyous = DaoInitUtility.GetComponent<r_framework.Dao.IM_CONTENA_JOUKYOUDao>().GetAllData();
            ...
            switch (this.windowID)
            {
                ...
                case WINDOW_ID.R_SAGYOU_SIJISYO:                    // R350 作業指示書
                    ...
                    if (dataTableHeaderTmp.Rows.Count > 0)
                    {
                        ...
                        // 配車状況
                        index = dataTableHeaderTmp.Columns.IndexOf("HAISHA_JOKYO_NAME");
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            rowTmp["HAISHA_JOKYO_NM"] = dataTableHeaderTmp.Rows[0].ItemArray[index];
                        }
                        else
                        {
                            rowTmp["HAISHA_JOKYO_NM"] = string.Empty;
                        }
                        ...
                        index = dataTableHeaderTmp.Columns.IndexOf("GENBA_TODOUFUKEN_NAME");
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                    ...
                    for (int i = 0; i < dataTableDetailTmp.Rows.Count; i++)
                    {
                        ...
                        if (!this.IsDBNull(dataTableDetailTmp.Rows[i].ItemArray[index]))
                        {
                            short contenaJoukyouCd = -1;
                            // コンテナ設置区分≠コンテナ状況 ため変換
                            if (CommonConst.CONTENA_SET_KBN_SECCHI.ToString()
                                .Equals(dataTableDetailTmp.Rows[i].ItemArray[index].ToString()))
                            {
                                contenaJoukyouCd = 2;
                            }
                            else if (CommonConst.CONTENA_SET_KBN_HIKIAGE.ToString()
                                .Equals(dataTableDetailTmp.Rows[i].ItemArray[index].ToString()))
                            {
                                contenaJoukyouCd = 3;
                            }
                            ...
                            {
                                // コンテナ状況CD
                                rowTmp["KONTENA_JOKYO_CD"] = contenaJoukyouCd.ToString();

                                // コンテナ状況名
                                var contenaJoukyou = contenaJoukyous.AsEnumerable().Where(w => (bool)(w.CONTENA_JOUKYOU_CD == contenaJoukyouCd)).ToArray();
                                if (contenaJoukyou.Count() > 0)
                                {
                                    rowTmp["KONTENA_JOKYO_NM"] = contenaJoukyou.First().CONTENA_JOUKYOU_NAME_RYAKU;
                                }
                            }
                        }
                        else
                    ...
                    for (int i = 0; i < dataTableHeaderTmp.Rows.Count; i++)
                    {
                        ...
                        else
                        {
                            ...
                            if (!this.IsDBNull(dataTableHeaderTmp.Rows[i].ItemArray[index]))
                            {
                                rowTmp["YOTEISU"] = Convert.ToDecimal(dataTableHeaderTmp.Rows[i].ItemArray[index]).ToString(format);
                            }
                            else
                            {
                                rowTmp["YOTEISU"] = string.Empty;
                            ...
                            if (!this.IsDBNull(dataTableHeaderTmp.Rows[i].ItemArray[index]))
                            {
                                rowTmp["TANKA"] = Convert.ToDecimal(dataTableHeaderTmp.Rows[i].ItemArray[index]).ToString(format);
                            }
                            else
                            {
                                rowTmp["TANKA"] = string.Empty;
                            ...
                            if (!this.IsDBNull(dataTableHeaderTmp.Rows[i].ItemArray[index]))
                            {
                                rowTmp["KINGAKU"] = Convert.ToDecimal(dataTableHeaderTmp.Rows[i].ItemArray[index]).ToString("#,##0");
                            }
                            else
                            {
                                rowTmp["KINGAKU"] = string.Empty;
                    ...
                    if (dataTableHeaderTmp.Rows.Count > 0)
                    {
                        ...
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            rowTmp["KINGAKU_KEI"] = Convert.ToDecimal(dataTableHeaderTmp.Rows[0].ItemArray[index]).ToString("#,##0");
                        }
                        else
                        {
                        ...
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            rowTmp["SHOHIZEI"] = Convert.ToDecimal(dataTableHeaderTmp.Rows[0].ItemArray[index]).ToString("#,##0");
                        }
                        else
                        {
                            rowTmp["SHOHIZEI"] = 0;
                        ...
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            rowTmp["GOKEI"] = Convert.ToDecimal(dataTableHeaderTmp.Rows[0].ItemArray[index]).ToString("#,##0");
                        }
                        else
                        {
                            rowTmp["GOKEI"] = 0;
