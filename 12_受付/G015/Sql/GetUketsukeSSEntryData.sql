...
FROM	T_UKETSUKE_SS_ENTRY AS T_USSE LEFT OUTER JOIN
		M_COURSE_NAME ON T_USSE.COURSE_NAME_CD = M_COURSE_NAME.COURSE_NAME_CD AND M_COURSE_NAME.DELETE_FLG = 0 LEFT OUTER JOIN
		M_CONTENA_JOUKYOU ON T_USSE.CONTENA_SOUSA_CD = M_CONTENA_JOUKYOU.CONTENA_JOUKYOU_CD AND M_CONTENA_JOUKYOU.DELETE_FLG = 0 LEFT OUTER JOIN
