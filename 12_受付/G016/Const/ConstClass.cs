...
namespace Shougun.Core.Reception.UketsukeSyukkaNyuuryoku
{
    ...
    public class ConstClass
    {
        ...
        /// ボタン設定ファイル
        /// </summary>
        public const string BUTTON_SETTING_XML = "Shougun.Core.Reception.UketsukeSyukkaNyuuryoku.Setting.ButtonSetting.xml";
        ...
        /// 伝票種類「2.出荷」
        /// </summary>
        public static readonly string DENPYOU_SHURUI_SK = "2";
