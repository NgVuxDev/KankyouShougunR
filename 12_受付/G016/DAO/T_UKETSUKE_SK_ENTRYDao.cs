...
namespace Shougun.Core.Reception.UketsukeSyukkaNyuuryoku
{
    ...
    public interface T_UKETSUKE_SK_ENTRYDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyukkaNyuuryoku.Sql.GetListUketsukeSKEntryData.sql")]
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyukkaNyuuryoku.Sql.GetHinmei3MonthData.sql")]
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Reception.UketsukeSyukkaNyuuryoku.Sql.GetSharyou3MonthData.sql")]
        ...
        [Sql("SELECT ISNULL(MAX(SEQ),1) FROM T_UKETSUKE_SK_ENTRY WHERE UKETSUKE_NUMBER = /*uketsukeNumber*/")]
        ...
        [SqlFile("Shougun.Core.Reception.UketsukeSyukkaNyuuryoku.Sql.GetSmsJokyoData.sql")]
