...
OR (SAGYOU_DATE IS NULL AND SAGYOU_DATE_BEGIN <= /*data.SagyouDate*/ AND SAGYOU_DATE_END >= /*data.SagyouDate*/))
...
ON TK.KYOTEN_CD = GTKN.KYOTEN_CD

ORDER BY HAISHA_FLG, DENPYOU_SEQ , DENSHU_TYPE, DENPYOU_NUM_