...
namespace Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku
{
    ...
    public interface IT_TEIKI_HAISHA_ENTRYDao : IS2Dao
    {
        ...
        [SqlFile("Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku.Sql.GetAllValidDataByHaishaNumber.sql")]
        ...
        /// <parameparam name="data">Entity</parameparam>
        /// <returns>取得したデータのリスト</returns>
        [SqlFile("Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku.Sql.GetAllValidData.sql")]
        ...
        [SqlFile("Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku.Sql.GetDetailForMiTourokuHaisha.sql")]
        DataTable GetDataToMRDataTable(DTOCls data);
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku.Sql.GetMobilNioroshiData.sql")]
        ...
        /// <param name="NIOROSHI_NUMBER">NIOROSHI_NUMBER</param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku.Sql.GetTeikiHaishaNioroshiData.sql")]
