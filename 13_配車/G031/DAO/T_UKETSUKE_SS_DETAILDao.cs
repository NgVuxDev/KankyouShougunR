// $Id: T_UKETSUKE_SS_DETAILDao.cs 9436 2013-12-04 00:50:08Z sys_dev_23 $
using System;
...
namespace Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku
{
    ...
    public interface T_UKETSUKE_SS_DETAILDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku.Sql.GetUketsukeSSDetailData.sql")]
        ...
        [SqlFile("Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku.Sql.GetUketsukeSSDetailDataBySystemID.sql")]
