// $Id: T_UKETSUKE_SS_ENTRYDao.cs 36292 2014-12-02 02:43:29Z fangjk@oec-h.com $
using System;
...
namespace Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku
{
    ...
    public interface T_UKETSUKE_SS_ENTRYDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CourseHaishaIraiNyuuryoku.Sql.GetUketsukeSSEntryData.sql")]
