// $Id: DataGridViewProgressBarColumn.cs 24040 2014-06-26 05:06:18Z d-sato $
using System;
...
namespace Shougun.Core.Allocation.ContenaIchiran
{
    ...
    public class DataGridViewProgressBarCell : DataGridViewTextBoxCell
    {
            ...
            DataGridViewPaintParts paintParts)
        {
            ...
            //割合を計算する
            decimal rate = (decimal)(intValue - this.mimimumValue) /
                ...
                DataGridViewPaintParts.ContentForeground)
            {
                if (ProgressBarRenderer.IsSupported)
                {
                    ...
                    barBounds.Width = (int)Math.Round(barBounds.Width * rate, 0, MidpointRounding.AwayFromZero);
                ...
                else
                {
                    ...
                    barBounds.Width = (int)Math.Round(barBounds.Width * rate, 0, MidpointRounding.AwayFromZero);
                    graphics.FillRectangle(Brushes.Lime, barBounds);
                }
            }
            ...
            {
                //表示するテキストを決定
                //string txt = string.Format("{0}%", Math.Round(rate * 100, 0, MidpointRounding.AwayFromZero));
                string txt = string.Format("{0}%", Math.Round(Convert.ToDecimal(value), 0, MidpointRounding.AwayFromZero));
