// $Id: IT_TEIKI_HAISHA_NIOROSHIDao.cs 5893 2013-11-05 00:21:12Z sys_dev_20 $
using System;
...
namespace Shougun.Core.Allocation.TeikiHaishaIkkatsuSakusei
{
    ...
    public interface IT_TEIKI_HAISHA_NIOROSHIDao : IS2Dao
    {
        ...
        /// <summary>
        /// 定期配車番号をもとに定期配車荷卸のデータを取得する
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.TeikiHaishaIkkatsuSakusei.Sql.GetNioroshiData.sql")]
