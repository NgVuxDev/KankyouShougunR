...
namespace Shougun.Core.Allocation.Sharyoukyuudounyuryoku
{
    ...
    /// G208 車輌休動入力
    /// </summary>
    class G208 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// フォーム作成
        /// </summary>
        ...
        public Form CreateForm(params object[] args)
        {
            ...
            var callForm = new Shougun.Core.Allocation.Sharyoukyuudounyuryoku.UIForm();
            var callHeader = new Shougun.Core.Allocation.Sharyoukyuudounyuryoku.UIHeader();
