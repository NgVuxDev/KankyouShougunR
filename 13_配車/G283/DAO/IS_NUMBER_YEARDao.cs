...
namespace Shougun.Core.Allocation.MobileShougunTorikomi.DAO
{
    ...
    public interface IS_NUMBER_YEARDao : IS2Dao
    {
        ...
        /// <returns></returns>
        [Sql("SELECT S_NUMBER_YEAR.CURRENT_NUMBER, TIME_STAMP FROM dbo.S_NUMBER_YEAR /*$whereSql*/")]
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.MobileShougunTorikomi.Sql.IS_NUMBER_YEARDao_GetDataForEntity.sql")]
