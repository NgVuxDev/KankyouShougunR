...
T_TEIKI_JISSEKI_DETAIL.SUURYOU AS SUURYOU,
...
/*IF data.DENPYOU_DATE_FROM != null*/AND T_TEIKI_JISSEKI_ENTRY.SAGYOU_DATE >= CONVERT(varchar,/*data.DENPYOU_DATE_FROM*/,111)/*END*/
/*IF data.dtp_KikanTO != null*/AND T_TEIKI_JISSEKI_ENTRY.SAGYOU_DATE <= CONVERT(varchar,/*data.dtp_KikanTO*/,111)/*END*/
