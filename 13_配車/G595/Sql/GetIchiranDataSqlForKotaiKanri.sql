...
T_CONTENA_RESULT.CONTENA_CD AS CONTENA_CD,
M_CONTENA.CONTENA_NAME_RYAKU AS CONTENA_NAME_RYAKU,
...
LEFT JOIN M_CONTENA
	ON M_CONTENA.CONTENA_SHURUI_CD = T_CONTENA_RESULT.CONTENA_SHURUI_CD
	AND M_CONTENA.CONTENA_CD = T_CONTENA_RESULT.CONTENA_CD
...
AND (T_CONTENA_RESULT.CONTENA_CD IS NOT NULL AND T_CONTENA_RESULT.CONTENA_CD <> '')
...
/*END*/
/*IF data.contenaFrom != null*/
	AND T_CONTENA_RESULT.CONTENA_CD >= /*data.contenaFrom*/
/*END*/
/*IF data.contenaTo != null*/
	AND T_CONTENA_RESULT.CONTENA_CD <= /*data.contenaTo*/
/*END*/
...
M_CONTENA_SHURUI.CONTENA_SHURUI_NAME_RYAKU AS CONTENA_SHURUI_NAME_RYAKU,
T_CONTENA_RESERVE.CONTENA_CD AS CONTENA_CD,
M_CONTENA.CONTENA_NAME_RYAKU AS CONTENA_NAME_RYAKU,
...
LEFT JOIN M_CONTENA
	ON M_CONTENA.CONTENA_SHURUI_CD = T_CONTENA_RESERVE.CONTENA_SHURUI_CD
	AND M_CONTENA.CONTENA_CD = T_CONTENA_RESERVE.CONTENA_CD
...
AND (T_CONTENA_RESERVE.CONTENA_CD IS NOT NULL AND T_CONTENA_RESERVE.CONTENA_CD <> '')
...
/*END*/
/*IF data.contenaFrom != null*/
	AND T_CONTENA_RESERVE.CONTENA_CD >= /*data.contenaFrom*/
/*END*/
/*IF data.contenaTo != null*/
	AND T_CONTENA_RESERVE.CONTENA_CD <= /*data.contenaTo*/
/*END*/
)