...
COALESCE(SUM(T_TEIKI_JISSEKI_DETAIL.SUURYOU),0) AS Expr1,
...
/*IF data.BumonCD != null*/AND T_TEIKI_JISSEKI_ENTRY.BUMON_CD = /*data.BumonCD*//*END*/
...
COALESCE(SUM(T_TEIKI_JISSEKI_DETAIL.KANSAN_SUURYOU),0) AS Expr1,
M_GENBA.GENBA_NAME1 + '　' + M_GENBA.GENBA_NAME2 AS GENBA_NAME,
M_GYOUSHA.GYOUSHA_NAME1 + '　' + M_GYOUSHA.GYOUSHA_NAME2 AS GYOUSHA_NAME
...
M_UNIT.UNIT_NAME_RYAKU,
T_TEIKI_JISSEKI_DETAIL.HINMEI_CD,
T_TEIKI_JISSEKI_DETAIL.KANSAN_UNIT_CD,
T_TEIKI_JISSEKI_DETAIL.TSUKIGIME_KBN,
M_GENBA.GENBA_NAME1,
M_GYOUSHA.GYOUSHA_NAME1,
M_GENBA.GENBA_NAME2,
...
COALESCE(SUM(T_TEIKI_JISSEKI_DETAIL.ANBUN_SUURYOU),0) AS Expr1,
M_GENBA.GENBA_NAME1 + '　' + M_GENBA.GENBA_NAME2 AS GENBA_NAME,
M_GYOUSHA.GYOUSHA_NAME1 + '　' + M_GYOUSHA.GYOUSHA_NAME2 AS GYOUSHA_NAME
...
T_TEIKI_JISSEKI_ENTRY.SYSTEM_ID = T_TEIKI_JISSEKI_DETAIL.SYSTEM_ID AND 
T_TEIKI_JISSEKI_ENTRY.SEQ = T_TEIKI_JISSEKI_DETAIL.SEQ 
INNER JOIN M_UNIT ON T_TEIKI_JISSEKI_DETAIL.UNIT_CD_KG = M_UNIT.UNIT_CD
INNER JOIN M_HINMEI ON 
T_TEIKI_JISSEKI_DETAIL.HINMEI_CD = M_HINMEI.HINMEI_CD
LEFT JOIN M_GENBA ON 
T_TEIKI_JISSEKI_DETAIL.GENBA_CD = M_GENBA.GENBA_CD AND 
...
M_UNIT.UNIT_NAME_RYAKU,
T_TEIKI_JISSEKI_DETAIL.HINMEI_CD,
T_TEIKI_JISSEKI_DETAIL.UNIT_CD_KG,
T_TEIKI_JISSEKI_DETAIL.TSUKIGIME_KBN,
M_GENBA.GENBA_NAME1,
M_GYOUSHA.GYOUSHA_NAME1,
M_GENBA.GENBA_NAME2,
