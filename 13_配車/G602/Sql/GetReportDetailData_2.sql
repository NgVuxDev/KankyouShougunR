SELECT
	 TJ.*
	,GYOUSHA_D.GYOUSHA_NAME1 AS DETAIL_GYOUSHA_NAME1
	,GYOUSHA_D.GYOUSHA_NAME2 AS DETAIL_GYOUSHA_NAME2
	,GENBA_D.GENBA_NAME1 AS DETAIL_GENBA_NAME1
	,GENBA_D.GENBA_NAME2 AS DETAIL_GENBA_NAME2
	...
	,ISNULL(GENBA_D.SHIKUCHOUSON_CD,'')     AS SHIKUCHOUSON_CD
 ...
 LEFT JOIN
	M_GYOUSHA AS GYOUSHA_D ON TJ.GYOUSHA_CD = GYOUSHA_D.GYOUSHA_CD
 LEFT JOIN
	M_GENBA AS GENBA_D ON TJ.GENBA_CD = GENBA_D.GENBA_CD AND TJ.GYOUSHA_CD = GENBA_D.GYOUSHA_CD
 LEFT JOIN
 ...
 LEFT JOIN
	M_SHIKUCHOUSON AS SHIKUCHOUSON ON GENBA_D.SHIKUCHOUSON_CD = SHIKUCHOUSON.SHIKUCHOUSON_CD
 LEFT JOIN
