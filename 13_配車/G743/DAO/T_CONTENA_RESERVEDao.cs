...
namespace Shougun.Core.Allocation.CarTransferSpot
{
    ...
    public interface T_CONTENA_RESERVEDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CarTransferSpot.Sql.GetContenaReserveData.sql")]
        T_CONTENA_RESERVE[] GetDataForEntity(T_CONTENA_RESERVE data);
        ...
        /// <summary>
        /// モバイル連携）収集受付コンテナデータを取得
        /// </summary>
        /// <param name="SYSTEM_ID">SYSTEM_ID</param>
        /// <param name="SEQ">SEQ</param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CarTransferSpot.Sql.GetSyuusyuuUketukeContenaData.sql")]
