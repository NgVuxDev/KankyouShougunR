...
namespace Shougun.Core.Allocation.CarTransferSpot
{
    ...
    public interface T_UKETSUKE_SK_DETAILDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CarTransferSpot.Sql.GetUketsukeSKDetailData.sql")]
        ...
        //SqlInt64 getMaxSystemId(string whereSql)C:\00_R版\mobile_ph3\13_配車\G743\DAO\T_UKETSUKE_SK_DETAILDao.cs;
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CarTransferSpot.Sql.GetShukkaUketukeDetailData.sql")]
