...
namespace Shougun.Core.Allocation.CarTransferSpot
{
    ...
    public interface T_UKETSUKE_SS_ENTRYDao : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CarTransferSpot.Sql.GetAllDataSql.sql")]
        new DataTable GetAllUketsukeData(DTOClass data);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CarTransferSpot.Sql.GetUketsukeSSEntryData.sql")]
        ...
        ///// <param name="data">検索条件</param>
        ///// <returns>DataTable</returns>
        //[SqlFile("Shougun.Core.Allocation.CarTransferSpot.Sql.GetDetailForMiTourokuUketuke.sql")]
