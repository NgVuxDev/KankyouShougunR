...
namespace Shougun.Core.Allocation.CarTransferTeiki
{
    ...
    public interface IT_TEIKI_HAISHA_SHOUSAIDao : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CarTransferTeiki.Sql.GetShousaiData.sql")]
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CarTransferTeiki.Sql.GetTeikiHaishaShousaiData.sql")]
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Allocation.CarTransferTeiki.Sql.GetNData.sql")]
        new DataTable GetNioroshiData(T_TEIKI_HAISHA_SHOUSAI data);
    }
}
