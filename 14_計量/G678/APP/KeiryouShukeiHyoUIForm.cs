...
namespace Shougun.Core.Scale.KeiryouShukeiHyo
{
    ...
    /// 計量集計表画面クラス
    /// </summary>
    public partial class KeiryouShukeiHyoUIForm : SuperForm
    {
        /// <summary>
        /// 計量集計表ロジッククラス
        /// </summary>
        private KeiryouShukeiHyoLogic logic;

        /// <summary>
        /// 計量集計表DTOを取得・設定します
        /// </summary>
        internal KeiryouShukeiHyoDto FormDataDto { get; set; }
        ...
        /// コンストラクタ
        /// </summary>
        public KeiryouShukeiHyoUIForm()
        {
            LogUtility.DebugMethodStart();

            this.InitializeComponent();

            this.WindowId = WINDOW_ID.T_KEIRYOU_SHUUKEIHYOU;

            this.logic = new KeiryouShukeiHyoLogic(this);
        ...
        private bool SetDefault()
        {
            try
            {
                this.DENPYOU_KBN.Text = KeiryouShukeiHyoConst.DENPYOU_KBN;
                this.DATE_SHURUI.Text = KeiryouShukeiHyoConst.DATE_SHURUI_CD_DENPYOU;
                this.DATE_RANGE.Text = KeiryouShukeiHyoConst.DATE_RANGE_CD_TOUJITSU;
                this.KIHON_KEIRYOU.Text = KeiryouShukeiHyoConst.KIHON_KEIRYOU_CD_SUBETE;
                this.KYOTEN_CD.Text = KeiryouShukeiHyoConst.KYOTEN_CD_ZENSHA;
                this.KYOTEN_NAME.Text = KeiryouShukeiHyoConst.KYOTEN_NAME_99;
                this.URIAGE_TORIHIKI_KBN.Text = KeiryouShukeiHyoConst.TORIHIKI_KBN_CD_SUBETE;
                this.SHIHARAI_TORIHIKI_KBN.Text = KeiryouShukeiHyoConst.TORIHIKI_KBN_CD_SUBETE;
            }
            catch (Exception ex)
            {
        ...
        private bool SetDtoData()
        {
            try
            {
                ...
                this.FormDataDto = new KeiryouShukeiHyoDto();

                this.FormDataDto.Pattern = this.PATTERN_LIST_BOX.GetSelectedPatternDto();

                this.FormDataDto.KihonKeiryou = 0;
                if (this.KIHON_KEIRYOU_1.Checked)
                {
                    this.FormDataDto.KihonKeiryou = 1;
                }
                else if (this.KIHON_KEIRYOU_2.Checked)
                {
                    this.FormDataDto.KihonKeiryou = 2;
                }

                this.FormDataDto.DenpyouKbn = Int32.Parse(this.DENPYOU_KBN.Text);
                if (this.DENPYOU_KBN_1.Checked)
                {
                    this.FormDataDto.DenpyouKbnName = KeiryouShukeiHyoConst.DENPYOU_KBN_1;
                }
                else if (this.DENPYOU_KBN_2.Checked)
                {
                    this.FormDataDto.DenpyouKbnName = KeiryouShukeiHyoConst.DENPYOU_KBN_2;
                }

                this.FormDataDto.DateShurui = Int32.Parse(this.DATE_SHURUI.Text);
                if (this.DATE_SHURUI_1.Checked)
                {
                    this.FormDataDto.DateShuruiName = KeiryouShukeiHyoConst.DATE_SHURUI_1;
                }
                else if (this.DATE_SHURUI_2.Checked)
                {
                    this.FormDataDto.DateShuruiName = KeiryouShukeiHyoConst.DATE_SHURUI_2;
                }
                if (this.DATE_RANGE.Text == KeiryouShukeiHyoConst.DATE_RANGE_CD_TOUJITSU)
                {
                    this.FormDataDto.DateFrom = this.logic.parentForm.sysDate.Date;
                    this.FormDataDto.DateTo = this.logic.parentForm.sysDate.Date;
                }
                else if (this.DATE_RANGE.Text == KeiryouShukeiHyoConst.DATE_RANGE_CD_TOUGETSU)
                {
                ...
                this.FormDataDto.DenpyouShurui = Int32.Parse(this.KIHON_KEIRYOU.Text);
                if (this.KIHON_KEIRYOU_1.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = KeiryouShukeiHyoConst.DENPYOU_SHURUI_1;
                }
                else if (this.KIHON_KEIRYOU_2.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = KeiryouShukeiHyoConst.DENPYOU_SHURUI_2;
                }
                else if (this.KIHON_KEIRYOU_3.Checked)
                {
                    this.FormDataDto.DenpyouShuruiName = KeiryouShukeiHyoConst.DENPYOU_SHURUI_3;
                }
                if (String.IsNullOrEmpty(this.KYOTEN_CD.Text) == false)
                {
                    this.FormDataDto.KyotenCd = this.KYOTEN_CD.Text;
                }
                ...
                if (!string.IsNullOrEmpty(this.URIAGE_TORIHIKI_KBN.Text))
                {
                    this.FormDataDto.UriageTorihikiKbn = Int32.Parse(this.URIAGE_TORIHIKI_KBN.Text);
                }
                if (this.URIAGE_TORIHIKI_KBN_1.Checked)
                {
                    this.FormDataDto.UriageTorihikiKbnName = KeiryouShukeiHyoConst.TORIHIKI_KBN_1;
                }
                else if (this.URIAGE_TORIHIKI_KBN_2.Checked)
                {
                    this.FormDataDto.UriageTorihikiKbnName = KeiryouShukeiHyoConst.TORIHIKI_KBN_2;
                }
                else if (this.URIAGE_TORIHIKI_KBN_3.Checked)
                {
                    this.FormDataDto.UriageTorihikiKbnName = KeiryouShukeiHyoConst.TORIHIKI_KBN_3;
                }
                if (!string.IsNullOrEmpty(this.SHIHARAI_TORIHIKI_KBN.Text))
                {
                    this.FormDataDto.ShiharaiTorihikiKbn = Int32.Parse(this.SHIHARAI_TORIHIKI_KBN.Text);
                }
                if (this.SHIHARAI_TORIHIKI_KBN_1.Checked)
                {
                    this.FormDataDto.ShiharaiTorihikiKbnName = KeiryouShukeiHyoConst.TORIHIKI_KBN_1;
                }
                else if (this.SHIHARAI_TORIHIKI_KBN_2.Checked)
                {
                    this.FormDataDto.ShiharaiTorihikiKbnName = KeiryouShukeiHyoConst.TORIHIKI_KBN_2;
                }
                else if (this.SHIHARAI_TORIHIKI_KBN_3.Checked)
                {
                    this.FormDataDto.ShiharaiTorihikiKbnName = KeiryouShukeiHyoConst.TORIHIKI_KBN_3;
                }
            }
            catch (Exception ex)
            {
        ...
        private void DATE_RANGE_TextChanged(object sender, EventArgs e)
        {
            ...
            if (this.DATE_RANGE.Text == KeiryouShukeiHyoConst.DATE_RANGE_CD_SHITEI)
            {
