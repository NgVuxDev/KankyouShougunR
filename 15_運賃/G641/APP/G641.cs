...
{
    class G641 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// フォーム作成
        /// </summary>
        ...
        public Form CreateForm(params object[] args)
        {
            ...
            //社員コード、伝種区分を共通画面に渡す
            var HeaderForm = new Shougun.Core.Carriage.Unchinichiran.HeaderForm();
            var callForm = new Shougun.Core.Carriage.Unchinichiran.UnchinichiranForm((DENSHU_KBN)iDensyuKbn, searchString, HeaderForm, sSyainid);
