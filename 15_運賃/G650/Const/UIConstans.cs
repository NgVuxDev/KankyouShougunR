...
namespace Shougun.Core.Carriage.UnchinDaichou.Const
{
    /// <summary>
    /// 定数クラス
    /// </summary>
    public static class UIConstans
    {
        ...
        /// Button設定用XMLファイルパス
        /// </summary>
        internal static readonly string ButtonInfoXmlPath = "Shougun.Core.Carriage.UnchinDaichou.Setting.ButtonSetting.xml";
        /// <summary>
        /// Report設定用XMLファイルパス
        /// </summary>
        internal static readonly string OutputFormFullPathName = "./Template/R651-Form.xml";
    }
}
