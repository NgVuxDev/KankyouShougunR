// $Id: M_ZaikoHiritsuDao.cs 11341 2013-12-16 12:04:22Z sys_dev_18 $
...
namespace Shougun.Core.Stock.ZaikoMeisaiNyuuryoku.DAO
{
    ...
    public interface M_ZaikoHiritsuDao : IS2Dao
    {
        /// <summary>
        /// Insert
        /// </summary>
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.Stock.ZaikoMeisaiNyuuryoku.Sql.M_ZaikoHiritsuSql.sql")]
        new DataTable GetDataForEntity(M_ZAIKO_HIRITSU data);
