...
namespace Shougun.Core.Stock.ZaikoIdou
{
    ...
    public partial class UIForm : SuperForm
    {
        ...
        /// </summary>
        internal string idouNumber { get; set; }
        #endregion
        ...
        public UIForm(UIHeader headerForm, WINDOW_TYPE windowType, string idouNum)
            : base(WINDOW_ID.T_ZAIKO_IDOU_NYUURYOKU, windowType)
        {
            this.InitializeComponent();

            this.headerForm = headerForm;
            this.idouNumber = idouNum;
        ...
        public void bt_func7_Click(object sender, EventArgs e)
        {
            ...
            FormManager.OpenFormWithAuth("G632", WINDOW_TYPE.REFERENCE_WINDOW_FLAG);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                this.DETAIL_Ichiran.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            }
        ...
        /// <summary>
        /// 移動番号のValidated実行時に処理します
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void IDOU_NUMBER_Validated(object sender, EventArgs e)
        {
            this.logic.IDOU_NUMBER_Validated();
        }
        ...
        private void DETAIL_Ichiran_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                case "MEISAI_GENBA_CD":
                    if (!this.IsInputErrorOccured && !this.isError)
                    {
                        // 現場CDが入力エラーで無い場合、現在の入力値を変更前現場CDとする
                        this.beforeGenbaCd = Convert.ToString(cell.Value);
                        this.beforeGenbaName = Convert.ToString(this.DETAIL_Ichiran.Rows[e.RowIndex].Cells["MEISAI_GENBA_NAME"].Value);
                    }

                    this.DETAIL_Ichiran.ImeMode = System.Windows.Forms.ImeMode.Disable;
                    break;
                case "MEISAI_IDOU_RYOU":
                    this.DETAIL_Ichiran.ImeMode = System.Windows.Forms.ImeMode.Disable;
                    break;
