...
namespace Shougun.Core.Stock.ZaikoKanriHyo
{
    ...
    public partial class UIForm : SuperForm
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (this.zaikoKanriHyo1 != null)
            {
                this.zaikoKanriHyo1.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            }
            if (this.zaikoKanriHyo2 != null)
            {
                this.zaikoKanriHyo2.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            }
        }
