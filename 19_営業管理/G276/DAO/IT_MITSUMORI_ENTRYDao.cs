...
namespace Shougun.Core.BusinessManagement.MitsumoriNyuryoku.DAO
{
    ...
    public interface IT_MITSUMORI_ENTRYDao : IS2Dao
    {
        ...
        /// <returns></returns>
        [Transaction]
        int Delete(T_MITSUMORI_ENTRY data);
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.BusinessManagement.MitsumoriNyuryoku.Sql.IT_MITSUMORI_ENTRYDao_GetDataForEntity.sql")]
        T_MITSUMORI_ENTRY[] GetDataForEntity(T_MITSUMORI_ENTRY data);
        ...
        /// <summary>
        /// T_MITSUMORI_ENTRY.SYSTEM_IDの最高値を取得する
        /// </summary>
        /// <param name="whereSql">絞り込み条件</param>
        /// <returns>SYSTEM_IDのMAX値</returns>
        [Sql("select ISNULL(MAX(SYSTEM_ID),1) FROM T_MITSUMORI_ENTRY /*$whereSql*/")]
