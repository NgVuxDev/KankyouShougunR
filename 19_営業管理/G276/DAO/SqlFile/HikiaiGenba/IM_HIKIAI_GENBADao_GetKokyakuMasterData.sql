...
FROM M_HIKIAI_GYOUSHA AS sha 
	INNER JOIN M_HIKIAI_GENBA AS ba ON sha.GYOUSHA_CD = ba.GENBA_CD 
	LEFT OUTER JOIN M_HIKIAI_TORIHIKISAKI AS shaTorihiki ON sha.TORIHIKISAKI_CD = shaTorihiki.TORIHIKISAKI_CD 
	LEFT OUTER JOIN M_HIKIAI_TORIHIKISAKI AS baTorihiki ON ba.TORIHIKISAKI_CD = baTorihiki.TORIHIKISAKI_CD 
