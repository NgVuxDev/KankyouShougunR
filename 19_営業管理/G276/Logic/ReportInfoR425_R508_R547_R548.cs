...
namespace Shougun.Core.BusinessManagement.MitsumoriNyuryoku
{
    ...
    public class ReportInfoR425_R508_R547_R548 : ReportInfoBase
    {
        ...
        private const int ConstMaxDispDetailVRowCount = 15; //17          // 金額見積もり縦のDetail1の最大表示行数
        private const int ConstMaxDispTankaDetailHRowCount = 11;      // 単価見積もり横のDetail1の最大表示行数
        private const int ConstMaxDispTankaDetailVRowCount = 17; //19     // 単価見積もり縦のDetail1の最大表示行数
        ...
        public void CreateSampleData()
        {
            ...
            for (int pageNo = 1; pageNo <= 1; pageNo++)
            {
                ...
                {
                    case OutputTypeDef.KingakuMitsumoriV:   // 金額見積り（縦）4
                        ...
                        //20250417
                        dataTableTmp.Columns.Add("KENMEI_2");
                        ...
                        //20250416
                        // 見積項目名称4
                        dataTableTmp.Columns.Add("MITSUMORI_KOUMOKU5");
                        // 見積項目4
                        dataTableTmp.Columns.Add("MITSUMORI_5");
                        ...
                        if (isPrintH)
                        {
                            ...
                            //20250416
                            rowTmp["KENMEI_2"] = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほ";
                            ...
                            //20250416
                            // 見積項目名称5
                            rowTmp["MITSUMORI_KOUMOKU5"] = "あいうえおかきくけこさしすせそ";
                            // 見積項目5
                            rowTmp["MITSUMORI_5"] = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほ";
                    ...
                    case OutputTypeDef.KingakuMitsumoriH:   // 金額見積り（横）
                        ...
                        break;
                    case OutputTypeDef.TankaMitsumoriV:     // 単価見積り（縦）2
                        ...
                        if (isPrintH)
                        {
                            ...
                            //20250417
                            rowTmp["KENMEI_2"] = "あいうえおかきくけこさしすせそたちつてとなにぬねの";
                            ...
                            rowTmp["MITSUMORI_KOUMOKU5"] = "あいうえおかきくけこさしすせそ";
                            // 見積項目5
                            rowTmp["MITSUMORI_5"] = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめも";
                        ...
                        for (i = detailStart; i < maxRow; i++)
                        {
                            ...
                            if (!detailComp)
                            {
                                ...
                                if (!this.IsDBNull(dataTableTmp.Rows[i].ItemArray[index]))
                                {
                                    ...
                                    {
                                        row[ctrlName] = encoding.GetString(byteArray, 0, 60);
                                    }
                                    else
                                    {
                                        row[ctrlName] = dataTableTmp.Rows[i].ItemArray[index];
                ...
                case OutputTypeDef.KingakuMitsumoriV:       // 金額見積り（縦）
                    ...
                    if (dataTableHeaderTmp.Rows.Count > 0)
                    {
                        ...
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            ...
                            {
                                this.SetFieldName("PHY_KENMEI_VLB", encoding.GetString(byteArray, 0, 36));
                            }
                            else
                            {
                        ...
                        //20250417
                        index = dataTableHeaderTmp.Columns.IndexOf("KENMEI_2");
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            byteArray = encoding.GetBytes(dataTableHeaderTmp.Rows[0].ItemArray[index].ToString());
                            if (byteArray.Length > 34)
                            {
                                this.SetFieldName("PHY_KENMEI_VLB1", encoding.GetString(byteArray, 0, 34));
                            }
                            else
                            {
                                this.SetFieldName("PHY_KENMEI_VLB1", (string)dataTableHeaderTmp.Rows[0].ItemArray[index]);
                            }
                        }
                        else
                        {   // NULL
                            this.SetFieldName("PHY_KENMEI_VLB1", string.Empty);
                        }
                        ...
                        {
                            byteArray = encoding.GetBytes(dataTableHeaderTmp.Rows[0].ItemArray[index].ToString());
                            if (byteArray.Length > 70)
                            {
                                this.SetFieldName("PHY_MITSUMORI_1_VLB", encoding.GetString(byteArray, 0, 70));
                            }
                            else
                            {
                        ...
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            ...
                            if (byteArray.Length > 70)
                            {
                                this.SetFieldName("PHY_MITSUMORI_2_VLB", encoding.GetString(byteArray, 0, 70));
                            }
                            else
                            {
                        ...
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            ...
                            if (byteArray.Length > 70)
                            {
                                this.SetFieldName("PHY_MITSUMORI_3_VLB", encoding.GetString(byteArray, 0, 70));
                            }
                            else
                            {
                        ...
                        //20250417
                        // 見積項目名称5
                        index = dataTableHeaderTmp.Columns.IndexOf("MITSUMORI_KOUMOKU5");
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            byteArray = encoding.GetBytes(dataTableHeaderTmp.Rows[0].ItemArray[index].ToString());
                            if (byteArray.Length > 12)
                            {
                                this.SetFieldName("PHY_MITSUMORI_KOUMOKU5_VLB", encoding.GetString(byteArray, 0, 12));
                            }
                            else
                            {
                                this.SetFieldName("PHY_MITSUMORI_KOUMOKU5_VLB", (string)dataTableHeaderTmp.Rows[0].ItemArray[index]);
                            }
                        }
                        else
                        {   // NULL
                            this.SetFieldName("PHY_MITSUMORI_KOUMOKU5_VLB", string.Empty);
                        }

                        // 見積項目5
                        index = dataTableHeaderTmp.Columns.IndexOf("MITSUMORI_5");
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            byteArray = encoding.GetBytes(dataTableHeaderTmp.Rows[0].ItemArray[index].ToString());
                            if (byteArray.Length > 70)
                            {
                                this.SetFieldName("PHY_MITSUMORI_5_VLB", encoding.GetString(byteArray, 0, 70));
                            }
                            else
                            {
                                this.SetFieldName("PHY_MITSUMORI_5_VLB", (string)dataTableHeaderTmp.Rows[0].ItemArray[index]);
                            }
                        }
                        else
                        {   // NULL
                            this.SetFieldName("PHY_MITSUMORI_5_VLB", string.Empty);
                        }
                ...
                case OutputTypeDef.TankaMitsumoriV:         // 単価見積り（縦）
                    ...
                    if (dataTableHeaderTmp.Rows.Count > 0)
                    {
                        ...
                        if (!this.IsDBNull(dataTableHeaderTmp.Rows[0].ItemArray[index]))
                        {
                            ...
                            if (byteArray.Length > 70)
                            {
                                this.SetFieldName("PHY_MITSUMORI_4_VLB", encoding.GetString(byteArray, 0, 70));
                            }
                            else
                            {
                                this.SetFieldName("PHY_MITSUMORI_4_VLB", (string)dataTableHeaderTmp.Rows[0].ItemArray[index]);
