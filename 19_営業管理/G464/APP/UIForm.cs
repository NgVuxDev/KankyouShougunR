...
namespace Shougun.Core.BusinessManagement.JuchuuMokuhyouKensuuNyuuryoku
{
    ...
    /// </summary>
    [Implementation]
    public partial class JuchuuMokuhyouForm : SuperForm
    {
        #region 内部変数
        /// <summary>
        /// ヘッダコントロール
        ...
        /// 画面ロジック
        /// </summary>
        private JuchuuMokuhyouLogic logic;
        ...
        public JuchuuMokuhyouForm(HeaderForm headerForm)
            : base(WINDOW_ID.T_JYUCYUU_MOKUHYUO_KENSUU_NYUURYOKU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            this.InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new JuchuuMokuhyouLogic(this);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                int GRID_HEIGHT_MIN_VALUE = 359;
                int GRID_WIDTH_MIN_VALUE = 597;
                int h = this.Height - 82;
                int w = this.Width;
