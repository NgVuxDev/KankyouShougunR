...
namespace Shougun.Core.BusinessManagement.DenpyouIkkatuUpdate.DTO
{
    ...
    public class CsvUtility
    {
        ...
        public CsvUtility(GcCustomMultiRow mr, SuperForm form = null, string fileName = "",
            ...
            : this(form ?? (SuperForm)mr.FindForm(), fileName, customColumns, customFormats, customHeaders, outputHeader, useOriginalHeaderPriority, encoding ?? new UTF8Encoding(true))
        {
            this.source = mr;
        }
        ...
        public CsvUtility(CustomDataGridView dgv, SuperForm form = null, string fileName = "",
            CsvColumns customColumns = null, CsvFormats customFormats = null, CsvHeaders customHeaders = null, bool outputHeader = true, bool useOriginalHeaderPriority = false,
            Encoding encoding = null)
            : this(form ?? (SuperForm)dgv.FindForm(), fileName, customColumns, customFormats, customHeaders, outputHeader, useOriginalHeaderPriority, encoding ?? new UTF8Encoding(true))
        {
            this.source = dgv;
        }
        ...
        public CsvUtility(DataTable dt, SuperForm form, string fileName = "",
            ...
            Encoding encoding = null)
            : this(form, fileName, customColumns, customFormats, customHeaders, outputHeader, true, encoding ?? new UTF8Encoding(true))
        {
            this.source = dt;
        }
        ...
        /// CSV出力
        /// </summary>
        public bool Output(string directoryName)
        {
            if (this.source == null ||
        ...
        private void SetColumns()
        {
            ...
            else if (this.source is DataTable)
            {
                ...
                {
                    this.outputColumns = CsvColumns.CreateCustomColumns(checkColumnNames.ToArray(), CsvColumns.SOURCE_TYPE.DT);
                }
