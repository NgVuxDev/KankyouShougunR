...
namespace Shougun.Core.BusinessManagement.DenpyouDetailIkkatuUpdate.Accessor
{
    /// <summary>
    /// DBAccessするためのクラス
    /// </summary>
    ...
    public class DBAccessor
    {
        ...
        private MZHIClass mzhiDao;

        /// <summary>
        /// IM_KOBETSU_HINMEIDao
        /// </summary>
        private IM_KOBETSU_HINMEIDao kobetsuHinmei;
        ...
        public List<M_UNIT> unitList = new List<M_UNIT>();
        public List<M_DENPYOU_KBN> denpyouKbnList = new List<M_DENPYOU_KBN>();
        #endregion
        ...
        public DBAccessor()
        {
            ...
            this.mzhiDao = DaoInitUtility.GetComponent<MZHIClass>();
            this.kobetsuHinmei = DaoInitUtility.GetComponent<IM_KOBETSU_HINMEIDao>();
            ...
            this.unitList = this.unitDao.GetAllData().ToList();
            this.denpyouKbnList = this.denpyouKbnDao.GetAllData().ToList();
        }
        ...
        internal M_TORIHIKISAKI GetTorihikisakiValidDataByCode(string torihikisakiCd, string teikiyouDate)
        {
            ...
            if (result != null && !string.IsNullOrEmpty(teikiyouDate))
            {
        ...
        /// </summary>
        /// <returns></returns>
        internal string GetUnitNameFast(string cd)
        {
            if (string.IsNullOrEmpty(cd))
            {
                return "";
            ...
            M_UNIT[] unit = this.unitList.Where(x => x.UNIT_CD.Value == Convert.ToInt16(cd)).ToArray();

            if (unit == null || unit.Length == 0)
            {
                return "";
            }
            return unit[0].UNIT_NAME_RYAKU;
        }
        ...
        /// </summary>
        /// <returns></returns>
        internal string GetDenpyouKbnNameFast(string cd)
        {
            if (string.IsNullOrEmpty(cd))
            {
                return "";
            ...
            M_DENPYOU_KBN[] denpyouKbn = this.denpyouKbnList.Where(x => x.DENPYOU_KBN_CD.Value == Convert.ToInt16(cd)).ToArray();

            if (denpyouKbn == null || denpyouKbn.Length == 0)
            {
                return "";
            }
            return denpyouKbn[0].DENPYOU_KBN_NAME_RYAKU;
        }
        ...
        /// </summary>
        /// <returns></returns>
        internal string GetTorihikiKbnNameFast(int cd)
        {
            switch (cd)
            {
                case 1:
        ...
        /// </summary>
        /// <returns></returns>
        internal string GetZeikeisanKbnNameFast(int cd)
        {
            switch (cd)
            {
                case 1:
        ...
        /// </summary>
        /// <returns></returns>
        internal string GetZeiKbnNameFast(int cd)
        {
            switch (cd)
            {
                case 1:
