...
namespace ChouhyouPatternPopup
{
    ...
    internal class ChouhyouPatternTourokuPopupLogic
    {
        ...
        /// デフォルトコンストラクタ
        /// </summary>
        internal ChouhyouPatternTourokuPopupLogic()
        {
        ...
        internal bool Regist(WINDOW_TYPE windowType, PatternDto dto)
        {
            ...
            catch (Exception ex)
            {
                if (ex is Seasar.Dao.NotSingleRowUpdatedRuntimeException)
                {
                    //排他エラー
                    LogUtility.Warn(ex);
                    new MessageBoxShowLogic().MessageBoxShow("E080");
                }
                else
                {
                    //その他
        ...
        private SqlInt64 GetSystemId()
        {
            ...
            var entity = dao.GetNumberSystemDataWithTableLock(new S_NUMBER_SYSTEM() { DENSHU_KBN_CD = (int)DENSHU_KBN.HANYOU_CHOUHYOU });
