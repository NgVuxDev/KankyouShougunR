...
ON M_TORIHIKISAKI.TORIHIKISAKI_CD = T_SEISAN_DENPYOU.TORIHIKISAKI_CD 
AND T_SEISAN_DENPYOU.DELETE_FLG = 0 
AND SEISAN_NUMBER = (select max(SEISAN_NUMBER) from T_SEISAN_DENPYOU tmp where tmp.TORIHIKISAKI_CD = M_TORIHIKISAKI.TORIHIKISAKI_CD)
/*joinStr*/ 
/*sqlWhere*/ 
AND
 ( /*sqlTekiyou*/
    ...
    OR (T_SEISAN_DENPYOU.KONKAI_SEISAN_GAKU IS NULL 
        AND M_TORIHIKISAKI_SHIHARAI.KAISHI_KAIKAKE_ZANDAKA != 0))
