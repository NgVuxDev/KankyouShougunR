...
{
    public partial class IchiranSyuForm : SuperForm
    {
        ...
        public IchiranSyuForm(String paramIn_DenshuKb, String paramIn_SystemID)
            : base(WINDOW_ID.C_ICHIRANSYUTSURYOKU_KOUMOKU, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
        {
            this.InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
            this.logic = new IchiranSyuLogic(this);
        ...
        private void OUTPUT_KBN_VALUE_TextChanged(object sender, EventArgs e)
        {
            switch (this.OUTPUT_KBN_VALUE.Text)
            {
                case "1"://伝票
                    ...
                    this.OUTPUT_KBN_JISSEKI.Checked = false;
                    if (isLoaded != false)
                    {
                        this.logic.ClearScreen();
                        this.logic.Search();
                ...
                case "3":
                    ...
                    this.OUTPUT_KBN_DENPYO.Checked = false;
                    this.OUTPUT_KBN_MEISAI.Checked = false;
                    this.OUTPUT_KBN_JISSEKI.Checked = true;
        ...
        private void OUTPUT_KBN_VALUE_Validated(object sender, EventArgs e)
        {
            switch (this.OUTPUT_KBN_VALUE.Text)
            {
                ...
                case "2"://明細
                    ...
                    break;
                default://空白など
                    if (this.OUTPUT_KBN_VALUE.Text == "3" && this.OUTPUT_KBN_JISSEKI.Visible.Equals(true))
                    {
                        break;
                    }
                    else
                    {
                        ...
                        messageShowLogic.MessageBoxShow("W001", Const.OUTPUT_KBN.DENPYOU.ToString(), Const.OUTPUT_KBN.MEISAI.ToString());
