...
{
    class NumberDayAccess : IMasterDataAccess
    {
        /// <summary>
        /// 日連番
        /// </summary>
        private IS_NUMBER_DAYDao Dao;
        ...
        public NumberDayAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IS_NUMBER_DAYDao>();
        }
        ...
        public bool IsOverCDLimit(S_NUMBER_DAY data, out int maxPlusKeyValue)
        {
            maxPlusKeyValue = -1;
