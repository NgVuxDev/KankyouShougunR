...
{
    class NumberDenshuAccess : IMasterDataAccess
    {
        /// <summary>
        /// 日連番
        /// </summary>
        private IS_NUMBER_DENSHUDao Dao;
        ...
        public NumberDenshuAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IS_NUMBER_DENSHUDao>();
        }
        ...
        public bool IsOverCDLimit(S_NUMBER_DENSHU data, out int maxPlusKeyValue)
        {
            maxPlusKeyValue = -1;
