...
{
    class NumberSystemAccess : IMasterDataAccess
    {
        /// <summary>
        /// 日連番
        /// </summary>
        private IS_NUMBER_SYSTEMDao Dao;
        ...
        public NumberSystemAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IS_NUMBER_SYSTEMDao>();
        }
        ...
        public bool IsOverCDLimit(S_NUMBER_SYSTEM data, out int maxPlusKeyValue)
        {
            maxPlusKeyValue = -1;
