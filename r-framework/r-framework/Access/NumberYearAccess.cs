...
{
    class NumberYearAccess : IMasterDataAccess
    {
        /// <summary>
        /// 日連番
        /// </summary>
        private IS_NUMBER_YEARDao Dao;
        ...
        public NumberYearAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IS_NUMBER_YEARDao>();
        }
        ...
        public bool IsOverCDLimit(S_NUMBER_YEAR data, out int maxPlusKeyValue)
        {
            maxPlusKeyValue = -1;
