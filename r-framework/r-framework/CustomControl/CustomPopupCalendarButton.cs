...
namespace r_framework.CustomControl
{
    ...
    /// ポップアップオープン用ボタン
    /// </summary>
    public sealed partial class CustomPopupCalendarButton : Button, ICustomControl
    {
        /// <summary>
        ...
        /// コンストラクタ
        /// </summary>
        public CustomPopupCalendarButton()
        {
            InitializeComponent();
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            {
                int index = this.PopupSendParams.Length;
                ...
                if (this.DisplayOnlyYear)
                {
                    sendParamArray[index - 1] = "DISPLAY_ONLY_YEAR";
                }
            }
            else
            {
                if (this.DisplayOnlyYear)
                {
                    ...
                    sendParamArray[0] = "DISPLAY_ONLY_YEAR";
                }
            }
