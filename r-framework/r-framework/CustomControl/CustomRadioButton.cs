...
namespace r_framework.CustomControl
{
    ...
    /// カスタムラジオボタン
    /// </summary>
    public partial class CustomRadioButton : RadioButton, ICustomControl
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        ...
        protected override void OnCheckedChanged(EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(LinkedTextBox))
            {
                if (this.Checked)
                {
                    ...
                    var numTextBox = ctrlUtil.GetSettingField(LinkedTextBox) as CustomNumericTextBox2;
                    if (numTextBox != null)
                    {
        ...
        {
            get { return _ReadOnlyPopUp; }
            set { _ReadOnlyPopUp = value; }
        }
