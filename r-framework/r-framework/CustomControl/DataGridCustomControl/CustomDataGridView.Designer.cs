namespace r_framework.CustomControl
{
    partial class CustomDataGridView
    {
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            ////課題 #1588 ここで例外が出る場合あり。（テキストのDispose処理内で、次のコントロールへフォーカス移動するロジックが悪さしている模様。visible=falseでフォーカスを消して回避)
            this.Visible = false; //フォーカス移動なくす
            this.Enabled = false; //とにかく使えなくする
            try
            {
                this.DataSource = null;//データクリア試みる
            }
            catch (System.Exception ex)
            {
                //一旦握りつぶす
                r_framework.Utility.LogUtility.Error("CustomDataGridView.Dispose", ex);   
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.CustomDateGridView_KeyUp);
