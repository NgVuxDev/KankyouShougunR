...
{
    public class GcCustomPhoneNumberTextBoxEditingControl : TextBoxEditingControl
    {
        ...
        protected override void OnEnter(EventArgs e)
        {
            ...
            //
            var cell = this.GcMultiRow.CurrentCell as GcCustomPhoneNumberTextBoxCell;
        ...
        {
            var cell = this.GcMultiRow.CurrentCell as GcCustomPhoneNumberTextBoxCell;
            bool useParentheses = cell.UseParentheses;

            bool accept = logic.CanAcceptOnKeyPress(e.KeyChar, useParentheses);
            if (!accept)
            {
                e.Handled = true;
            }
