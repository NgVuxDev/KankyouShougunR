...
{
    public partial class GcCustomPopupOpenButtonCell : ButtonCell, ICustomControl
    {
        /// <summary>
        /// カスタムポップアップボタンセル
        /// </summary>
        public GcCustomPopupOpenButtonCell()
        {
            InitializeComponent();
        ...
        {
            GcCustomPopupOpenButtonCell myCustomPopupOpenButtonCell = base.Clone() as GcCustomPopupOpenButtonCell;
            ...
            myCustomPopupOpenButtonCell.LinkedSettingTextBox = this.LinkedSettingTextBox;
        ...
        protected override void OnClick(CellEventArgs e)
        {
            ...
            //if (this.GcMultiRow.DataSource == null)
            //{
            //    return;
            //}
            ...
            if (!string.IsNullOrEmpty(LinkedSettingTextBox))
            {
                ...
                ctrlUtil1.ControlCollection = this.GcMultiRow.FindForm().Controls;
                GcCustomTextBoxCell csTextBox = null;

                foreach (Column c in this.GcMultiRow.Columns)
                {
                    if (c.Name == LinkedSettingTextBox)
                    {
                        if (this.GcMultiRow[0, c.Index] is GcCustomTextBoxCell)
                        {
                            csTextBox = (GcCustomTextBoxCell)this.GcMultiRow[0, c.Index];
                        }
                    }
                }
                ...
                if (csTextBox != null)
                {
                    ...
                    this.GetCodeMasterField = csTextBox.GetCodeMasterField;
                    this.SetFormField = csTextBox.SetFormField;
