...
namespace r_framework.Dao
{
    ...
    public interface IM_CONTENA_SHURUIDao : IS2Dao
    {
        ...
        /// <returns></returns>
        DataTable GetIchiranDataSqlFile(string path, M_CONTENA_SHURUI data, bool tekiyounaiFlg, bool deletechuFlg, bool tekiyougaiFlg);
    }
}
