SELECT * FROM dbo.M_BIKO_PATAN_NYURYOKU
WHERE
...
/*IF data.BIKO_NAME != null*/AND BIKO_NAME = /*data.BIKO_NAME*//*END*/
/*IF data.BIKO_NAME_RYAKU != null*/AND BIKO_NAME_RYAKU = /*data.BIKO_NAME_RYAKU*//*END*/
/*IF data.BIKO_FURIGANA != null*/AND BIKO_FURIGANA = /*data.BIKO_FURIGANA*//*END*/
