SELECT M_CHIIKI.CHIIKI_CD, M_CHIIKI.CHIIKI_NAME_RYAKU FROM dbo.M_CHIIKI AS M_CHIIKI
WHERE 
DELETE_FLG = 0
/*IF data.CHIIKI_CD != null*/AND CHIIKI_CD = /*data.CHIIKI_CD*//*END*/
/*IF data.CHIIKI_NAME != null*/AND CHIIKI_NAME = /*data.CHIIKI_NAME*//*END*/
/*IF data.CHIIKI_NAME_RYAKU != null*/AND CHIIKI_NAME_RYAKU = /*data.CHIIKI_NAME_RYAKU*//*END*/
/*IF data.CHIIKI_FURIGANA != null*/AND CHIIKI_FURIGANA = /*data.CHIIKI_FURIGANA*//*END*/
/*IF data.CHIIKI_BIKOU != null*/AND CHIIKI_BIKOU = /*data.CHIIKI_BIKOU*//*END*/
