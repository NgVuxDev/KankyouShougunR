SELECT * FROM dbo.M_DENSHI_SHINSEI_ROUTE_NAME
WHERE 
...
-- ELSE
 1 = 1
/*END*/
/*IF data.DENSHI_SHINSEI_ROUTE_CD != null*/AND DENSHI_SHINSEI_ROUTE_CD = /*data.DENSHI_SHINSEI_ROUTE_CD*//*END*/
/*IF data.DENSHI_SHINSEI_ROUTE_NAME != null*/AND DENSHI_SHINSEI_ROUTE_NAME = /*data.DENSHI_SHINSEI_ROUTE_NAME*//*END*/
/*IF data.DENSHI_SHINSEI_ROUTE_FURIGANA != null*/AND DENSHI_SHINSEI_ROUTE_FURIGANA = /*data.DENSHI_SHINSEI_ROUTE_FURIGANA*//*END*/
