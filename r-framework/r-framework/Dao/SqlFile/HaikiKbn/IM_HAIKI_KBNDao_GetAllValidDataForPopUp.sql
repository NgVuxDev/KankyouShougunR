SELECT M_HAIKI_KBN.HAIKI_KBN_CD, M_HAIKI_KBN.HAIKI_KBN_NAME_RYAKU FROM dbo.M_HAIKI_KBN AS M_HAIKI_KBN
WHERE DELETE_FLG = 0
/*IF !data.HAIKI_KBN_CD.IsNull*/AND HAIKI_KBN_CD = /*data.HAIKI_KBN_CD.Value*//*END*/
/*IF data.HAIKI_KBN_NAME != null*/AND HAIKI_KBN_NAME = /*data.HAIKI_KBN_NAME*//*END*/
/*IF data.HAIKI_KBN_NAME_RYAKU != null*/AND HAIKI_KBN_NAME_RYAKU = /*data.HAIKI_KBN_NAME_RYAKU*//*END*/
/*IF data.HAIKI_KBN_BIKOU != null*/AND HAIKI_KBN_BIKOU = /*data.HAIKI_KBN_BIKOU*//*END*/
