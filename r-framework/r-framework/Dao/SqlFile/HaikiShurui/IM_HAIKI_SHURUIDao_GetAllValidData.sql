SELECT * FROM dbo.M_HAIKI_SHURUI
WHERE
...
/*IF data.HAIKI_SHURUI_NAME_RYAKU != null*/AND HAIKI_SHURUI_NAME_RYAKU = /*data.HAIKI_SHURUI_NAME_RYAKU*//*END*/
/*IF data.HAIKI_SHURUI_FURIGANA != null*/AND HAIKI_SHURUI_FURIGANA = /*data.HAIKI_SHURUI_FURIGANA*//*END*/
/*IF data.HOUKOKUSHO_BUNRUI_CD != null*/AND HOUKOKUSHO_BUNRUI_CD = /*data.HOUKOKUSHO_BUNRUI_CD*//*END*/
/*IF data.HAIKI_SHURUI_BIKOU != null*/AND HAIKI_SHURUI_BIKOU = /*data.HAIKI_SHURUI_BIKOU*//*END*/
