SELECT * FROM dbo.M_KONGOU_HAIKIBUTSU
WHERE
...
/*IF !data.HAIKI_HIRITSU.IsNull*/AND HAIKI_HIRITSU = /*data.HAIKI_HIRITSU.Value*//*END*/
/*IF data.KONGOU_HAIKIBUTSU_BIKOU != null*/AND KONGOU_HAIKIBUTSU_BIKOU = /*data.KONGOU_HAIKIBUTSU_BIKOU*//*END*/
