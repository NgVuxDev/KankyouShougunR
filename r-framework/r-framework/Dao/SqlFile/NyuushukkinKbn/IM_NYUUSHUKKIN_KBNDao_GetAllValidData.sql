SELECT * FROM dbo.M_NYUUSHUKKIN_KBN
WHERE 
...
-- ELSE
 1 = 1
/*END*/
/*IF !data.NYUUSHUKKIN_KBN_CD.IsNull*/AND NYUUSHUKKIN_KBN_CD = /*data.NYUUSHUKKIN_KBN_CD.Value*//*END*/
/*IF data.NYUUSHUKKIN_KBN_NAME != null*/AND NYUUSHUKKIN_KBN_NAME = /*data.NYUUSHUKKIN_KBN_NAME*//*END*/
/*IF data.NYUUSHUKKIN_KBN_NAME_RYAKU != null*/AND NYUUSHUKKIN_KBN_NAME_RYAKU = /*data.NYUUSHUKKIN_KBN_NAME_RYAKU*//*END*/
/*IF data.NYUUSHUKKIN_KBN_BIKOU != null*/AND NYUUSHUKKIN_KBN_BIKOU = /*data.NYUUSHUKKIN_KBN_BIKOU*//*END*/
