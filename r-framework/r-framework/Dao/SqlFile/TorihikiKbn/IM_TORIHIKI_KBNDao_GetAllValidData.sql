SELECT * FROM dbo.M_TORIHIKI_KBN
WHERE 
...
-- ELSE
 1 = 1
/*END*/
/*IF !data.TORIHIKI_KBN_CD.IsNull*/AND TORIHIKI_KBN_CD = /*data.TORIHIKI_KBN_CD.Value*//*END*/
/*IF data.TORIHIKI_KBN_NAME != null*/AND TORIHIKI_KBN_NAME = /*data.TORIHIKI_KBN_NAME*//*END*/
/*IF data.TORIHIKI_KBN_NAME_RYAKU != null*/AND TORIHIKI_KBN_NAME_RYAKU = /*data.TORIHIKI_KBN_NAME_RYAKU*//*END*/
/*IF data.TORIHIKI_KBN_BIKOU != null*/AND TORIHIKI_KBN_BIKOU = /*data.TORIHIKI_KBN_BIKOU*//*END*/
