SELECT * FROM dbo.M_UNPAN_HOUHOU
WHERE 
...
-- ELSE
 1 = 1
/*END*/
/*IF data.UNPAN_HOUHOU_CD != null*/AND UNPAN_HOUHOU_CD = /*data.UNPAN_HOUHOU_CD*//*END*/
/*IF data.UNPAN_HOUHOU_NAME != null*/AND UNPAN_HOUHOU_NAME = /*data.UNPAN_HOUHOU_NAME*//*END*/
/*IF data.UNPAN_HOUHOU_NAME_RYAKU != null*/AND UNPAN_HOUHOU_NAME_RYAKU = /*data.UNPAN_HOUHOU_NAME_RYAKU*//*END*/
