...
{
    public class M_GENBA : SuperEntity
    {
        ...
        //2014.05.09 返送案内仕様変更　by　胡　start
        ...
        //2014.05.09 返送案内仕様変更　by　胡　end
        //2014.05.16 返送案内仕様変更　by　胡　start
        ...
        // 20151020 BUNN #12040 EDN

        // 20160429 koukoukon v2.1_電子請求書 #16612 start
        public string HAKKOUSAKI_CD { get; set; }
        // 20160429 koukoukon v2.1_電子請求書 #16612 end

        public string GENBA_LATITUDE { get; set; }
        public string GENBA_LONGITUDE { get; set; }
        public string GENBA_LOCATION_INFO_UPDATE_NAME { get; set; }
        public SqlDateTime GENBA_LOCATION_INFO_UPDATE_DATE { get; set; }
        public string SEARCH_GENBA_LOCATION_INFO_UPDATE_DATE { get; set; }

        // Begin: LANDUONG - 20220211 - refs#160054
        public string RAKURAKU_CUSTOMER_CD { get; set; }
        // End: LANDUONG - 20220211 - refs#160054

        // ｼｮｰﾄﾒｯｾｰｼﾞオプション
        public SqlInt16 SMS_USE { get; set; }
