...
{
    public class M_GYOUSHA : SuperEntity
    {
        ...
        public SqlInt16 TASYA_EDI { get; set; }

        public string GYOUSHA_LATITUDE { get; set; }
        public string GYOUSHA_LONGITUDE { get; set; }
        public string GYOUSHA_LOCATION_INFO_UPDATE_NAME { get; set; }
        public SqlDateTime GYOUSHA_LOCATION_INFO_UPDATE_DATE { get; set; }

        // Begin: LANDUONG - 20220211 - refs#160052
        public string RAKURAKU_CUSTOMER_CD { get; set; }
        // End: LANDUONG - 20220211 - refs#160052
