...
{
    public class M_KARI_GENBA_TEIKI_HINMEI : SuperEntity
    {
        ...
        public SqlDateTime TANKA_TEKIYOU_BEGIN { get; set; }
        public string SEARCH_TANKA_TEKIYOU_BEGIN { get; set; }
        public SqlDateTime TANKA_TEKIYOU_END { get; set; }
        public string SEARCH_TANKA_TEKIYOU_END { get; set; }
        public SqlDateTime KAISHUU_DATE_END { get; set; }
        public string SEARCH_KAISHUU_DATE_END { get; set; }
