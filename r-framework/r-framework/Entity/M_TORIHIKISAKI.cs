...
{
    public class M_TORIHIKISAKI : SuperEntity
    {
        ...
        public string TORIHIKISAKI_LATITUDE { get; set; }
        public string TORIHIKISAKI_LONGITUDE { get; set; }
        public string TORIHIKISAKI_LOCATION_INFO_UPDATE_NAME { get; set; }
        public SqlDateTime TORIHIKISAKI_LOCATION_INFO_UPDATE_DATE { get; set; }
