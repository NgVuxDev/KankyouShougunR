...
{
    public class T_NYUUKIN_ENTRY : SuperEntity
    {
        public SqlInt64 SYSTEM_ID { get; set; }
        public SqlInt32 SEQ { get; set; }
        public SqlInt16 KYOTEN_CD { get; set; }
        public SqlInt64 NYUUKIN_SUM_SYSTEM_ID { get; set; }
        ...
        public SqlDecimal KARIUKEKIN { get; set; }
        ...
        public SqlBoolean CHOUSEI_DENPYOU_KBN { get; set; }
        public SqlBoolean TOK_INPUT_KBN { get; set; }
