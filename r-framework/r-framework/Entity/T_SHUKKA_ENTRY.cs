...
{
    public class T_SHUKKA_ENTRY : SuperEntity
    {
        ...
        public SqlDateTime KENSHU_DATE { get; set; }
        public string SEARCH_KENSHU_DATE { get; set; }
        public SqlDecimal SHUKKA_NET_TOTAL { get; set; }
        public SqlDecimal KENSHU_NET_TOTAL { get; set; }
        public SqlDecimal SABUN { get; set; }
        public SqlDecimal SHUKKA_KINGAKU_TOTAL { get; set; }
        public SqlDecimal KENSHU_KINGAKU_TOTAL { get; set; }
        public SqlDecimal SAGAKU { get; set; }
        public SqlBoolean KENSHU_MUST_KBN { get; set; }
        public SqlDecimal KENSHU_URIAGE_SHOUHIZEI_RATE { get; set; }
        public SqlDecimal KENSHU_URIAGE_AMOUNT_TOTAL { get; set; }
        public SqlDecimal KENSHU_URIAGE_TAX_SOTO { get; set; }
        public SqlDecimal KENSHU_URIAGE_TAX_UCHI { get; set; }
        public SqlDecimal KENSHU_URIAGE_TAX_SOTO_TOTAL { get; set; }
        public SqlDecimal KENSHU_URIAGE_TAX_UCHI_TOTAL { get; set; }
        public SqlDecimal KENSHU_HINMEI_URIAGE_KINGAKU_TOTAL { get; set; }
        public SqlDecimal KENSHU_HINMEI_URIAGE_TAX_SOTO_TOTAL { get; set; }
        public SqlDecimal KENSHU_HINMEI_URIAGE_TAX_UCHI_TOTAL { get; set; }
        public SqlDecimal KENSHU_SHIHARAI_SHOUHIZEI_RATE { get; set; }
        public SqlDecimal KENSHU_SHIHARAI_AMOUNT_TOTAL { get; set; }
        public SqlDecimal KENSHU_SHIHARAI_TAX_SOTO { get; set; }
        public SqlDecimal KENSHU_SHIHARAI_TAX_UCHI { get; set; }
        public SqlDecimal KENSHU_SHIHARAI_TAX_SOTO_TOTAL { get; set; }
        public SqlDecimal KENSHU_SHIHARAI_TAX_UCHI_TOTAL { get; set; }
        public SqlDecimal KENSHU_HINMEI_SHIHARAI_KINGAKU_TOTAL { get; set; }
        public SqlDecimal KENSHU_HINMEI_SHIHARAI_TAX_SOTO_TOTAL { get; set; }
        public SqlDecimal KENSHU_HINMEI_SHIHARAI_TAX_UCHI_TOTAL { get; set; }
        public SqlDateTime KENSHU_URIAGE_DATE { get; set; }
        public string SEARCH_KENSHU_URIAGE_DATE { get; set; }
        public SqlDateTime KENSHU_SHIHARAI_DATE { get; set; }
        public string SEARCH_KENSHU_SHIHARAI_DATE { get; set; }
