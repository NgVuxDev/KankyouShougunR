...
namespace r_framework.MasterAccess
{
    ...
    /// 分類マスタアクセス用クラス
    /// </summary>
    public class BunruiMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 取引先マスタのDao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public BunruiMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_BUNRUIDao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.BUNRUI_CD = CheckControl.GetResultText();
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "分類");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_BUNRUI)Entity);
        }
    }
}
