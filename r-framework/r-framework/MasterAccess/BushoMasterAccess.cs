...
namespace r_framework.MasterAccess
{
    ...
    /// 部署マスタアクセスクラス
    /// </summary>
    public class BushoMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public BushoMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;

            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_BUSHODao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.BUSHO_CD = CheckControl.GetResultText();
