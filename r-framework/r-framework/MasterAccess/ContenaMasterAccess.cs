...
namespace r_framework.MasterAccess
{
    ...
    /// コンテナマスタアクセスクラス
    /// </summary>
    public class ContenaMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// コンテナマスタのDao
        /// </summary>
        private IM_CONTENADao Dao;
        /// <summary>
        /// Entity
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public ContenaMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_CONTENADao>();
        }
        ...
        public string CodeCheck()
        {
            ...
            entity.CONTENA_CD = CheckControl.GetResultText();
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "コンテナ");
            }
            else
            {
        ...
        public string RegistCodeCheck(bool presenceFlag)
        {
            ...
            else
            {
                if (returnEntitys.Length != 0)
                {
                    ...
                    errorMessage = String.Format(errorMessage, "コンテナ種類CD、コンテナCD");
                }
            }
            return errorMessage;
        }
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_CONTENA)Entity);
        }
        ...
        /// <returns></returns>
        private bool HasEmptyKey(M_CONTENA data)
        {
            if (data == null
                || string.IsNullOrEmpty(data.CONTENA_SHURUI_CD)
                || string.IsNullOrEmpty(data.CONTENA_CD))
            {
                return true;
            }
            else
