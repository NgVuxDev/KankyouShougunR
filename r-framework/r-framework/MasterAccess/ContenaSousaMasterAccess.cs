...
namespace r_framework.MasterAccess
{
    ...
    /// コンテナ操作マスタ
    /// </summary>
    public class ContenaSousaMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        private IM_CONTENA_SOUSADao Dao;
        /// <summary>
        /// Entity
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public ContenaSousaMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_CONTENA_SOUSADao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.CONTENA_SOUSA_CD = Int16.Parse(CheckControl.GetResultText());
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "コンテナ操作");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_CONTENA_SOUSA)Entity);
        }
    }
}
