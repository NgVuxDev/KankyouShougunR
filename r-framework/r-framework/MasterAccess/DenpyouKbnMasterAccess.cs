...
namespace r_framework.MasterAccess
{
    ...
    /// 伝票区分マスタアクセス
    /// </summary>
    public class DenpyouKbnMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public DenpyouKbnMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENPYOU_KBNDao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.DENPYOU_KBN_CD = Int16.Parse(CheckControl.GetResultText());
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "伝票区分");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENPYOU_KBN)Entity);
        }
    }
}
