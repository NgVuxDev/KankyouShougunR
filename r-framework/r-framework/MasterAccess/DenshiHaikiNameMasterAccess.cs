...
{
    public class DenshiHaikiNameMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public DenshiHaikiNameMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENSHI_HAIKI_NAMEDao>();
        }
        ...
        public string CodeCheck()
        {
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "電子廃棄物名称");
            }
            else
            {
        ...
        private string RegistCodeCheck(bool presenceFlag)
        {
            ...
            else
            {
                if (returnEntitys.Length != 0)
                {
                    ...
                    errorMessage = String.Format(errorMessage, "加入者番号、廃棄物名称CD");
                }
            }
            return errorMessage;
        }
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENSHI_HAIKI_NAME)Entity);
        }
