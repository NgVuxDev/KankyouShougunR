...
{
    public class DenshiHaikiShuruiMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public DenshiHaikiShuruiMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENSHI_HAIKI_SHURUIDao>();
        }
        ...
        public string CodeCheck()
        {
            ...
            if(returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "電子廃棄物種類");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENSHI_HAIKI_SHURUI)Entity);
        }
