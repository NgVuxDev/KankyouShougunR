...
{
    public class DenshiHaikiShuruiSaibunruiMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public DenshiHaikiShuruiSaibunruiMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENSHI_HAIKI_SHURUI_SAIBUNRUIDao>();
        }
        ...
        public string CodeCheck()
        {
            ...
            entity.HAIKI_SHURUI_SAIBUNRUI_CD = CheckControl.GetResultText();
            ...
            if(returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "電子廃棄物種類細分類");
            }
            else
            {
        ...
        private string RegistCodeCheck(bool presenceFlag)
        {
            ...
            else
            {
                if(returnEntitys.Length != 0)
                {
                    ...
                    errorMessage = String.Format(errorMessage, "加入者番号、廃棄物種類CD、廃棄物種類細分類CD");
                }
            }
            return errorMessage;
        }
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENSHI_HAIKI_SHURUI_SAIBUNRUI)Entity);
        }
