...
{
    public class DenshiKeiyakuShanaiKeiroNameMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        private IM_DENSHI_KEIYAKU_SHANAI_KEIRO_NAMEDao Dao;
        ...
        public DenshiKeiyakuShanaiKeiroNameMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENSHI_KEIYAKU_SHANAI_KEIRO_NAMEDao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.DENSHI_KEIYAKU_SHANAI_KEIRO_NAME_CD = Int16.Parse(CheckControl.GetResultText());
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "社内経路名（電子）");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENSHI_KEIYAKU_SHANAI_KEIRO_NAME)Entity);
        }
    }
}
