...
{
    public class DenshiShinseiJyuyoudoMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 取引先マスタのDao
        /// </summary>
        private IM_DENSHI_SHINSEI_JYUYOUDODao Dao;
        /// <summary>
        /// Entity
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public DenshiShinseiJyuyoudoMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENSHI_SHINSEI_JYUYOUDODao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.JYUYOUDO_CD = CheckControl.GetResultText();
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "重要度");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENSHI_SHINSEI_JYUYOUDO)Entity);
        }
    }
}
