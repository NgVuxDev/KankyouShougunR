...
{
    public class DenshiShinseiNaiyoMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        private IM_DENSHI_SHINSEI_NAIYOUDao Dao;
        ...
        public DenshiShinseiNaiyoMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENSHI_SHINSEI_NAIYOUDao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            M_DENSHI_SHINSEI_NAIYOU entity = new M_DENSHI_SHINSEI_NAIYOU();
            if (SendParam != null)
            {
            ...
            entity.NAIYOU_CD = Int16.Parse(CheckControl.GetResultText());
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "申請内容名");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENSHI_SHINSEI_NAIYOU)Entity);
        }
    }
}
