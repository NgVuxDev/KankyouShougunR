...
{
    public class DenshiTantoushaMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public DenshiTantoushaMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENSHI_TANTOUSHADao>();
        }
        ...
        public string CodeCheck()
        {
            ...
            if(returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "電子担当者");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENSHI_TANTOUSHA)Entity);
        }
