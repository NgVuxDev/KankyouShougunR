...
{
    public class DenshiYuugaiBusshitsuMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public DenshiYuugaiBusshitsuMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENSHI_YUUGAI_BUSSHITSUDao>();
        }
        ...
        public string CodeCheck()
        {
            ...
            entity.YUUGAI_BUSSHITSU_CD = CheckControl.GetResultText();
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "電子有害物質");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENSHI_YUUGAI_BUSSHITSU)Entity);
        }
