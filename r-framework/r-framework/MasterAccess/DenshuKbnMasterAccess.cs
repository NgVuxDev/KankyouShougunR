...
namespace r_framework.MasterAccess
{
    ...
    /// 伝種区分マスタアクセス
    /// </summary>
    public class DenshuKbnMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public DenshuKbnMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;

            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_DENSHU_KBNDao>();
        }
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_DENSHU_KBN)Entity);
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.DENSHU_KBN_CD = SqlInt16.Parse(CheckControl.GetResultText());
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "伝種区分");
            }
            else
            {
        ...
        private string RegistCodeCheck(bool presenceFlag)
        {
            ...
            else
            {
                if (returnEntitys.Length != 0)
                {
                    ...
                    errorMessage = String.Format(errorMessage, "部署");
                }
            }
            return errorMessage;
        }
