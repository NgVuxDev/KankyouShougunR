...
{
    public class HaikiShuruiMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 取引先マスタのDao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public HaikiShuruiMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_HAIKI_SHURUIDao>();
        }
        ...
        public string CodeCheck()
        {
            ...
            entity.HAIKI_SHURUI_CD = CheckControl.GetResultText();
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "廃棄物種類");
            }
            else
            {
        ...
        public string RegistCodeCheck(bool presenceFlag)
        {
            ...
            else
            {
                if (returnEntitys.Length != 0)
                {
                    ...
                    errorMessage = String.Format(errorMessage, "廃棄物区分CD、廃棄物種類CD");
                }
            }
            return errorMessage;
        }
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_HAIKI_SHURUI)Entity);
        }
        ...
        /// <returns></returns>
        private bool HasEmptyKey(M_HAIKI_SHURUI data)
        {
            if (data == null
                || data.HAIKI_KBN_CD.IsNull
                || string.IsNullOrEmpty(data.HAIKI_SHURUI_CD))
            {
                return true;
            }
            else
