...
{
    public class ItakuKeiyakuKihonMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 委託契約基本マスタのDao
        /// </summary>
        private IM_ITAKU_KEIYAKU_KIHONDao Dao;
        /// <summary>
        /// Entity
        /// </summary>
        ...
        /// CDのMax桁数
        /// </summary>
        public readonly int CdMaxLength = 9;

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ItakuKeiyakuKihonMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_ITAKU_KEIYAKU_KIHONDao>();
        }
        ...
        public string CodeCheck()
        {
            ...
            M_ITAKU_KEIYAKU_KIHON entity = new M_ITAKU_KEIYAKU_KIHON();
            if (SendParam != null)
            {
            ...
            entity.SYSTEM_ID = CheckControl.GetResultText();
        ...
        private string RegistCodeCheck(bool presenceFlag)
        {
            ...
            else
            {
                if (returnEntitys.Length != 0)
                {
                    ...
                    errorMessage = String.Format(errorMessage, "委託契約書基本情報");
                }
            }
            return errorMessage;
        }
