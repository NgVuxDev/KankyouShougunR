...
{
    public class JissekiBunruiMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public JissekiBunruiMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_JISSEKI_BUNRUIDao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.JISSEKI_BUNRUI_CD = CheckControl.GetResultText();
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "実績分類");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_JISSEKI_BUNRUI)Entity);
