...
namespace r_framework.MasterAccess
{
    ...
    /// 換算値マスタアクセスクラス
    /// </summary>
    public class KansanMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 換算値マスタのDao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public KansanMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_KANSANDao>();
        }
        ...
        public string CodeCheckAndSetting()
        {
            ...
            var checkResultFlag = this.CodeCheck();
        ...
        public string CodeCheck()
        {
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "換算値");
            }
            else
            {
        ...
        public string RegistCodeCheck(bool presenceFlag)
        {
            ...
            else
            {
                if (returnEntitys.Length != 0)
                {
                    ...
                    errorMessage = String.Format(errorMessage, "伝票区分CD、品名CD、単位CD");
                }
            }
            return errorMessage;
        }
        ...
        /// <returns></returns>
        private bool HasEmptyKey(M_KANSAN data)
        {
            if (data == null
                || data.DENPYOU_KBN_CD.IsNull
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_KANSAN)Entity);
        }
    }
}
