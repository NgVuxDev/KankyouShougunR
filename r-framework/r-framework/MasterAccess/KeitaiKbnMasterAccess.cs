...
{
    public class KeitaiKbnMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 取引先マスタのDao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public KeitaiKbnMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_KEITAI_KBNDao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.KEITAI_KBN_CD = Int16.Parse(CheckControl.GetResultText());
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "形態区分");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_KEITAI_KBN)Entity);
        }
    }
}
