...
{
    public class KihonHinmeiTankaMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public KihonHinmeiTankaMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_KIHON_HINMEI_TANKADao>();
        }
        ...
        public string CodeCheckAndSetting()
        {
            ...
            else
            {
                ...
                errorMessage = String.Format(errorMessage, "基本品名単価");
            }
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_KIHON_HINMEI_TANKA)Entity);
        }
