...
{
    public class KyotenMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        private IM_KYOTENDao Dao;
        /// <summary>
        /// Entity
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public KyotenMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_KYOTENDao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.KYOTEN_CD = Int16.Parse(CheckControl.GetResultText());
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "拠点");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_KYOTEN)Entity);
        }
    }
}
