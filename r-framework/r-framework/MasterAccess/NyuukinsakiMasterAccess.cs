...
{
    public class NyuukinsakiMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 入金先マスタのDao
        /// </summary>
        private IM_NYUUKINSAKIDao Dao;
        ...
        public NyuukinsakiMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;

            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_NYUUKINSAKIDao>();
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_NYUUKINSAKI)Entity);
        }
        ...
        private string CodeCheck()
        {
            ...
            M_NYUUKINSAKI entity = new M_NYUUKINSAKI();
            if (SendParam != null)
            {
            ...
            entity.NYUUKINSAKI_CD = CheckControl.GetResultText();
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "入金先");
            }
            else
            {
