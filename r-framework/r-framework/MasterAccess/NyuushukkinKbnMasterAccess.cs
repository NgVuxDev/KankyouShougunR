...
{
    public class NyuushukkinKbnMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public NyuushukkinKbnMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_NYUUSHUKKIN_KBNDao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.NYUUSHUKKIN_KBN_CD = Int16.Parse(CheckControl.GetResultText());
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "入出金区分");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_NYUUSHUKKIN_KBN)Entity);
        }
    }
}
