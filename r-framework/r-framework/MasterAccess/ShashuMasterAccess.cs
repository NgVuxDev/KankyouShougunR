...
{
    public class ShashuMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// Dao
        /// </summary>
        private IM_SHASHUDao Dao;
        /// <summary>
        /// Entity
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public ShashuMasterAccess()
        {
            Dao = DaoInitUtility.GetComponent<IM_SHASHUDao>();
        }
        public ShashuMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
        ...
        private string CodeCheck()
        {
            ...
            entity.SHASHU_CD = CheckControl.GetResultText();
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "車種");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_SHASHU)Entity);
        }

        /// <summary>
        /// すべてのデータを取得
        /// </summary>
        public M_SHASHU[] GetMasterData()
        {
