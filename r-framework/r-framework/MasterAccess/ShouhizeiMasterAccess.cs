...
{
    public class ShouhizeiMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 取引先マスタのDao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public ShouhizeiMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_SHOUHIZEIDao>();
        }
        ...
        public string CodeCheckAndSetting()
        {
            ...
            else
            {
                ...
                errorMessage = String.Format(errorMessage, "消費税");
            }
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_SHOUHIZEI)Entity);
        }
