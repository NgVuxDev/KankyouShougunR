...
{
    public class TegataHokanshaMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 取引先マスタのDao
        /// </summary>
        private IM_TEGATA_HOKANSHADao Dao;
        /// <summary>
        /// Entity
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public TegataHokanshaMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_TEGATA_HOKANSHADao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            M_TEGATA_HOKANSHA entity = new M_TEGATA_HOKANSHA();
            if (SendParam != null)
            {
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "手形保管者");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_SHAIN)Entity);
        }
    }
}
