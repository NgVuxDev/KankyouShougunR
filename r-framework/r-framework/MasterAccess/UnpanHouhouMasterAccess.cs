...
{
    public class UnpanHouhouMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 取引先マスタのDao
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public UnpanHouhouMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_UNPAN_HOUHOUDao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            entity.UNPAN_HOUHOU_CD = CheckControl.GetResultText();
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "運搬方法");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_UNPAN_HOUHOU)Entity);
        }
    }
}
