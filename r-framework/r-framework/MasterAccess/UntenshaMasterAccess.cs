...
{
    public class UntenshaMasterAccess : IMasterDataAccess
    {
        /// <summary>
        /// 取引先マスタのDao
        /// </summary>
        private IM_UNTENSHADao Dao;
        /// <summary>
        /// Entity
        /// </summary>
        ...
        /// コンストラクタ
        /// </summary>
        public UntenshaMasterAccess(ICustomControl control, object[] obj, object[] sendParam)
        {
            this.CheckControl = control;
            this.Param = obj;
            this.SendParam = sendParam;
            Dao = DaoInitUtility.GetComponent<IM_UNTENSHADao>();
        }
        ...
        private string CodeCheck()
        {
            ...
            M_UNTENSHA entity = new M_UNTENSHA();
            if (SendParam != null)
            {
            ...
            if (returnEntitys.Length == 0)
            {
                ...
                errorMessage = String.Format(errorMessage, "運転者");
            }
            else
            {
        ...
        public virtual void CodeDataSetting()
        {
            ...
            controlUtil.setCheckDate((M_UNTENSHA)Entity);
        }
    }
}
