...
namespace Shougun.Function.ShougunCSCommon.Dao
{
    ...
    public interface IS_NUMBER_DAYDao : IS2Dao
    {
        ...
        /// <summary>
        /// 【テーブルロック】テーブルをロックしEntityで絞り込んで値を取得する
        /// </summary>
        /// <param name="date"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Function.ShougunCSCommon.Dao.SqlFile.NumberDay.IS_NUMBER_DAYDao_GetDataForEntity_WithTableLock.sql")]
        S_NUMBER_DAY[] GetDataForEntityWithTableLock(S_NUMBER_DAY data);
