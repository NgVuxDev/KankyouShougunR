...
namespace Shougun.Function.ShougunCSCommon.Dao
{
    ...
    public interface IS_NUMBER_YEARDao : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Function.ShougunCSCommon.Dao.SqlFile.NumberYear.IS_NUMBER_YEARDao_GetDataForEntity.sql")]
        S_NUMBER_YEAR[] GetDataForEntity(S_NUMBER_YEAR data);

        /// <summary>
        /// 【テーブルロック】テーブルロックをしつつEntityで絞り込んで値を取得する
        /// </summary>
        /// <param name="date"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Function.ShougunCSCommon.Dao.SqlFile.NumberYear.IS_NUMBER_YEARDao_GetDataForEntity_WithTableLock.sql")]
        S_NUMBER_YEAR[] GetDataForEntityWithTableLock(S_NUMBER_YEAR data);
