...
namespace Shougun.Function.ShougunCSCommon.Dao
{
    ...
    public interface IT_KEIRYOU_DETAILDao : IS2Dao
    {
        ...
        /// <returns></returns>
		[SqlFile("Shougun.Function.ShougunCSCommon.Dao.SqlFile.KeiryouDetail.IT_KEIRYOU_DETAILDao_GetDataForEntity.sql")]
        T_KEIRYOU_DETAIL[] GetDataForEntity(T_KEIRYOU_DETAIL data);
        ...
        /// <summary>
        /// T_KEIRYOU_DETAIL.SYSTEM_IDの最高値を取得する
        /// </summary>
        /// <param name="whereSql">絞り込み条件</param>
        /// <returns>SYSTEM_IDのMAX値</returns>
        [Sql("select ISNULL(MAX(DETAIL_SYSTEM_ID),1) FROM T_KEIRYOU_DETAIL /*$whereSql*/")]
