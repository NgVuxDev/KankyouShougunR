...
namespace Shougun.Function.ShougunCSCommon.Dao
{
    ...
    public interface IT_SHUKKIN_ENTRYDao : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Function.ShougunCSCommon.Dao.SqlFile.ShukkinEntry.IT_SHUKKIN_ENTRYDao_GetDataForEntity.sql")]
        T_SHUKKIN_ENTRY[] GetDataForEntity(T_SHUKKIN_ENTRY data);
    }
}
