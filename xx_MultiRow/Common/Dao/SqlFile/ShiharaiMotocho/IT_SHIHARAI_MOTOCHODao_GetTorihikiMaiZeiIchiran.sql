SELECT
	...
	SEIDEN.SEISAN_NUMBER AS SEISAN_NUMBER,
...
FROM
	...
	LEFT JOIN T_SEISAN_DETAIL AS SEIDET 
	ON SEIDEN.SEISAN_NUMBER = SEIDET.SEISAN_NUMBER
	...
	AND UE.DELETE_FLG = 0
	/*IF startDay != null*/
	AND CONVERT (DATETIME ,CONVERT (NVARCHAR ,UE.URIAGE_DATE ,111),120) >= CONVERT (DATETIME ,CONVERT (NVARCHAR ,/*startDay*/'2013/11/01 0:00:00' ,111),120)
	/*END*/
	/*IF endDay != null*/
	AND CONVERT (DATETIME ,CONVERT (NVARCHAR ,UE.URIAGE_DATE ,111),120) <= CONVERT (DATETIME ,CONVERT (NVARCHAR ,/*endDay*/'2013/11/30 0:00:00' ,111),120)
	/*END*/
WHERE
	SEIDEN.DELETE_FLG = 0
AND	SEIDEN.TORIHIKISAKI_CD = /*torihikisakiCD*/
AND	CONVERT(DATETIME, CONVERT(nvarchar, SEIDEN.SEISAN_DATE, 111), 120) >= CONVERT(DATETIME, CONVERT(nvarchar, /*startDay*/, 111), 120)
AND	CONVERT(DATETIME, CONVERT(nvarchar, SEIDEN.SEISAN_DATE, 111), 120) <= CONVERT(DATETIME, CONVERT(nvarchar, /*endDay*/, 111), 120)
UNION ALL 
(
SELECT
	SEIDEN.TORIHIKISAKI_CD AS TORIHIKISAKI_CD,
...
FROM
	...
	/*IF startDay != null*/
	AND CONVERT (DATETIME ,CONVERT (NVARCHAR ,SE.URIAGE_DATE ,111),120) >= CONVERT (DATETIME ,CONVERT (NVARCHAR ,/*startDay*/'2013/11/01 0:00:00' ,111),120)
	/*END*/
	/*IF endDay != null*/
	AND CONVERT (DATETIME ,CONVERT (NVARCHAR ,SE.URIAGE_DATE ,111),120) <= CONVERT (DATETIME ,CONVERT (NVARCHAR ,/*endDay*/'2013/11/30 0:00:00' ,111),120)
	/*END*/
WHERE
	SEIDEN.DELETE_FLG = 0
AND	SEIDEN.TORIHIKISAKI_CD = /*torihikisakiCD*/
...
FROM
	...
	/*IF startDay != null*/
	AND CONVERT (DATETIME ,CONVERT (NVARCHAR ,SE.KENSHU_URIAGE_DATE ,111),120) >= CONVERT (DATETIME ,CONVERT (NVARCHAR ,/*startDay*/'2013/11/01 0:00:00' ,111),120)
	/*END*/
	/*IF endDay != null*/
	AND CONVERT (DATETIME ,CONVERT (NVARCHAR ,SE.KENSHU_URIAGE_DATE ,111),120) <= CONVERT (DATETIME ,CONVERT (NVARCHAR ,/*endDay*/'2013/11/30 0:00:00' ,111),120)
	/*END*/
WHERE
	SEIDEN.DELETE_FLG = 0
AND	SEIDEN.TORIHIKISAKI_CD = /*torihikisakiCD*/
...
FROM
	...
	/*IF startDay != null*/
	AND CONVERT (DATETIME ,CONVERT (NVARCHAR ,U_SE.URIAGE_DATE ,111),120) >= CONVERT (DATETIME ,CONVERT (NVARCHAR ,/*startDay*/'2013/11/01 0:00:00' ,111),120)
	/*END*/
	/*IF endDay != null*/
	AND CONVERT (DATETIME ,CONVERT (NVARCHAR ,U_SE.URIAGE_DATE ,111),120) <= CONVERT (DATETIME ,CONVERT (NVARCHAR ,/*endDay*/'2013/11/30 0:00:00' ,111),120)
	/*END*/
WHERE
	SEIDEN.DELETE_FLG = 0
AND	SEIDEN.TORIHIKISAKI_CD = /*torihikisakiCD*/
