// $Id: JyuuryouDto.cs 21047 2014-05-21 00:23:46Z ogawa@takumi-sys.co.jp $
using System;
...
namespace Shougun.Function.ShougunCSCommon.Dto
{
    ...
    public class JyuuryouDto
    {
            ...
            bool jyuuryouTargetFlag, short valueHasuCd = 1, short valueKetaKeta = 1, short percentHasuCd = 1, short percentHasuKeta = 3)
        {
            ...
            // 計算可能な行かを確認
            if (firstJyuuryouDto.stackJyuuryou == null || firstJyuuryouDto.emptyJyuuryou == null)
            {
            ...
            decimal JyuuryouSum = 0;  // 割振重量の合計値を計算
            ...
            while (0 < netJyuuryou)
            {
                ...
                if (jyuuryouTargetFlag)
                {
                    ...
                    // 割振%計算
                    if ((stackJyuuryou - emptyJyuuryou - JyuuryouSum - jyuuryouDto.WarifuriJyuuryouToDecimal() > 0))
                    {
                        // 割振重量の残りがある場合
                ...
                JyuuryouSum += jyuuryouDto.WarifuriJyuuryouToDecimal();
                 ...
                 */
                if (jyuuryouTargetFlag || (!jyuuryouTargetFlag && jyuuryouDto.warifuriPercent != 0))
                {
                    if (overCountFlag)
                    {
                        // 一番下に新規追加
                ...
                {
                    // 端数が出ると３行目ができてしまうため、端数分は２行目に追加
                    if (i > 0)
                    {
                        jyuuryouDtoList[i - 1].netJyuuryou += jyuuryouDto.netJyuuryou;
                        jyuuryouDtoList[i - 1].warifuriJyuuryou += jyuuryouDto.warifuriJyuuryou;
                    }
                }
