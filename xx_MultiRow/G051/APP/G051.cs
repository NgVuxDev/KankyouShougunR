...
namespace Shougun.Core.SalesPayment.UkeireNyuuryoku
{
    ...
    /// G051 受入入力
    /// </summary>
    class G051 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// フォーム作成
        /// </summary>
        ...
        public Form CreateForm(params object[] args)
        {
            ...
            Shougun.Core.SalesPayment.UkeireNyuuryoku.UIForm.LastRunMethod lastRunMethod = null;
            if (args.Length > 2 && args[2] != null)
            {
                lastRunMethod = (Shougun.Core.SalesPayment.UkeireNyuuryoku.UIForm.LastRunMethod)args[2];
            }
