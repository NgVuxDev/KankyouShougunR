    ...
    public partial class UIForm : SuperForm
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (this.UkeireNumber == -1 && this.UketsukeNumber != -1)
            {
                ...
                this.UKETSUKE_NUMBER.Text = this.UketsukeNumber.ToString();
            ...
            if (!nowLoding)
            {
                    ...
                    && long.TryParse(this.ENTRY_NUMBER.Text.ToString(), out ukeireNumber))
                {
                    if (this.UkeireNumber != ukeireNumber)  // No.2175
                    {
                        ...
                        // 権限チェック
                        if (!r_framework.Authority.Manager.CheckAuthority("G051", WINDOW_TYPE.UPDATE_WINDOW_FLAG, false))
                        {
                            // 修正権限がない場合
                            if (r_framework.Authority.Manager.CheckAuthority("G051", WINDOW_TYPE.REFERENCE_WINDOW_FLAG, false))
                            {
        ...
        private void GENBA_CD_Enter(object sender, EventArgs e)
        {
            //// 現場を取得
            //bool catchErr = true;
            //var retData = this.logic.accessor.GetGenba(this.GYOUSHA_CD.Text, this.GENBA_CD.Text, this.DENPYOU_DATE.Text, this.logic.footerForm.sysDate, out catchErr);
            //if (!catchErr)
            //{
            //    return;
            //}
        ...
        public virtual void ChangeNewWindow(object sender, EventArgs e)
        {
            ...
            if (isChangeNewModeFlg)
            {
                ...
                // 追加権限チェック
                if (r_framework.Authority.Manager.CheckAuthority("G051", WINDOW_TYPE.NEW_WINDOW_FLAG))
                {
                    this.WindowType = WINDOW_TYPE.NEW_WINDOW_FLAG;
                    this.InitNumbers();
                    this.SEQ = "0";
        ...
        public virtual void SharyouKuushaJyuuryouTorikomi(object sender, EventArgs e)
        {
            ...
            if (null != lastRow)
            {
                ...
                var warifuriJyuuryou = lastRow.Cells[LogicClass.CELL_NAME_WARIFURI_JYUURYOU].Value;
        ...
        public virtual void TairyuuRegist(object sender, EventArgs e)
        {
            ...
            // 20141105 Houkakou 委託契約チェック start
            if (!base.RegistErrorFlag)
            {
                bool catchErr = true;
            ...
            // 20141105 Houkakou 委託契約チェック end
            ...
            if (!base.RegistErrorFlag)
            {
                ...
                switch (this.WindowType)
                {
                    ...
                    case WINDOW_TYPE.UPDATE_WINDOW_FLAG:
                        ...
                        if (SalesPaymentConstans.KEIZOKU_NYUURYOKU_ON.Equals(this.KEIZOKU_NYUURYOKU_VALUE.Text)
                            && r_framework.Authority.Manager.CheckAuthority("G051", WINDOW_TYPE.NEW_WINDOW_FLAG, false))
                        {
                            // 新規モードに切り替え、再度入力可能状態とする
                            this.WindowType = WINDOW_TYPE.NEW_WINDOW_FLAG;
                            this.UkeireNumber = -1;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private bool RegistDataProcess(object sender, EventArgs e)
        {
            bool ret = true;
            try
            {
                ...
                // 20141014 luning 「受入入力画面」の休動Checkを追加する　start
                ...
                // 20141014 luning 「受入入力画面」の休動Checkを追加する　end
                ...
                if (!base.RegistErrorFlag)
                {
                    ...
                    switch (this.WindowType)
                    {
                        case WINDOW_TYPE.NEW_WINDOW_FLAG:
                            ...
                            // 4935_6 受入入力 jyokou 20150429 str
                            this.logic.isRegistered = true;
                            // 4935_6 受入入力 jyokou 20150429 end
        ...
        public virtual void AddRow(object sender, EventArgs e)
        {
            ...
            if (this.ismobile_mode && this.DETAIL_TAB.SelectedIndex == 1)
            {
        ...
        internal void UketsukeDenpyo(object sender, EventArgs e)
        {
            ...
            FormManager.OpenForm("G292", WINDOW_TYPE.NONE, DENSHU_KBN.UKEIRE);
            ...
            if (this.WindowType == WINDOW_TYPE.NEW_WINDOW_FLAG)
            {
                ...
                if (this.UketsukeNumberTextChangeFlg)
                {
                    ...
                    if (!string.IsNullOrEmpty(this.UKETSUKE_NUMBER.Text))
                    {
                        ...
                        if (!this.UKETSUKE_NUMBER.Text.Equals(this.UketsukeNumber.ToString()))
                        {
                            bool catchErr = true;
        ...
        // No.4578-->
        // 20150411 在庫品名CD KeyDownイベント設定 Start
        // 在庫品名CDが活性化の上、
        ...
        // 20150411 在庫品名CD KeyDownイベント設定 End
        // No.4578<--
            ...
            if (e.KeyChar == (char)Keys.Tab || e.KeyChar == (char)Keys.Enter)
            {
                if (ActiveControl != null)
                {
                    ...
                    else
                    {
                        ...
                        if (this.ActiveControl != null && (this.ActiveControl.Name == "gcMultiRow2" || (this.ActiveControl.Name == "DETAIL_TAB" && this.DETAIL_TAB.SelectedIndex == 1)))
                        {
        ...
        {
            // この画面（G051）が呼び出された時の引数に受付番号が含まれていた場合、
        ...
        {
            // この画面（G051）が呼び出された時の引数に計量番号が含まれていた場合、
            // 初回起動時にフラグが立たないようにするための対策
