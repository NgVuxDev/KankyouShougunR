...
namespace Shougun.Core.SalesPayment.UkeireNyuuryoku.DAO
{
    /// <summary>
    /// コンテナ情報DAO
    /// </summary>
    ...
    internal interface TCRClass : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetContena.sql")]
    ...
    internal interface TCREClass : IS2Dao
    {
        ...
        /// <param name="sysId">受入入力．システムID</param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetContenaReserveData.sql")]
    ...
    public interface MCClass : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetContenaMaster.sql")]
    ...
    internal interface MTSeiClass : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetTorihikisakiKBN_Seikyuu.sql")]
    ...
    internal interface MTShihaClass : IS2Dao
    {
        ...
        /// <param name="torihikisakiCD">画面．取引先CD</param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetTorihikisakiKBN_Shiharai.sql")]
    ...
    internal interface TZUDClass : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetZaikoInfo.sql")]
    ...
    internal interface TZHHClass : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetZaikoInfo2.sql")]
    ...
    internal interface TUMEClass : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetUketsukeData.sql")]
    ...
    internal interface TKEClass : IS2Dao
    {
        ...
        /// <param name="sysId"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetKeiryouData.sql")]
    ...
    internal interface TKUJEClass : IS2Dao
    {
        ...
        /// <param name="sysId"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetKeiryouJissekiData.sql")]
    ...
    //    /// <returns></returns>
    //    M_ZAIKO_HINMEI GetDataForEntity(M_ZAIKO_HINMEI data);
    //}
    // 20150412 go 在庫品名DAO削除 End

    // 20150409 go 在庫比率DAO Start
    /// <summary>
    /// 在庫比率DAO
    /// </summary>
    ...
    internal interface MZHIClass : IS2Dao
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetZaikoHiritsu.sql")]
        DataTable GetZaikoHiritsuInfo(M_ZAIKO_HIRITSU data);
    }
    // 20150409 go 在庫比率DAO End
    // No.4578<--
    ...
    internal interface TUSEClass : IS2Dao
    {
        ...
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetUketsukeSSData.sql")]
        DataTable GetUketsukeData(string uketsukeNum);
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetUketsukeSSRenkeiData.sql")]
    ...
    internal interface MKKClass : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetKeitaiKbnCd.sql")]
    ...
    internal interface TUEClass : IS2Dao
    {
        ...
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetPreUkeireNumber.sql")]
        ...
        /// <param name="KyotenCD">拠点CD</param>
        /// <returns></returns>
        [SqlFile("Shougun.Core.SalesPayment.UkeireNyuuryoku.Sql.GetNextUkeireNumber.sql")]
