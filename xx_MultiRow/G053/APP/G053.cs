...
namespace Shougun.Core.SalesPayment.SyukkaNyuuryoku
{
    ...
    /// G053 出荷入力
    /// </summary>
    class G053 : r_framework.FormManager.IShougunForm
    {
        /// <summary>
        /// フォーム作成
        /// </summary>
        ...
        public Form CreateForm(params object[] args)
        {
            ...
            Shougun.Core.SalesPayment.SyukkaNyuuryoku.UIForm.LastRunMethod lastRunMethod = null;
            if (args.Length > 2 && args[2] != null)
            {
                lastRunMethod = (Shougun.Core.SalesPayment.SyukkaNyuuryoku.UIForm.LastRunMethod)args[2];
            }
