...
,TKE.NINZUU_CNT                             AS NINZUU_CNT
,TKE.KEITAI_KBN_CD                          AS KEITAI_KBN_CD
,TKE.CONTENA_SOUSA_CD                       AS CONTENA_SOUSA_CD
...
,TKE.UKETSUKE_NUMBER                        AS UKETSUKE_NUMBER
...
,ISNULL(MNIGYO.GYOUSHA_NAME_RYAKU, '')      AS NIZUMI_GYOUSHA_NAME_RYAKU
,ISNULL(MNIGYOOS.GYOUSHA_NAME_RYAKU, '')      AS NIOROSHI_GYOUSHA_NAME_RYAKU
,CASE WHEN MNIGYO.SHOKUCHI_KBN = 1
    THEN '1' ELSE '0' END                   AS NIZUMI_GYOUSHA_SHOKUCHI_KBN
,CASE WHEN MNIGYOOS.SHOKUCHI_KBN = 1
    THEN '1' ELSE '0' END                   AS NIOROSHI_GYOUSHA_SHOKUCHI_KBN
,ISNULL(MNIGEN.GENBA_NAME_RYAKU, '')        AS NIZUMI_GENBA_NAME_RYAKU
,ISNULL(MNIGENOS.GENBA_NAME_RYAKU, '')        AS NIOROSHI_GENBA_NAME_RYAKU
,CASE WHEN MNIGEN.SHOKUCHI_KBN = 1
    THEN '1' ELSE '0' END                   AS NIZUMI_GENBA_SHOKUCHI_KBN
,CASE WHEN MNIGENOS.SHOKUCHI_KBN = 1
...
,ISNULL(MCS.CONTENA_JOUKYOU_NAME_RYAKU, '') AS CONTENA_JOUKYOU_NAME_RYAKU
...
,TKD.WARIFURI_JYUURYOU                      AS DETAIL_WARIFURI_JYUURYOU
,TKD.WARIFURI_PERCENT                       AS DETAIL_WARIFURI_PERCENT
...
,TKD.NISUGATA_SUURYOU                       AS DETAIL_NISUGATA_SUURYOU
,TKD.NISUGATA_UNIT_CD                       AS DETAIL_NISUGATA_UNIT_CD
...
,ISNULL(MUNI.UNIT_NAME_RYAKU, '')           AS DETAIL_NISUGATA_UNIT_NAME_RYAKU
...
ON MNIGYO.GYOUSHA_CD = TKE.NIZUMI_GYOUSHA_CD
...
ON MNIGEN.GYOUSHA_CD = TKE.NIZUMI_GYOUSHA_CD
AND MNIGEN.GENBA_CD = TKE.NIZUMI_GENBA_CD
...
LEFT JOIN M_GYOUSHA AS MNIGYOOS
ON MNIGYOOS.GYOUSHA_CD = TKE.NIOROSHI_GYOUSHA_CD
AND MNIGYOOS.DELETE_FLG = 0
AND (MNIGYOOS.TEKIYOU_BEGIN IS NULL
    OR (MNIGYOOS.TEKIYOU_BEGIN IS NOT NULL AND CONVERT(DATETIME, CONVERT(nvarchar, MNIGYOOS.TEKIYOU_BEGIN, 111), 120) <= CONVERT(DATETIME, CONVERT(nvarchar, GETDATE(), 111), 120)))
AND (MNIGYOOS.TEKIYOU_END IS NULL
    OR (MNIGYOOS.TEKIYOU_END IS NOT NULL AND CONVERT(DATETIME, CONVERT(nvarchar, MNIGYOOS.TEKIYOU_END, 111), 120) >= CONVERT(DATETIME, CONVERT(nvarchar, GETDATE(), 111), 120)))

LEFT JOIN M_GENBA AS MNIGENOS
ON MNIGENOS.GYOUSHA_CD = TKE.NIOROSHI_GYOUSHA_CD
AND MNIGENOS.GENBA_CD = TKE.NIOROSHI_GENBA_CD
AND MNIGENOS.DELETE_FLG = 0
AND (MNIGENOS.TEKIYOU_BEGIN IS NULL
    OR (MNIGENOS.TEKIYOU_BEGIN IS NOT NULL AND CONVERT(DATETIME, CONVERT(nvarchar, MNIGEN.TEKIYOU_BEGIN, 111), 120) <= CONVERT(DATETIME, CONVERT(nvarchar, GETDATE(), 111), 120)))
AND (MNIGEN.TEKIYOU_END IS NULL
    OR (MNIGEN.TEKIYOU_END IS NOT NULL AND CONVERT(DATETIME, CONVERT(nvarchar, MNIGEN.TEKIYOU_END, 111), 120) >= CONVERT(DATETIME, CONVERT(nvarchar, GETDATE(), 111), 120)))
...
/* コンテナ状況CD */
LEFT JOIN M_CONTENA_JOUKYOU AS MCS
ON MCS.CONTENA_JOUKYOU_CD = TKE.CONTENA_SOUSA_CD
AND MCS.DELETE_FLG = 0
...
ON MUNI.UNIT_CD = TKD.NISUGATA_UNIT_CD
