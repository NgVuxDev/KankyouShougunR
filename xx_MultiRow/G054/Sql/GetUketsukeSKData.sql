...
,TUKE.HAISHA_JOKYO_CD                       AS HAISHA_JOKYO_CD
...
,TUKE.NIZUMI_GYOUSHA_CD                     AS NIZUMI_GYOUSHA_CD
,TUKE.NIZUMI_GENBA_CD                       AS NIZUMI_GENBA_CD
...
,TUKE.UNTENSHA_CD                           AS UNTENSHA_CD
,''                                         AS CONTENA_SOUSA_CD
...
,ISNULL(TUKE.NIZUMI_GYOUSHA_NAME, '')      AS NIZUMI_GYOUSHA_NAME_RYAKU
...
,ISNULL(TUKE.NIZUMI_GENBA_NAME, '')        AS NIZUMI_GENBA_NAME_RYAKU
,CASE WHEN MNIGEN.SHOKUCHI_KBN = 1
    THEN '1' ELSE '0' END                   AS NIZUMI_GENBA_SHOKUCHI_KBN
,''                                         AS NIOROSHI_GYOUSHA_NAME_RYAKU
,'0'                                        AS NIOROSHI_GYOUSHA_SHOKUCHI_KBN
,''                                         AS NIOROSHI_GENBA_NAME_RYAKU
,'0'                                        AS NIOROSHI_GENBA_SHOKUCHI_KBN
...
FROM T_UKETSUKE_SK_ENTRY AS TUKE

LEFT JOIN T_UKETSUKE_SK_DETAIL AS TUKD
...
ON MNIGYO.GYOUSHA_CD = TUKE.NIZUMI_GYOUSHA_CD
...
ON MNIGEN.GYOUSHA_CD = TUKE.NIZUMI_GYOUSHA_CD
AND MNIGEN.GENBA_CD = TUKE.NIZUMI_GENBA_CD
...
ON MUNTEN.SHAIN_CD = TUKE.UNTENSHA_CD
