...
using Shougun.Core.SalesManagement.UriageMotocho.Logic;
...
namespace Shougun.Core.SalesManagement.UriageMotocho.APP
{
	...
	public partial class UIForm : SuperForm
    {
		...
		/// </summary>
		public UIForm()
			: base(WINDOW_ID.T_URIAGE_MOTOCHO, WINDOW_TYPE.ICHIRAN_WINDOW_FLAG)
		{
			// コンポーネントの初期化
            this.InitializeComponent();

            // 画面タイプなど引数値は変更となるが基本的にやることは変わらない
			this.logic = new UriageMotocho.Logic.LogicClass(this);
		...
		{
			// 範囲条件指定画面表示
			this.logic.ShowPopUp(MotochoHaniJokenPopUp.Const.UIConstans.DispType.URIAGE);
		}
