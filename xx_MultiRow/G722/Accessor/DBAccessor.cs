...
using Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO;
using Shougun.Function.ShougunCSCommon.Const;
using Shougun.Function.ShougunCSCommon.Utility;

namespace Shougun.Core.SalesPayment.SyukkaNyuuryoku2.Accessor
{
    /// <summary>
    /// DBAccessするためのクラス
    ///
    ...
    public class DBAccessor
    {
        ...
        public DBAccessor()
        {
            ...
            this.mtSeiDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.MTSeiClass>();
            this.mtShihaDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.MTShihaClass>();
            this.tzsdDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TZSDClass>();
            this.tzhhDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TZHHClass>();
            this.tuskeDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TUSKEClass>();
            this.tuskdDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TUSKDClass>();
            this.shashuDao = DaoInitUtility.GetComponent<r_framework.Dao.IM_SHASHUDao>();
            this.tkeDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TKEClass>();
            this.tkdDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TKDClass>();
            this.mzhiDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.MZHIClass>();
            this.tksdDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TKSDClass>();
            this.mkkDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.MKKClass>();
            this.tseDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TSEClass>();
            this.tsdDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TSDClass>();
            this.tlddDao = DaoInitUtility.GetComponent<Shougun.Core.SalesPayment.SyukkaNyuuryoku2.DAO.TLDDClass>();
            ...
            this.sysDatedao = DaoInitUtility.GetComponent<GET_SYSDATEDao>();
            this.kobetsuHinmeiTanka = DaoInitUtility.GetComponent<r_framework.Dao.IM_KOBETSU_HINMEI_TANKADao>();
            this.shuukeiKomokuDao = DaoInitUtility.GetComponent<r_framework.Dao.IM_SHUUKEI_KOUMOKUDao>(); //PhuocLoc 2020/12/01 #136220
        }
        #endregion
        ...
        /// <returns></returns>
        public M_WORK_CLOSED_SHARYOU[] GetWorkclosedsharyouList(M_WORK_CLOSED_SHARYOU keyEntity)
        {
            return this.workclosedsharyouDao.GetAllValidData(keyEntity);
        }
        ...
        /// <param name="keyEntity"></param>
        /// <returns></returns>
        public M_WORK_CLOSED_UNTENSHA[] GetWorkcloseduntenshaList(M_WORK_CLOSED_UNTENSHA keyEntity)
        {
            return this.workcloseduntenshaDao.GetAllValidData(keyEntity);
        }
        ...
        /// <param name="uketsukeNum"></param>
        /// <returns></returns>
        public DataTable GetRenkeiData(string uketsukeNum)
        {
            return this.mobisyoRtDao.GetRenkeiData("1", uketsukeNum);
        }
        ...
        /// <param name="uketsukeNum"></param>
        /// <returns></returns>
        public DataTable GetLogiLinkStatus(string uketsukeNum)
        {
            // ロジこんぱす連携済みであるかをチェックする。
            return this.tlddDao.GetLogiLinkStatus(uketsukeNum);
        }
        ...
        /// <param name="genbaCd"></param>
        /// <returns></returns>
        public T_SHUKKA_ENTRY[] GetEntitysForSharyouName(DateTime dateFrom, DateTime dateTo, string sharyouName, SqlInt16 kyotenCd)
        {
            return this.tseDao.GetEntitysForSharyouName(dateFrom, dateTo, sharyouName, kyotenCd);
        }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public T_SHUKKA_DETAIL[] GetEntitysForHinmeiCd(DateTime dateFrom, DateTime dateTo, T_SHUKKA_ENTRY data)
        {
            return this.tsdDao.GetEntitysForHinmeiCd(dateFrom, dateTo, data);
        }
        ...
        public DateTime GetDate()
        {
            ...
            DataTable dt = sysDatedao.GetDateForStringSql("SELECT GETDATE() AS DATE_TIME");//DBサーバ日付を取得する
            if (dt.Rows.Count > 0)
            {
        ...
        {
            DataTable ret = this.tseDao.GetTairyuuIchiran(kyotenCd, sharyou, unpanGyousha);
