...
FROM
	(SELECT
		...
		,(CASE WHEN EE.KAKUTEI_KBN = 1 
			THEN 'Šm’è'
			ELSE '–¢Šm’è'
		END) AS KAKUTEI_KBN_COL
		,EE.DENPYOU_DATE AS DENPYOU_DATE_COL
		,HM.SHURUI_CD AS SHURUI_CD_COL
		,MS.SHURUI_NAME AS SHURUI_NAME_COL
		,DD.HINMEI_CD AS HINMEI_CD_COL
		,DD.HINMEI_NAME AS HINMEI_NAME_COL
		,DD.UNIT_CD AS UNIT_CD_COL
		,MU.UNIT_NAME_RYAKU AS UNIT_NAME_COL
		,DD.TANKA AS TANKA_COL

	FROM T_UR_SH_ENTRY AS EE
		LEFT JOIN T_UR_SH_DETAIL AS DD ON EE.SYSTEM_ID = DD.SYSTEM_ID AND EE.SEQ = DD.SEQ
	...
	/*IF !dto.HIDZUKE_FROM.IsNull*/
		AND EE.DENPYOU_DATE >= CONVERT(datetime, /*dto.HIDZUKE_FROM.Value*/'2020/01/01')
	/*END*/
	/*IF !dto.HIDZUKE_TO.IsNull*/
		AND EE.DENPYOU_DATE <= CONVERT(datetime, /*dto.HIDZUKE_TO.Value*/'2020/01/01')
	/*END*/
	...
	/*IF dto.KAKUTEI_KBN != null && dto.KAKUTEI_KBN != ''*/
		/*IF dto.KAKUTEI_KBN == '1'*/
			AND EE.KAKUTEI_KBN = 1
		/*END*/
		/*IF dto.KAKUTEI_KBN == '2'*/
			AND EE.KAKUTEI_KBN = 2
		/*END*/
	/*END*/
